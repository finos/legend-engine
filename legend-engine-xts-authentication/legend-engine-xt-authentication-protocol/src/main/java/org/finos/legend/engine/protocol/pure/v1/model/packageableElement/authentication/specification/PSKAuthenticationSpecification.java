...
public class PSKAuthenticationSpecification extends AuthenticationSpecification
{
    public String psk;

    public PSKAuthenticationSpecification()
    {

    }

    public PSKAuthenticationSpecification(String psk)
    {
        this.psk = psk;
    }
