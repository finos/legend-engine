...
public class EnvironmentCredentialVaultSecret extends CredentialVaultSecret
{
    public String envVariableName;

    public EnvironmentCredentialVaultSecret()
    {
    }

    public EnvironmentCredentialVaultSecret(String envVariableName)
    {
