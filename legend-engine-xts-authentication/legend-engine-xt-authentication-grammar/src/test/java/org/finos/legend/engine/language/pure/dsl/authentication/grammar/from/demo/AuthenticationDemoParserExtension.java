...
public class AuthenticationDemoParserExtension implements IAuthenticationDemoParserExtension
{
    ...
    private static Section parseSection(SectionSourceCode sectionSourceCode, Consumer<PackageableElement> elementConsumer, PureGrammarParserContext context)
    {
        ...
        AuthenticationDemoParseTreeWalker authenticationDemoParseTreeWalker = new AuthenticationDemoParseTreeWalker(parserInfo.walkerSourceInformation, elementConsumer, section, context);
        authenticationDemoParseTreeWalker.visit((AuthenticationParserGrammar.DefinitionContext) parserInfo.rootContext);
