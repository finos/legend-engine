...
public class EnvironmentCredentialVault extends CredentialVault<EnvironmentCredentialVaultSecret>
{
    ...
    {
        String envVariableName = vaultSecret.envVariableName;
        if (System.getenv(envVariableName) == null)
        {
            throw new RuntimeException("Secret not found in the environment. Environment variable name=" + envVariableName);
        }
