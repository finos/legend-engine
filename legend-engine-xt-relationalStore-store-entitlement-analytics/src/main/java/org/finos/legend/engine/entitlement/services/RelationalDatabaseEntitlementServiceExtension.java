...
import org.finos.legend.pure.generated.core_relational_database_store_entitlement_relational_relationalAnalyzer;
...
public class RelationalDatabaseEntitlementServiceExtension implements EntitlementServiceExtension
{
    ...
    @Override
    public List<DatasetSpecification> generateDatasetSpecifications(Lambda query, String runtimePath, Root_meta_pure_runtime_Runtime runtime, String mappingPath, Mapping mapping, PureModelContext model, PureModel pureModel, ModelManager modelManager, MutableList<CommonProfile> profiles)
    {
        RichIterable<? extends Root_meta_analytics_store_entitlements_TableWithType> tablesWithType =
                query == null ?
                        core_relational_database_store_entitlement_relational_relationalAnalyzer.Root_meta_analytics_store_entitlements_getGeneralRelationalTablesFromMapping_Mapping_1__Runtime_1__TableWithType_MANY_(mapping, runtime, pureModel.getExecutionSupport())
                        : core_relational_database_store_entitlement_relational_relationalAnalyzer.Root_meta_analytics_store_entitlements_getGeneralRelationalTablesFromQuery_FunctionDefinition_1__Mapping_1__Runtime_1__TableWithType_MANY_(buildPureLambda(query, pureModel), mapping, runtime, pureModel.getExecutionSupport());
    ...
    public List<Function0<List<EntitlementSubtypeInfo<?>>>> getExtraEntitlementSubTypeInfoCollectors()
    {
        return Lists.fixedSize.with(() -> Lists.fixedSize.with(
                EntitlementSubtypeInfo.newBuilder(DatasetSpecification.class)
