...
public class BigQueryFunctionService implements FunctionActivatorService<Root_meta_external_function_activator_bigQueryFunction_BigQueryFunction, BigQueryFunctionDeploymentConfiguration, BigQueryFunctionDeploymentResult>
{
    ...
    @Override
    public MutableList<? extends FunctionActivatorError> validate(MutableList<CommonProfile> profiles, PureModel pureModel, Root_meta_external_function_activator_bigQueryFunction_BigQueryFunction activator, PureModelContext inputModel, Function<PureModel, RichIterable<? extends Root_meta_pure_extension_Extension>> routerExtensions)
    {
