...
public class BigQueryFunctionDeploymentManager implements DeploymentManager<BigQueryFunctionArtifact, BigQueryFunctionDeploymentResult, BigQueryFunctionDeploymentConfiguration>
{
    ...
    @Override
    public BigQueryFunctionDeploymentResult deploy(MutableList<CommonProfile> profiles, BigQueryFunctionArtifact artifact)
    {
        return new BigQueryFunctionDeploymentResult("", false);
    }

    @Override
    public BigQueryFunctionDeploymentResult deploy(MutableList<CommonProfile> profiles, BigQueryFunctionArtifact artifact, List<BigQueryFunctionDeploymentConfiguration> availableRuntimeConfigurations)
    {
        return new BigQueryFunctionDeploymentResult("", false);
    }
