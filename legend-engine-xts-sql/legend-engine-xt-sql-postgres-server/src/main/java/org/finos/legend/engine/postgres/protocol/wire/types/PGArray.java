...
package org.finos.legend.engine.postgres.protocol.wire.types;
...
public class PGArray extends PGType<List<Object>>
{
    ...
    //static final PGArray CHARACTER_ARRAY = new PGArray(1014, CharacterType.INSTANCE);
   ...
   /* public static final PGArray ANY_ARRAY = new PGArray(
    ...
    private int getDimensions(Object value)
    {
        int dimensions = 0;
        Object array = value;
    ...
    private int buildDimensions(List<Object> values, List<Integer> dimensionsList, int maxDimensions,
                                int currentDimension)
    {
        ...
        if (currentDimension < maxDimensions)
        {
            ...
            {
                max = Math.max(max,
                        buildDimensions((List<Object>) o, dimensionsList, maxDimensions, currentDimension + 1));
            }
    ...
    private int writeArrayAsBinary(ByteBuf buffer, List<Object> array, List<Integer> dimensionsList,
                                   int currentDimension)
    {
        int bytesWritten = 0;
        ...
        else
        {
            for (Object o : array)
            {
                bytesWritten += writeArrayAsBinary(buffer, (List<Object>) o, dimensionsList,
                        currentDimension + 1);
            }
        }
        return bytesWritten;
