...
package org.finos.legend.engine.postgres.protocol.wire.auth;
...
public class AuthenticationContext implements Closeable
{
     ...
     */
    public AuthenticationContext(AuthenticationMethod authMethod, ConnectionProperties connProperties,
