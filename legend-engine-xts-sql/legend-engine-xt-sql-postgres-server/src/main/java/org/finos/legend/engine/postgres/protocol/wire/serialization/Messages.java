...
package org.finos.legend.engine.postgres.protocol.wire.serialization;
...
public class Messages
{
     ...
     */
    public ChannelFuture sendReadyForQuery(Channel channel)
    {
     ...
     */
    public void sendParameterStatus(Channel channel, final String name, final String value)
    {
    ...
    public void sendAuthenticationError(Channel channel, String message)
    {
        LOGGER.warn(message);
    ...
    public ChannelFuture sendErrorResponse(Channel channel, Throwable throwable)
    {
     ...
     */
    public void sendParameterDescription(Channel channel, ParameterMetaData parameters) throws SQLException
    {
...
*/
     ...
     */
    public void sendParseComplete(Channel channel)
    {
        sendShortMsg(channel, '1', "sentParseComplete");
    }

    public void sendGssOutToken(Channel channel, byte[] outputToken)
    {
        int integerLength = 8;
     ...
     */
    public void sendBindComplete(Channel channel)
    {
     ...
     */
    public void sendEmptyQueryResponse(Channel channel)
    {
     ...
     * NoData | 'n' | int32 len |
     */
    public void sendNoData(Channel channel)
    {
     ...
     */
    public void sendCloseComplete(Channel channel)
    {
     ...
     */
    public void sendAuthenticationCleartextPassword(Channel channel)
    {
        ByteBuf buffer = channel.alloc().buffer(9);
        buffer.writeByte('R');
        buffer.writeInt(8);
    ...
    public void sendAuthenticationKerberos(Channel channel)
    {
        int integerLength = 8;
        int authReqGss = 7;
        int nullStopByteLength = 1;
     ...
     */
    public void sendKeyData(Channel channel, int pid, int secretKey)
    {
