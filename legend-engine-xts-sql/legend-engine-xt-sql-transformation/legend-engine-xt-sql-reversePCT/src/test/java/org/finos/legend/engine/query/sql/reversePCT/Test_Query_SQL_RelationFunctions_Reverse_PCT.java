...
public class Test_Query_SQL_RelationFunctions_Reverse_PCT extends PCTReportConfiguration
{
    ...
    private static final RichIterable<? extends Root_meta_pure_test_pct_reversePCT_framework_ReversesForSource> reverseInfo = core_external_query_sql_reverse_pct_relation_relation.Root_meta_external_query_sql_reversePCT_tests_relation_reverses__ReversesForSource_MANY_(getClassLoaderExecutionSupport(Thread.currentThread().getContextClassLoader()));
