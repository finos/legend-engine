...
public class Test_Query_SQL_VariantFunctions_Reverse_PCT extends PCTReportConfiguration
{
    ...
    private static final RichIterable<? extends Root_meta_external_query_sql_reversePCT_framework_ReversesForSource> reverseInfo = core_external_query_sql_reverse_pct_variant_variant.Root_meta_external_query_sql_reversePCT_tests_variant_reverses__ReversesForSource_MANY_(getClassLoaderExecutionSupport(Thread.currentThread().getContextClassLoader()));
