...
import org.finos.legend.pure.generated.core_external_query_sql_reverse_pct_standard_standard;
...
public class Test_Query_SQL_StandardFunctions_Reverse_PCT extends PCTReportConfiguration
{
    ...
    private static final RichIterable<? extends Root_meta_external_query_sql_reversePCT_framework_ReversesForSource> reverseInfo = core_external_query_sql_reverse_pct_standard_standard.Root_meta_external_query_sql_reversePCT_framework_standard_reverses__ReversesForSource_MANY_(getClassLoaderExecutionSupport(Thread.currentThread().getContextClassLoader()));
