...
public class TestRelationalExecutor extends AlloyTestServer
{
    ...
    public void testPlanWitGMTTimeZoneConversionForDateTimeQueryConstant() throws IOException
    {
        ...
        RelationalResult result = (RelationalResult) executionPlan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(executionPlan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
    ...
    public void testErrorFromSqlTemplateFreeMarkerProcessingBubblesUp() throws IOException
    {
        ...
        IllegalStateException exception = Assert.assertThrows(IllegalStateException.class, () -> executionPlan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(vars, Lists.mutable.withAll(executionPlan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort)))))));
    ...
    public void testTimeZoneRulesUsedAreAlignedWithTheDateParameter() throws IOException
    {
        ...
        result = (RelationalResult) executionPlan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(vars, Lists.mutable.withAll(executionPlan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
    ...
    public void testGMTTimeZonePlanWithDifferentSerializationFormats() throws IOException
    {
        ...
        RelationalResult result_default = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
        ...
        RelationalResult result_pureTdsObject = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
        ...
        RelationalResult result_pureTds = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
        ...
        RelationalResult result_jsonTds = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
        ...
        RelationalResult result_csv = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
        ...
        RelationalResult result_csvFixed = (RelationalResult) plan.rootExecutionNode.accept(new ExecutionNodeExecutor(IdentityFactoryProvider.getInstance().getAnonymousIdentity(), new ExecutionState(Maps.mutable.empty(), Lists.mutable.withAll(plan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
