...
public class TestRelationalExecutor extends AlloyTestServer
{
    ...
    public void testErrorFromSqlTemplateFreeMarkerProcessingBubblesUp() throws IOException
    {
        ...
        IllegalStateException exception = Assert.assertThrows(IllegalStateException.class, () -> executionPlan.rootExecutionNode.accept(new ExecutionNodeExecutor(Identity.getAnonymousIdentity(), new ExecutionState(vars, Lists.mutable.withAll(executionPlan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort)))))));
    ...
    public void testTimeZoneRulesUsedAreAlignedWithTheDateParameter() throws IOException
    {
        ...
        result = (RelationalResult) executionPlan.rootExecutionNode.accept(new ExecutionNodeExecutor(Identity.getAnonymousIdentity(), new ExecutionState(vars, Lists.mutable.withAll(executionPlan.templateFunctions), Lists.mutable.with(new RelationalStoreExecutionState(new RelationalStoreState(serverPort))))));
