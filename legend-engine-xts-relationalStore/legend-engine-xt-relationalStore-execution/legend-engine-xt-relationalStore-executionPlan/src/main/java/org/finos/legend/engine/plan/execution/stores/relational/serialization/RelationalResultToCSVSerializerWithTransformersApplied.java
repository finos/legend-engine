...
public class RelationalResultToCSVSerializerWithTransformersApplied extends CsvSerializer
{
    ...
    public RelationalResultToCSVSerializerWithTransformersApplied(RelationalResult relationalResult, boolean withHeader)
    {
    ...
    public RelationalResultToCSVSerializerWithTransformersApplied(RelationalResult relationalResult, CSVFormat csvFormat)
    {
