...
public class LegendH2Extensions_1_4_200
{
    ...
    public static float legend_h2_extension_cbrt(Float num)
    {
        return num == null ? null : (float) Math.cbrt(num.doubleValue());
    }
    ...
    public static Value legend_h2_extension_edit_distance(Value string1, Value string2)
    {
        ...
        return ValueInt.get(new LevenshteinDistance().apply(string1.getString(), string2.getString()));
    }
