...
public class H2LocalWithStaticUserPasswordFlow implements DatabaseAuthenticationFlow<LocalH2DatasourceSpecification, TestDatabaseAuthenticationStrategy>
{
    @Override
