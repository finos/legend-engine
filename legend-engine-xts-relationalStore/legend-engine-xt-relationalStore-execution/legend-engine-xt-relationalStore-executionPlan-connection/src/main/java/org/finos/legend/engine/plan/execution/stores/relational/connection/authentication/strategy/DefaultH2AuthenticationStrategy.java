...
public class DefaultH2AuthenticationStrategy extends AuthenticationStrategy
{
    ...
    private static List<String> getLegendH2ExtensionSQLs()
    {
        return Arrays.asList(
                ...
                "CREATE ALIAS IF NOT EXISTS legend_h2_extension_hash_md5 FOR \"org.finos.legend.engine.plan.execution.stores.relational.LegendH2Extensions.legend_h2_extension_hash_md5\";",
                "CREATE ALIAS IF NOT EXISTS legend_h2_extension_hash_sha1 FOR \"org.finos.legend.engine.plan.execution.stores.relational.LegendH2Extensions.legend_h2_extension_hash_sha1\";",
                ...
                "CREATE ALIAS IF NOT EXISTS legend_h2_extension_split FOR \"org.finos.legend.engine.plan.execution.stores.relational.LegendH2Extensions.legend_h2_extension_split\";",
    ...
    private static List<String> getLegendH2_1_4_200_ExtensionSQLs()
    {
        return Arrays.asList(
                ...
                "CREATE ALIAS IF NOT EXISTS legend_h2_extension_split FOR \"org.finos.legend.engine.plan.execution.stores.relational.LegendH2Extensions_1_4_200.legend_h2_extension_split\";",
