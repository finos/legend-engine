...
public class DefaultH2AuthenticationStrategy extends AuthenticationStrategy
{
    ...
    private static List<String> getLegendH2ExtensionSQLs()
    {
        return Arrays.asList(
                ...
                "CREATE ALIAS IF NOT EXISTS legend_h2_extension_cbrt FOR \"org.finos.legend.engine.plan.execution.stores.relational.LegendH2Extensions.legend_h2_extension_cbrt\";",
