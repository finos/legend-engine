...
package org.finos.legend.engine.language.pure.grammar.api.elementGenerationFromSchema.test;
...
public class TestElementGenerationFromSchemaApi
{
    ...
    {
        return IOUtils.toString(Objects.requireNonNull(TestElementGenerationFromSchemaApi.class
                .getClassLoader()
    ...
    @Test
    public void shouldGenerateElementsFromSchema() throws IOException
    {
        ...
        ElementGenerationInput inputJson = new ElementGenerationInput(databasePath, inputPmcd);
        ...
        ElementGenerationAPI elementGenerationAPI = new ElementGenerationAPI(routerExtensions, DeploymentMode.PROD);
        Response response = elementGenerationAPI.generateElements(inputJson, null);
