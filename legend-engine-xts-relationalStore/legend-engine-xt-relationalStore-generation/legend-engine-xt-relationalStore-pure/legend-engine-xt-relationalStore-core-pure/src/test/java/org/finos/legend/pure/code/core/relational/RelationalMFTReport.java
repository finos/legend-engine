...
public class RelationalMFTReport extends MFTReport
{
    private final String databaseType;

       public RelationalMFTReport(String databaseType)
    {
    ...
    {
        return "meta::relational::mft::relationalEvaluator__MFTEvaluator_1_";
    }
