...
public class TestCoreRelationalStoreRelationalSdtCompiledStateIntegrity extends AbstractCompiledStateIntegrityTest
{
    @BeforeClass
    public static void initialize()
    {
        initialize("core_external_store_relational_sdt");
    }
