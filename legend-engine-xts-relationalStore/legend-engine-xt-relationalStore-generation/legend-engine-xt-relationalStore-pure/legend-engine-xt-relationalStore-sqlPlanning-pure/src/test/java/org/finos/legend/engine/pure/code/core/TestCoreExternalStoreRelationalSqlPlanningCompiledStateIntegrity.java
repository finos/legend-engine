...
@Ignore
public class TestCoreExternalStoreRelationalSqlPlanningCompiledStateIntegrity extends AbstractCompiledStateIntegrityTest
{
    @BeforeClass
    public static void initialize()
    {
        initialize("core_external_store_relational_sql_planning");
    }
