...
public class RelationalGraphFetchExecutionNode extends LocalGraphFetchExecutionNode
{
    @Deprecated
    public ExecutionNode relationalNode;
    public List<RelationalGraphFetchExecutionNode> children;
    ...
    public List<ExecutionNode> childNodes()
    {
        ...
        if (this.relationalNode != null)
        {
            allNodes.add(this.relationalNode);
        }
