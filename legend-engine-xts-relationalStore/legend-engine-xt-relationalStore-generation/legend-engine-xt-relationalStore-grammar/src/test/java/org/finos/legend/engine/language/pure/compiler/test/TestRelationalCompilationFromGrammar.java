...
public class TestRelationalCompilationFromGrammar extends TestCompilationFromGrammar.TestCompilationFromGrammarTestSuite
{
    ...
    public void testRelationFunctionMappingWithInvalidBinding()
    {
        test(RELATION_MAPPING_PURE_SOURCE + BINDING_PURE_SOURCE + "###Mapping\n" +
                ...
                "  }\n" +
                ")\n", "COMPILATION warning at [47:6-48]: Can't find the packageable element 'my::FooBinding'");
    }
    ...
    public void testRelationFunctionMappingWithInvalidBindingColumn()
    {
        test(RELATION_MAPPING_PURE_SOURCE + BINDING_PURE_SOURCE + "###Mapping\n" +
                ...
                "  }\n" +
                ")\n", "COMPILATION warning at [47:6-48]: The system can't find the column FOO_DETAILS in the Relation (FIRSTNAME:String, AGE:Integer, FIRM_DETAILS:Variant)");
    }
    ...
    public void testDatabaseStereotype()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [8:44-48]: Can't find stereotype 'type3' in profile 'meta::pure::profiles::storeType'"
        );
    }
    ...
    public void testSchemaStereotype()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [10:44-48]: Can't find stereotype 'type3' in profile 'meta::pure::profiles::storeType'"
        );
    }
    ...
    public void testTableStereotype()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [10:43-47]: Can't find stereotype 'type3' in profile 'meta::pure::profiles::storeType'"
        );
    }
    ...
    public void testViewStereotype()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [15:42-46]: Can't find stereotype 'type3' in profile 'meta::pure::profiles::storeType'"
        );
    }
    ...
    public void testColumnStereotype()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [12:49-53]: Can't find stereotype 'type3' in profile 'meta::pure::profiles::storeType'"
        );
    }
    ...
    public void testTaggedValues()
    {
        ...
        test("###Pure\n" +
                        ...
                        "  )\n" +
                        ")",
                "COMPILATION warning at [10:37-43]: Can't find tag 'unknown' in profile 'meta::pure::profiles::doc'"
        );
    }
    ...
    public void testMissingColumnOnMilestoning()
    {
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:47-108]: Milestone column 'dummyIn' not found on table definition"
        );
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:47-108]: Milestone column 'dummyOut' not found on table definition"
        );
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:56-94]: Milestone column 'dummyIn' not found on table definition"
        );
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:56-94]: Milestone column 'dummyOut' not found on table definition"
        );
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:56-80]: Milestone column 'dummy' not found on table definition"
        );
        ...
        test("###Relational\n" +
                        ...
                        "    )\n" +
                        ")",
                "COMPILATION warning at [4:58-89]: Milestone column 'dummy' not found on table definition"
        );
    }
    ...
    public void testMissingJoin()
    {
        test("###Relational\n" +
                ...
                "       maxTradeEventDate : max(tradeEventTable.eventDate)\n" +
                "    )\n" +
                ")", "COMPILATION warning at [8:19-30]: Can't find join 'MissingJoin' in database 'dbInc'");
    }
    ...
    public void testFaultyDb()
    {
        test("###Relational\n" +
                        ...
                        "    Table personTable (ID INT PRIMARY KEY, MANAGERID INT)\n" +
                        ")",
                "COMPILATION warning at [4:5-43]: Can't find database 'model::relational::tests::dbInc'"
        );
        ...
        test("###Relational\n" +
                        ...
                        "\n" +
                        ")",
                "COMPILATION warning at [6:22-44]: Can't find schema 'missingSchema' in database 'dbInc'");
        ...
        test("###Relational\n" +
                        ...
                        "\n" +
                        ")",
                "COMPILATION warning at [6:22-33]: Can't find table 'missingTable' in schema 'default' and database 'dbInc'");
        ...
        test("###Relational\n" +
                        ...
                        "\n" +
                        ")",
                "COMPILATION warning at [6:37-62]: Can't find column 'FIRMID_MISSING'");
    }
    ...
    public void testFaultyRelationalMapping()
    {
        test("Class model::Person {\n" +
                ...
                "      name : [model::store::db]myTable.name\n" +
                "   }\n" +
                ")", "COMPILATION warning at [10:32-38]: The store 'model::store::db' can't be found."
        );
        ...
        test(MODEL + DB_INC +
                ...
                "  }\n" +
                ")", "COMPILATION warning at [92:21-74]: Can't find property 'propertyMissing' in [Firm, LegalEntity, Any]"
        );
        ...
        test("###Mapping\n" +
                ...
                "    )\n" +
                "  }\n\n" +
                ")", "COMPILATION warning at [4:3-20]: Can't find association 'MissingAssociation'"
        );
        ...
        test(MODEL +
                ...
                "      )\n" +
                "   }" +
                ")", "COMPILATION warning at [107:10-35]: Can't find property 'missingAssociationProperty' in association 'model::Employment'"
        );
        ...
        test("Class model::Person\n" +
                ...
                "                name:[model::db]personTb.name\n" +
                "            }\n" +
                ")\n", "COMPILATION warning at [34:21-52]: Mapping error: the join myJoin does not contain the source table personTb");
        ...
        test("Class model::Person\n" +
                ...
                "                name:[model::db]personTb.name\n" +
                "            }\n" +
                ")\n", "COMPILATION warning at [34:21-52]: Mapping error: the join otherJoin does not contain the source table otherTb");
        ...
        test("Class model::Person\n" +
                ...
                "                name:[model::db]personTb.name\n" +
                "            }\n" +
                ")\n", "COMPILATION warning at [35:21-64]: Mapping error: the join otherJoin does not contain the source table otherTb");
        ...
        test(MODEL + DB_INC +
                ...
                "    )\n" +
                "  }\n" +
                ")", "COMPILATION warning at [92:31-100]: Can't find property 'missingEmbeddedProperty' in [Person, Any]"
        );
        ...
        test(MODEL + DB_INC +
                ...
                "    legalName: [model::relational::tests::dbInc]firmTable.LEGALNAME\n" +
                "  }\n" +
                ")", "COMPILATION warning at [90:5-58]: Can't find filter 'MissingFilter' in database 'dbInc'"
        );
    }
    ...
    public void testMappingInheritance()
    {
        test(MODEL + DB_INC +
                ...
                "    legalName: [model::relational::tests::dbInc]firmTable.LEGALNAME\n" +
                "  }\n" +
                ")", "COMPILATION warning at [92:3-95:3]: Can't find extends class mapping 'entity1' in mapping 'model::myRelationalMapping'"
        );
    ...
    public void testTestMappingError()
    {
        test(MODEL + DB_INC +
                ...
                "    )\n" +
                "  ]\n" +
                ")", "COMPILATION warning at [99:9-242]: The store 'test::DB' can't be found."
        );
    }
    ...
    public void testInnerJoinReferenceInRelationalMapping()
    {
        ...
        test(model +
                ...
                "  }\n" +
                "\n" +
                ")", "COMPILATION warning at [55:14-90]: Do not support specifying join type for the first join in the classMapping.");
    }
    ...
    public void testRelationalPropertyMappingWithBindingTransformer()
    {
        ...
        test(model +
                ...
                "  }\n" +
                ")\n", "COMPILATION warning at [46:8-68]: Binding transformer can be used with complex properties only. Property 'age' return type is 'Integer'");
        ...
        test(model +
                ...
                "  }\n" +
                ")\n", "COMPILATION warning at [47:12-73]: Class: simple::Person should be included in modelUnit for binding: simple::TestBinding");
    ...
    public void testRelationalClassMappingWithDuplicateSetIdsError()
    {
        test("###Pure\n" +
                ...
                "   {      \n" +
                "   }   \n" +
                ")", "COMPILATION warning at [47:4-49:4]: Duplicated class mappings found with ID 'id' in mapping 'simple::merged'; parent mapping for duplicated: 'simple::gen1::map', 'simple::gen2::map'");
    }
    ...
    public void testAssociationAndComplexPropertyCompilerErrors()
    {
        ...
        test(MODEL +
                ...
                "  }\n" +
                ")", "COMPILATION warning at [97:11-76]: Mapping error: the join Firm_PersonFirm does not contain the source table personTable");
    ...
    public void testForMultipleRelationalConnections()
    {
        test("###Relational\n" +
                ...
                "    ]\n" +
                "  ];\n" +
                "}\n", "COMPILATION warning at [89:1-107:1]: Found 2 connections against store [dbInc] under a single runtime.");
    }
    ...
    public void testForRelationalRuntimeErrors()
    {
        test("###Relational\n" +
                ...
                "    ]\n" +
                "  ];\n" +
                "}\n", "COMPILATION warning at [90:1-107:1]: Found 2 connections against store [dbInc] under a single runtime.");
    }
    ...
    public void testTableReferencesWithDuplicatedSchemaNames()
    {
        ...
        test("###Relational\n" +
                ...
                ")\n", "COMPILATION warning at [34:44-56]: The relation 'Firm' has been found 2 times in the schema 'mySchema' of the database 'store::relational::db1'", null);
        ...
        test("###Relational\n" +
                ...
                ")", "COMPILATION warning at [19:22-34]: The relation 'Firm' has been found 2 times in the schema 'mySchema' of the database 'store::relational::db'", null);
    }
