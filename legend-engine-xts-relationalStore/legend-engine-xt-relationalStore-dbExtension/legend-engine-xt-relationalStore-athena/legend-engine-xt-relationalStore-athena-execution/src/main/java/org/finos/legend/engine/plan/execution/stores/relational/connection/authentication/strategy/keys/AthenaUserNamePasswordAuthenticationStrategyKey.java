...
public class AthenaUserNamePasswordAuthenticationStrategyKey implements AuthenticationStrategyKey
{
    private final String userNameVaultReference;
    private final String passwordVaultReference;

    public AthenaUserNamePasswordAuthenticationStrategyKey(String userNameVaultReference, String passwordVaultReference)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        AthenaUserNamePasswordAuthenticationStrategyKey that = (AthenaUserNamePasswordAuthenticationStrategyKey) o;
