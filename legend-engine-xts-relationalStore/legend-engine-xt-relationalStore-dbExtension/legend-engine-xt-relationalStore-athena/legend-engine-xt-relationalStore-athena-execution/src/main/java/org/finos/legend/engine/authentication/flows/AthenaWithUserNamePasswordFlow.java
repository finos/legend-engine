...
public class AthenaWithUserNamePasswordFlow implements DatabaseAuthenticationFlow<AthenaDatasourceSpecification, UserNamePasswordAuthenticationStrategy>
{
    @Override
    public Class<AthenaDatasourceSpecification> getDatasourceClass()
    {
        return AthenaDatasourceSpecification.class;
    }
    ...
    @Override
    public Credential makeCredential(Identity identity, AthenaDatasourceSpecification datasourceSpecification, UserNamePasswordAuthenticationStrategy authStrategy) throws Exception
    {
