...
public class AthenaUserNamePasswordAuthenticationStrategy extends AuthenticationStrategy
{
    private final String userNameVaultReference;
    private final String passwordVaultReference;

    public AthenaUserNamePasswordAuthenticationStrategy(String userNameVaultReference, String passwordVaultReference)
    {
    ...
    public Pair<String, Properties> handleConnection(String url, Properties properties, DatabaseManager databaseManager)
    {
        ...
        connectionProperties.put("User", this.userNameVaultReference);
    ...
    {
        return new AthenaUserNamePasswordAuthenticationStrategyKey(this.userNameVaultReference, this.passwordVaultReference);
    }
}
