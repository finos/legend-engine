...
public class MemSQLRelationalTestServerInvoker
{
    public static void main(String[] args) throws Exception
    {
        RelationalTestServer.execute(
                args.length == 0 ? new String[] {"server", "legend-engine-xt-relationalStore-memsql-execution-tests/src/test/resources/org/finos/legend/engine/server/test/userTestConfig_withMemSQLTestConnection.json"} : args,
