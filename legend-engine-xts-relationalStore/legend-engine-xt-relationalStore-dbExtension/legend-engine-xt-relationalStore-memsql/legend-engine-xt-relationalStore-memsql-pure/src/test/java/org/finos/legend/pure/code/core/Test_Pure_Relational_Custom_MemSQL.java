...
public class Test_Pure_Relational_Custom_MemSQL
{
    public static TestSuite suite()
    {
        // All tests related to MemSQL that are not defined as parameterized DB specific tests should be here
        String testPackage = "meta::relational::memsql::tests";
