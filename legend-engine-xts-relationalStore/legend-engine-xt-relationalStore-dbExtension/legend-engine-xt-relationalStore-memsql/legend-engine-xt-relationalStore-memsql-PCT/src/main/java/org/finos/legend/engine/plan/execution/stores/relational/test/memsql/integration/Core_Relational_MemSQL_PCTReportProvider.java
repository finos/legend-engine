...
public class Core_Relational_MemSQL_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Core_Relational_MemSQL_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                ...
                "pct-reports/ADAPTER_variant_compiled_MemSQL.json",
                "pct-reports/ADAPTER_scenario_quant_compiled_MemSQL.json"
        );
    }
}