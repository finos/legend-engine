...
public class Test_Relational_MemSQL_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::filter::testFilterLiteralFromVar_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: MemSQL"),
            one("meta::pure::functions::collection::tests::filter::testFilterLiteral_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: MemSQL"),
            one("meta::pure::functions::collection::tests::filter::testLambdaAsFunctionParameter_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: MemSQL"),
            ...
            one("meta::pure::functions::math::tests::minus::testLargeMinus_Function_1__Boolean_1_", "Match failure: null"),
            ...
            one("meta::pure::functions::math::tests::plus::testLargePlus_Function_1__Boolean_1_", "Match failure: null"),
            ...
            one("meta::pure::functions::math::tests::times::testLargeTimes_Function_1__Boolean_1_", "Match failure: null"),
            ...
            one("meta::pure::functions::boolean::tests::conjunctions::and::testBasicParse_Function_1__Boolean_1_", "class java.lang.Long cannot be cast to class java.lang.Boolean"),
            one("meta::pure::functions::boolean::tests::conjunctions::not::testBasicParse_Function_1__Boolean_1_", "class java.lang.Long cannot be cast to class java.lang.Boolean"),
            one("meta::pure::functions::boolean::tests::conjunctions::or::testBasicParse_Function_1__Boolean_1_", "class java.lang.Long cannot be cast to class java.lang.Boolean")
    );
