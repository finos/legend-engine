...
public class Test_Relational_MemSQL_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Median
            one("meta::pure::functions::math::tests::median::testMedian_Floats_Function_1__Boolean_1_", "Function 'for_testing.mode' is not defined"),
            one("meta::pure::functions::math::tests::median::testMedian_Integers_Function_1__Boolean_1_", "Function 'for_testing.mode' is not defined"),
            one("meta::pure::functions::math::tests::median::testMedian_Numbers_Function_1__Boolean_1_", "Function 'for_testing.mode' is not defined"),
