...
public class Test_Relational_MemSQL_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Variance
            one("meta::pure::functions::math::tests::variance::testVariancePopulation_Function_1__Boolean_1_", "A non-scalar value ' [1,2]' is used as a scalar", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::math::tests::variance::testVarianceSample_Function_1__Boolean_1_", "A non-scalar value ' [1.0,2.0,3.0]' is used as a scalar", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::math::tests::variance::testVariance_Population_Function_1__Boolean_1_", "A non-scalar value ' [1,2]' is used as a scalar", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::math::tests::variance::testVariance_Sample_Function_1__Boolean_1_", "A non-scalar value ' [1.0,2.0,3.0]' is used as a scalar", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::in::testInForDecimal_Function_1__Boolean_1_", "class java.lang.Long cannot be cast to class java.lang.Boolean (java.lang.Long and java.lang.Boolean are in module java.base of loader 'bootstrap')", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::greatest::testGreatest_Empty_Function_1__Boolean_1_", "Too few arguments to function 'greatest'", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::collection::tests::greatest::testGreatest_Number_Function_1__Boolean_1_", "\"\nexpected: 2\nactual:   2.0\"", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::collection::tests::greatest::testGreatest_Single_Function_1__Boolean_1_", "Too few arguments to function 'greatest'", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::least::testLeast_Empty_Function_1__Boolean_1_", "Too few arguments to function 'least'", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::least::testLeast_Single_Function_1__Boolean_1_", "Too few arguments to function 'least'", AdapterQualifier.needsInvestigation)
    );
