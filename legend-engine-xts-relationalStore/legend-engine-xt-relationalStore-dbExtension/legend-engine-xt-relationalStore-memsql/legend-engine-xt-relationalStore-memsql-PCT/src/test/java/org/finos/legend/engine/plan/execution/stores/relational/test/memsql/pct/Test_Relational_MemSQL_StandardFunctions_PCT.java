...
public class Test_Relational_MemSQL_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::greatest::testGreatest_Single_Function_1__Boolean_1_", "java.sql.SQLSyntaxErrorException: (conn=37) Too few arguments to function 'greatest'"),
            ...
            one("meta::pure::functions::collection::tests::least::testLeast_Single_Function_1__Boolean_1_", "java.sql.SQLSyntaxErrorException: (conn=37) Too few arguments to function 'least'"),
