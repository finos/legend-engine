...
public class Test_Relational_Spanner_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::drop::testDropInList_Function_1__Boolean_1_", "Can't resolve the builder for function 'meta::pure::functions::collection::list' - stack:[Function 'test::lambdaContainer__Any_MANY_' Third Pass, new lambda, Applying meta::pure::mapping::from, Applying meta::pure::functions::collection::list]", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::collection::tests::slice::testSliceInList_Function_1__Boolean_1_", "Can't resolve the builder for function 'meta::pure::functions::collection::list' - stack:[Function 'test::lambdaContainer__Any_MANY_' Third Pass, new lambda, Applying meta::pure::mapping::from, Applying meta::pure::functions::collection::list]", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::collection::tests::take::testTakeInList_Function_1__Boolean_1_", "Can't resolve the builder for function 'meta::pure::functions::collection::list' - stack:[Function 'test::lambdaContainer__Any_MANY_' Third Pass, new lambda, Applying meta::pure::mapping::from, Applying meta::pure::functions::collection::list]", AdapterQualifier.unsupportedFeature),
            ...
            //zip
            one("meta::pure::functions::collection::tests::zip::testZipBothListsAreOfPairs_Function_1__Boolean_1_", "\"Cannot cast a collection of size 0 to multiplicity [1]\"", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::zip::testZipFirstListsIsOfPairs_Function_1__Boolean_1_", "\"Cannot cast a collection of size 0 to multiplicity [1]\"", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::collection::tests::zip::testZipSecondListsIsOfPairs_Function_1__Boolean_1_", "\"Cannot cast a collection of size 0 to multiplicity [1]\"", AdapterQualifier.needsInvestigation),

            //date
            one("meta::pure::functions::date::tests::testAdjustByDaysBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByDays_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByHoursBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByHours_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMicrosecondsBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMicroseconds_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMillisecondsBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMilliseconds_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMinutesBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMinutes_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMonthsBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByMonths_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustBySecondsBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustBySeconds_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByWeeksBigNumber_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByWeeks_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testAdjustByYears_Function_1__Boolean_1_", "\"[unsupported-api] The function 'adjust' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::date::tests::testDateDiffDays_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffHours_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffMilliseconds_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffMinutes_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffMonths_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffSeconds_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffWeeks_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffWithDifferentTimeZones_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::date::tests::testDateDiffYears_Function_1__Boolean_1_", "\"[unsupported-api] The function 'dateDiff' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            //if
            one("meta::pure::functions::lang::tests::if::testMultiIf_Function_1__Boolean_1_", "Error dynamically evaluating value specification (from /platform/pure/essential/lang/flow/if.pure:58cc29-32); error compiling generated Java code:", AdapterQualifier.needsInvestigation),
            ...
            //toDecimal
            one("meta::pure::functions::math::tests::toDecimal::testDecimalToDecimal_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toDecimal' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::math::tests::toDecimal::testDoubleToDecimal_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toDecimal' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::math::tests::toDecimal::testIntToDecimal_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toDecimal' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),

            //toFloat
            one("meta::pure::functions::math::tests::toFloat::testDecimalToFloat_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toFloat' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::math::tests::toFloat::testDoubleToFloat_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toFloat' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::math::tests::toFloat::testIntToFloat_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toFloat' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            //parseBoolean
            one("meta::pure::functions::string::tests::parseBoolean::testParseFalse_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseBoolean' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseBoolean::testParseTrue_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseBoolean' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),

            //parseDate
            one("meta::pure::functions::string::tests::parseDate::testParseDateTypes_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toTimestamp' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseDate::testParseDateWithTimezone_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toTimestamp' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseDate::testParseDateWithZ_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toTimestamp' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseDate::testParseDate_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toTimestamp' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),

            //parseDecimal
            one("meta::pure::functions::string::tests::parseDecimal::testParseDecimal_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseDecimal' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseDecimal::testParseZero_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseDecimal' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),

            //parseFloat
            one("meta::pure::functions::string::tests::parseFloat::testParseFloat_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseFloat' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::parseFloat::testParseZero_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseFloat' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),

            //parseInteger
            one("meta::pure::functions::string::tests::parseInteger::testParseInteger_Function_1__Boolean_1_", "\"[unsupported-api] The function 'parseInteger' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            //variant
            one("meta::pure::functions::collection::tests::fold::testFold_FromVariantAsPrimitive_Function_1__Boolean_1_", "Can't resolve the builder for function 'meta::pure::functions::variant::convert::toMany'", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::collection::tests::fold::testFold_FromVariant_Function_1__Boolean_1_", "Can't resolve the builder for function 'meta::pure::functions::variant::convert::toMany'", AdapterQualifier.unsupportedFeature),

            //toString
            one("meta::pure::functions::string::tests::toString::testBooleanToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::string::tests::toString::testDateTimeToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testDateTimeWithTimezoneToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testDateToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::string::tests::toString::testFloatToStringWithExcessTrailingZeros_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testFloatToStringWithNegativeExponent_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testFloatToStringWithNoLeadingZero_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testFloatToStringWithPositiveExponent_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testFloatToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testIntegerToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            ...
            one("meta::pure::functions::string::tests::toString::testPairCollectionToString_Function_1__Boolean_1_", "\"Cannot cast a collection of size 0 to multiplicity [1]\"", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::string::tests::toString::testSimpleDateToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::string::tests::toString::testStringToString_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) collection is of size 0\"", AdapterQualifier.unsupportedFeature)
            );
