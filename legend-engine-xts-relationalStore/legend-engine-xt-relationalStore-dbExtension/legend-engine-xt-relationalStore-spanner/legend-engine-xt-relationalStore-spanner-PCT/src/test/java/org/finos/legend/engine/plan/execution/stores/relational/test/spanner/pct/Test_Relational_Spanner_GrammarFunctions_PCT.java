...
public class Test_Relational_Spanner_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            //compare
            pack("meta::pure::functions::lang::tests::compare", "No SQL translation exists for the PURE function 'compare_T_1__T_1__Integer_1_'", AdapterQualifier.needsImplementation),
            ...
            //string-plus
            one("meta::pure::functions::string::tests::plus::testMultiPlusWithFunctionExpressions_Function_1__Boolean_1_", "\"[unsupported-api] The function 'toString' (state: [Select, false]) is not supported yet\"", AdapterQualifier.needsImplementation),
