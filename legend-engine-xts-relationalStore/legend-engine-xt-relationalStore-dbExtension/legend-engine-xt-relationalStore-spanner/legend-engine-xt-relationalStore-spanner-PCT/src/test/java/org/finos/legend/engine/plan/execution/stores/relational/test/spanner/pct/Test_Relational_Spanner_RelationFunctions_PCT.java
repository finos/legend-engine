...
public class Test_Relational_Spanner_RelationFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::composition::testExtendAddOnNull_Function_1__Boolean_1_", "Error while executing: insert into", AdapterQualifier.needsInvestigation), // error when inserting into table (id,grp) values (null,1);
            ...
            one("meta::pure::functions::relation::tests::composition::testExtendAddOnNull_Function_1__Boolean_1_", "Error while executing: insert into", AdapterQualifier.needsInvestigation), // Error while executing: insert into tb_8971898_1753454637615 (id,grp) values (2,null);"
            ...
            one("meta::pure::functions::relation::tests::composition::testExtendJoinStringOnNull_Function_1__Boolean_1_", "\"\nexpected: '#TDS\n   id,grp,name,newCol\n   10,0,J,J\n   2,1,null,J\n   6,1,F,\n   8,1,null,F\n   1,2,A,J\n   5,2,E,\n   3,3,C,J\n   7,3,G,\n   4,4,null,J\n   9,5,I,J\n#'\nactual:   '#TDS\n   id,grp,name,newCol\n   10,0,J,J\n   2,1,null,null\n   6,1,F,F\n   8,1,null,null\n   1,2,A,A\n   5,2,E,E\n   3,3,C,C\n   7,3,G,G\n   4,4,null,null\n   9,5,I,I\n#'\"", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::relation::tests::composition::testGroupByOnNull_Function_1__Boolean_1_", "Error while executing: insert into", AdapterQualifier.needsInvestigation), // Error while executing: insert into tb_8971898_1753454637615 (id,grp) values (2,null);"
