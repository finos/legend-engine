...
public class Test_Relational_Spanner_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::math::tests::stdDev::testSimpleGroupByStandardDeviationSample_Function_1__Boolean_1_", "Postgres function stddev_samp(double precision) is not supported", AdapterQualifier.unsupportedFeature),
            ...
            //variance
            one("meta::pure::functions::math::tests::variance::testSimpleGroupByVariancePopulation_Function_1__Boolean_1_", "Postgres function var_pop(bigint) is not supported", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::math::tests::variance::testSimpleGroupByVarianceSample_Function_1__Boolean_1_", "Postgres function var_samp(double precision) is not supported", AdapterQualifier.unsupportedFeature),
            ...
            // Percentile
            one("meta::pure::functions::math::tests::percentile::testPercentile_Relation_Aggregate_Function_1__Boolean_1_", "Postgres function percentile_disc(double precision) is not supported", AdapterQualifier.unsupportedFeature),
            ...
            // CosH
            pack("meta::pure::functions::math::tests::trigonometry::cosh", "Postgres function cosh(double precision) is not supported", AdapterQualifier.unsupportedFeature),

            // SinH
            pack("meta::pure::functions::math::tests::trigonometry::sinh", "Postgres function sinh(double precision) is not supported", AdapterQualifier.unsupportedFeature),

            // TanH
            pack("meta::pure::functions::math::tests::trigonometry::tanh", "Postgres function tanh(double precision) is not supported", AdapterQualifier.unsupportedFeature),
            ...
            // Greatest
            one("meta::pure::functions::collection::tests::greatest::testGreatest_DateTime_Function_1__Boolean_1_", "The Postgres Type is not supported: timestamp without time zone - Statement: 'select greatest(Timestamp'2025-02-10 20:10:20', Timestamp'2025-01-10 15:25:30')'", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::collection::tests::greatest::testGreatest_Date_Function_1__Boolean_1_", "The Postgres Type is not supported: timestamp without time zone - Statement: 'select greatest(Timestamp'2025-02-10 20:10:20', Date'2025-02-10')'", AdapterQualifier.unsupportedFeature),
            ...
            // Least
            one("meta::pure::functions::collection::tests::least::testLeast_DateTime_Function_1__Boolean_1_", "The Postgres Type is not supported: timestamp without time zone - Statement: 'select least(Timestamp'2025-02-10 20:10:20', Timestamp'2025-01-10 15:25:30')'", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::collection::tests::least::testLeast_Date_Function_1__Boolean_1_", "The Postgres Type is not supported: timestamp without time zone - Statement: 'select least(Timestamp'2025-02-10 20:10:20', Date'2025-02-10')'", AdapterQualifier.unsupportedFeature),
