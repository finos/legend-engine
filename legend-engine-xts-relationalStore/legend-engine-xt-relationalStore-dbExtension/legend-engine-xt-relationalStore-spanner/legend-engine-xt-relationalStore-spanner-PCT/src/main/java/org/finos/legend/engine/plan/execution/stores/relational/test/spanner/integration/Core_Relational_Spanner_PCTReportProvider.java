...
public class Core_Relational_Spanner_PCTReportProvider implements PCTReportProvider
{
    ...
    {
        return PCTReportProviderTool.load(Core_Relational_Spanner_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                ...
                "pct-reports/ADAPTER_variant_compiled_Spanner.json",
                "pct-reports/ADAPTER_scenario_quant_compiled_Spanner.json"
        );
    }
}
