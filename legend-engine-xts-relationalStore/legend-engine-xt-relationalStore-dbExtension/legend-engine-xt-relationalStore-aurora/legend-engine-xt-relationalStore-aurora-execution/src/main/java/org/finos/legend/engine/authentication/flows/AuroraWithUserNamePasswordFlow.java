...
public class AuroraWithUserNamePasswordFlow implements DatabaseAuthenticationFlow<AuroraDatasourceSpecification, UserNamePasswordAuthenticationStrategy>
{
    ...
    @Override
    public Credential makeCredential(Identity identity, AuroraDatasourceSpecification datasourceSpecification, UserNamePasswordAuthenticationStrategy authStrategy) throws Exception
    {
