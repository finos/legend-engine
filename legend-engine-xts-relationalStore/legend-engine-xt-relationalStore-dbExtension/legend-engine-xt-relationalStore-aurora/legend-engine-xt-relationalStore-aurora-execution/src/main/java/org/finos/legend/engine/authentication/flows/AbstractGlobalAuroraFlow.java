...
public abstract class AbstractGlobalAuroraFlow<A extends AuthenticationStrategy> implements DatabaseAuthenticationFlow<GlobalAuroraDatasourceSpecification, A>
{
    @Override
    public Class<GlobalAuroraDatasourceSpecification> getDatasourceClass()
    {
        return GlobalAuroraDatasourceSpecification.class;
    }
    ...
    @Override
    public Properties getDataSourceProperties(String dataSourceName, Identity identity, GlobalAuroraDatasourceSpecification datasourceSpecification, A authenticationStrategy, RuntimeContext runtimeContext)
    {
        Properties properties = new Properties();
        properties.put("clusterId", dataSourceName);
        properties.put("failoverHomeRegion", datasourceSpecification.region);
        properties.put("globalClusterInstanceHostPatterns", String.join(",", datasourceSpecification.globalClusterInstanceHostPatterns));
