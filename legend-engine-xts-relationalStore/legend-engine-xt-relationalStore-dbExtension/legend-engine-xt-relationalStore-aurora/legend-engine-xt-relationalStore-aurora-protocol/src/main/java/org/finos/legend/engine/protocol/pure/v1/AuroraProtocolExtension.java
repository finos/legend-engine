...
public class AuroraProtocolExtension implements PureProtocolExtension
{
    @Override
    ...
    public List<Function0<List<ProtocolSubTypeInfo<?>>>> getExtraProtocolSubTypeInfoCollectors()
    {
        return Lists.fixedSize.with(() -> Lists.fixedSize.with(
                ProtocolSubTypeInfo.newBuilder(DatasourceSpecification.class)
                        .withSubtype(AuroraDatasourceSpecification.class, "aurora")
                        .withSubtype(GlobalAuroraDatasourceSpecification.class, "globalAurora")
                        .build(),
