...
public class Test_Relational_H2_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Size
            one("meta::pure::functions::collection::tests::size::testSizeEmpty_Function_1__Boolean_1_", "Couldn't find DynaFunction to Postgres model translation for array_size().", AdapterQualifier.unsupportedFeature),
