...
public class Test_Relational_H2_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Variance
            one("meta::pure::functions::math::tests::variance::testVarianceSample_Function_1__Boolean_1_", "No matched function in function registry for - var_samp(DoubleSqlType, DoubleSqlType, DoubleSqlType).", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::math::tests::variance::testVariancePopulation_Function_1__Boolean_1_", "\"No matched function in function registry for - var_pop(IntegerSqlType, IntegerSqlType).", AdapterQualifier.needsImplementation),
            ...
            // Max
            one("meta::pure::functions::math::tests::max::testMax_Floats_Function_1__Boolean_1_", "Couldn't find DynaFunction to Postgres model translation for toVariantList().", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::math::tests::max::testMax_Integers_Function_1__Boolean_1_", "Couldn't find DynaFunction to Postgres model translation for toVariantList().", AdapterQualifier.needsImplementation),
            ...
            // Min
            one("meta::pure::functions::math::tests::min::testMin_Floats_Function_1__Boolean_1_", "Couldn't find DynaFunction to Postgres model translation for toVariantList().", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::math::tests::min::testMin_Integers_Function_1__Boolean_1_", "Couldn't find DynaFunction to Postgres model translation for toVariantList().", AdapterQualifier.needsImplementation),
            ...
            one("meta::pure::functions::collection::tests::min::testMin_Function_1__Boolean_1_", "Cannot cast a collection of size 0 to multiplicity [1]", AdapterQualifier.needsImplementation),
            ...
            // Date
            pack("meta::pure::functions::date::tests::timeBucket::dateTime", "H2 SQL Dialect does not support the function - time_bucket", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::date::tests::timeBucket::strictDate::testTimeBucketDays_Function_1__Boolean_1_", "\"H2 SQL Dialect does not support the function - time_bucket\"", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::date::tests::timeBucket::strictDate::testTimeBucketMonths_Function_1__Boolean_1_", "\"H2 SQL Dialect does not support the function - time_bucket\"", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::date::tests::timeBucket::strictDate::testTimeBucketWeeks_Function_1__Boolean_1_", "\"H2 SQL Dialect does not support the function - time_bucket\"", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::date::tests::timeBucket::strictDate::testTimeBucketYears_Function_1__Boolean_1_", "\"H2 SQL Dialect does not support the function - time_bucket\"", AdapterQualifier.needsImplementation),
            ...
            // Percentile
            one("meta::pure::functions::math::tests::percentile::testPercentile_Function_1__Boolean_1_", "Match failure: MapRelationalLambdaObject instanceOf MapRelationalLambda", AdapterQualifier.needsImplementation),
