...
public class TypeInfo extends ExtTypeInfo implements Typed
{
    ...
    private static TypeInfo getHigherRow(TypeInfo type1, TypeInfo type2)
    {
        ...
        ExtTypeInfoRow ext1 = (ExtTypeInfoRow) type1.getExtTypeInfo();
        ExtTypeInfoRow ext2 = (ExtTypeInfoRow) type2.getExtTypeInfo();
        if (ext1.equals(ext2))
        {
            return type1;
        }
    ...
    private static boolean areComparable(TypeInfo t1, TypeInfo t2)
    {
        ...
        int vt2 = (t2 = t2.unwrapRow()).getValueType();
        if (vt1 > vt2)
        {
            int vt = vt1;
            vt1 = vt2;
        ...
        if (vt1 == vt2)
        {
            switch (vt1)
            {
                ...
                case Value.ROW:
                {
                    ...
                    Iterator<Entry<String, TypeInfo>> i1 = f1.iterator();
                    Iterator<Entry<String, TypeInfo>> i2 = f2.iterator();
                    while (i1.hasNext())
                    {
