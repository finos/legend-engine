...
package org.finos.legend.engine.plan.execution.stores.relational.test.databricks.nonRelationalToRelational;
...
public class Test_Relational_Databricks_NonRelationalToRelational
{
    public static Test suite()
    {
        String testPackage = "meta::relational::tests::pct::databricks::nonRelationalToRelational";
        CompiledExecutionSupport executionSupport = PureTestBuilderCompiled.getClassLoaderExecutionSupport();

        MutableMap<String, String> pathToReason = Maps.mutable.<String, String>empty()
                .withKeyValue("meta::relational::mutation::tests::nonRelationalToRelational::testNonRelationalToRelationalSelect_Connection_1__Boolean_1_", "Create Temp not implemented for DatabricksCommands");
