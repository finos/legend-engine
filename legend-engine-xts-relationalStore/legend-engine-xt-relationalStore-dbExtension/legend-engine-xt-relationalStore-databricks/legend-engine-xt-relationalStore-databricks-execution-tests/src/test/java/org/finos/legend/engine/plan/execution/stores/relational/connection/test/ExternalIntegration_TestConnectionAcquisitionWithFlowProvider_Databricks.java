...
import org.finos.legend.engine.authentication.DatabricksTestDatabaseAuthenticationFlowProviderConfiguration;
...
public class ExternalIntegration_TestConnectionAcquisitionWithFlowProvider_Databricks extends RelationalConnectionTest
{
    ...
    {
        DatabricksTestDatabaseAuthenticationFlowProviderConfiguration flowProviderConfiguration = null;
        DatabricksTestDatabaseAuthenticationFlowProvider flowProvider = new DatabricksTestDatabaseAuthenticationFlowProvider();
    ...
    {
        return getRelationalConnectionByElement(readRelationalConnections(getResourceAsString("/org/finos/legend/engine/server/test/databricksRelationalDatabaseConnections.json")), "firstConn");
    }
}
