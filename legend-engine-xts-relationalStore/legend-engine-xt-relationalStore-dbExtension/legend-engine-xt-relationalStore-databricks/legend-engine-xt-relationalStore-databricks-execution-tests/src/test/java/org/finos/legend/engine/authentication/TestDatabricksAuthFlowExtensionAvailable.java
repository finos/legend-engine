...
public class TestDatabricksAuthFlowExtensionAvailable
{
    ...
    {
        MutableList<DatabaseAuthenticationFlowProvider> databaseAuthenticationFlowProviderExtensions = Lists.mutable.withAll(ServiceLoader.load(DatabaseAuthenticationFlowProvider.class));
