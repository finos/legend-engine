...
public abstract class AbstractTestSnowflakeSemiStructured
{
    ...
    {
        try (BufferedReader buffer = new BufferedReader(new InputStreamReader(Objects.requireNonNull(AbstractTestSnowflakeSemiStructured.class.getResourceAsStream(resourcePath)))))
        {
