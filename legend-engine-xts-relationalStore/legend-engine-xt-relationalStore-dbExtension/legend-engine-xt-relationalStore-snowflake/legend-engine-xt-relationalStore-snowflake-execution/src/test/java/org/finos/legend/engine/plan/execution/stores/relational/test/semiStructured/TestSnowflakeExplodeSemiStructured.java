...
public class TestSnowflakeExplodeSemiStructured extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testComplexProjectFlattenedAndExplodedPropertiesInProject()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                        "    (\n" +
                        "      type = TDS[(Id, String, VARCHAR(100), \"\"), (Entity Tag, String, VARCHAR(1000), \"\"), (Entity Tag Id, String, VARCHAR(1000), \"\"), (Orders/Id, String, VARCHAR(100), \"\")]\n" +
                        ...
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        String TDSType = "  type = TDS[(Id, String, VARCHAR(100), \"\"), (Entity Tag, String, VARCHAR(1000), \"\"), (Entity Tag Id, String, VARCHAR(1000), \"\"), (Orders/Id, String, VARCHAR(100), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testAggregationAggregateExplodedPropertyInsideProject()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Id, String, VARCHAR(100), \"\"), (Account, String, VARCHAR(100), \"\"), (Buy Order, Integer, INT, \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Id, String, VARCHAR(100), \"\"), (Account, String, VARCHAR(100), \"\"), (Buy Order, Integer, INT, \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
