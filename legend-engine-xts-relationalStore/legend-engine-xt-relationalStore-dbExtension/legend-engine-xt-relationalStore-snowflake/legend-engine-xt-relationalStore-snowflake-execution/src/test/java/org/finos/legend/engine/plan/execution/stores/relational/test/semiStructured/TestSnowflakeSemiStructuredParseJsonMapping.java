...
public class TestSnowflakeSemiStructuredParseJsonMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testParseJsonInMapping()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Name, String, VARCHAR(1000), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup1, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup2, String, VARCHAR(1000), \"\")]\n" +
                ...
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Name, String, VARCHAR(1000), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup1, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup2, String, VARCHAR(1000), \"\")]\n";
