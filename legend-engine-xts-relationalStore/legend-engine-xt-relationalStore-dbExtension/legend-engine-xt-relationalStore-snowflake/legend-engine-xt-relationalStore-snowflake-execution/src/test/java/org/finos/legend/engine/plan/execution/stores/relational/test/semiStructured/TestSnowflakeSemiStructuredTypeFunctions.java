...
public class TestSnowflakeSemiStructuredTypeFunctions extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSemiStructuredTypeNameFunctionUsageInProjectWithFunctions()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                        "    (\n" +
                        "      type = TDS[(Customer Address Type, String, VARCHAR(8192), \"\"), (Payment Type, String, VARCHAR(8192), \"\")]\n" +
                        ...
                        "    )\n";
        String TDSType = "  type = TDS[(Customer Address Type, String, VARCHAR(8192), \"\"), (Payment Type, String, VARCHAR(8192), \"\")]\n";
    ...
    public void testLegendJsonSchemaSemiStructuredTypeNameFunctionUsageInProjectWithFunctions()
    {
        ...
        String snowflakeExpected2 =
                ...
                "      type = TDS[(Customer Address Type, String, VARCHAR(8192), \"\"), (Payment Type, String, VARCHAR(8192), \"\")]\n" +
                "      resultColumns = [(\"Customer Address Type\", \"\"), (\"Payment Type\", \"\")]\n" +
                "      sql = select substring(\"root\".CUSTOMER['customerAddress']['_type']::varchar, ((length(\"root\".CUSTOMER['customerAddress']['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['customerAddress']['_type']::varchar)))) as \"Customer Address Type\", substring(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar, ((length(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar)))) as \"Payment Type\" from ORDER_SCHEMA.ORDER_TABLE as \"root\"\n" +
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
    ...
    public void testSemiStructuredTypeNameFunctionUsageInFilter()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                        "    (\n" +
                        "      type = TDS[(Order Id, Integer, INT, \"\"), (Customer Address Type, String, VARCHAR(8192), \"\")]\n" +
                        ...
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        String TDSType = "  type = TDS[(Order Id, Integer, INT, \"\"), (Customer Address Type, String, VARCHAR(8192), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testLegendJsonSchemaSemiStructuredTypeNameFunctionUsageInFilter()
    {
        ...
        String snowflakeExpected2 =
                "    Relational\n" +
                        ...
                        "      type = TDS[(Order Id, Integer, INT, \"\"), (Customer Address Type, String, VARCHAR(8192), \"\")]\n" +
                        "      resultColumns = [(\"Order Id\", INT), (\"Customer Address Type\", \"\")]\n" +
                        "      sql = select \"root\".ORDERID as \"Order Id\", substring(\"root\".CUSTOMER['customerAddress']['_type']::varchar, ((length(\"root\".CUSTOMER['customerAddress']['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['customerAddress']['_type']::varchar)))) as \"Customer Address Type\" from ORDER_SCHEMA.ORDER_TABLE as \"root\" where substring(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar, ((length(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['transactionDetails']['payment']['_type']::varchar)))) = 'CashOnDeliveryPayment'\n" +
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected2), snowflakePlan2);
    }
    ...
    public void testSemiStructuredTypeNameFunctionUsageAfterFlattenFunction()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                        "    (\n" +
                        "      type = TDS[(Order Id, Integer, INT, \"\"), (Product Type, String, VARCHAR(8192), \"\")]\n" +
                        ...
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        String TDSType = "  type = TDS[(Order Id, Integer, INT, \"\"), (Product Type, String, VARCHAR(8192), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testLegendJsonSchemaSemiStructuredTypeNameFunctionUsageAfterFlattenFunction()
    {
        ...
        String snowflakeExpected2 =
                "    Relational\n" +
                        ...
                        "      type = TDS[(Order Id, Integer, INT, \"\"), (Product Type, String, VARCHAR(8192), \"\")]\n" +
                        "      resultColumns = [(\"Order Id\", INT), (\"Product Type\", \"\")]\n" +
                        "      sql = select \"root\".ORDERID as \"Order Id\", substring(\"ss_flatten_0\".VALUE['_type']::varchar, ((length(\"ss_flatten_0\".VALUE['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"ss_flatten_0\".VALUE['_type']::varchar)))) as \"Product Type\" from ORDER_SCHEMA.ORDER_TABLE as \"root\" inner join lateral flatten(input => \"root\".CUSTOMER['products'], outer => true, recursive => false, mode => 'array') as \"ss_flatten_0\"\n" +
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected2), snowflakePlan2);
    }
    ...
    public void testSemiStructuredTypeNameFunctionUsageAfterArrayElementAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                        "    (\n" +
                        "      type = TDS[(Order Id, Integer, INT, \"\"), (Product 0 Type, String, VARCHAR(8192), \"\"), (Product 1 Type, String, VARCHAR(8192), \"\")]\n" +
                        ...
                        "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                        "    )\n";
        String TDSType = "  type = TDS[(Order Id, Integer, INT, \"\"), (Product 0 Type, String, VARCHAR(8192), \"\"), (Product 1 Type, String, VARCHAR(8192), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testLegendJsonSchemaSemiStructuredTypeNameFunctionUsageAfterArrayElementAccess()
    {
        ...
        String snowflakeExpected2 =
                ...
                "      type = TDS[(Order Id, Integer, INT, \"\"), (Product 0 Type, String, VARCHAR(8192), \"\"), (Product 1 Type, String, VARCHAR(8192), \"\")]\n" +
                "      resultColumns = [(\"Order Id\", INT), (\"Product 0 Type\", \"\"), (\"Product 1 Type\", \"\")]\n" +
                "      sql = select \"root\".ORDERID as \"Order Id\", substring(\"root\".CUSTOMER['products'][0]['_type']::varchar, ((length(\"root\".CUSTOMER['products'][0]['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['products'][0]['_type']::varchar)))) as \"Product 0 Type\", substring(\"root\".CUSTOMER['products'][1]['_type']::varchar, ((length(\"root\".CUSTOMER['products'][1]['_type']::varchar) + 2) - CHARINDEX('::', reverse(\"root\".CUSTOMER['products'][1]['_type']::varchar)))) as \"Product 1 Type\" from ORDER_SCHEMA.ORDER_TABLE as \"root\"\n" +
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected2), snowflakePlan2);
    }
    ...
    public void testLegendJsonSchemaSemiStructuredTypePathFunctionUsageInProjectWithFunctions()
    {
        ...
        String TDSType = "  type = TDS[(Customer Address Type, String, VARCHAR(8192), \"\"), (Payment Type, String, VARCHAR(8192), \"\")]\n";
        String snowflakePlan = this.buildExecutionPlanString(queryFunction, snowflakeMappingWithMinimalLegendJsonSchema, snowflakeRuntime);
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Customer Address Type, String, VARCHAR(8192), \"\"), (Payment Type, String, VARCHAR(8192), \"\")]\n" +
