...
public class TestSnowflakeSimpleSemiStructuredMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSingleSemiStructuredPropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Firm Legal Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "    )\n";
        String TDSType = "  type = TDS[(Firm Legal Name, String, VARCHAR(1000), \"\")]\n";
    ...
    public void testCombinedPrimitiveAndSemiStructuredPropertyAccessParallel()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testCombinedPrimitiveAndSemiStructuredPropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Out Col, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Out Col, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testCombinedComplexAndSemiStructuredPropertyAccessParallel()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Manager First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Manager First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testNestedSemiStructuredPropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Firm Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Firm Address Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testMultipleSemiStructuredPropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Firm Legal Name, String, VARCHAR(1000), \"\"), (Firm Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Firm Legal Name, String, VARCHAR(1000), \"\"), (Firm Address Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testMultipleSemiStructuredPropertyAccessCombined()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Firm Legal Name And Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Firm Legal Name And Address Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testGroupByWithSemiStructuredProperty()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(Address, String, VARCHAR(1000), \"\"), (Names, String, VARCHAR(200), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Address, String, VARCHAR(1000), \"\"), (Names, String, VARCHAR(200), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testIsEmptyCheckOnSemiStructuredPrimitivePropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (First Address Street, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (First Address Street, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testIsEmptyCheckOnSemiStructuredPropertyAccessAfterAt()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (First Address Line, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (First Address Line, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredDifferentDataTypePropertyAccess()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Firm Employee Count, Integer, INT, \"\"), (Firm MNC, Boolean, \"\", \"\"), (Firm Est Date, StrictDate, \"\", \"\"), (Firm Last Update, DateTime, \"\", \"\"), (Firm Address Street, String, VARCHAR(1000), \"\"), (Firm Entity Type, simple::model::EntityType, \"\", \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Firm Employee Count, Integer, INT, \"\"), (Firm MNC, Boolean, \"\", \"\"), (Firm Est Date, StrictDate, \"\", \"\"), (Firm Last Update, DateTime, \"\", \"\"), (Firm Address Street, String, VARCHAR(1000), \"\"), (Firm Entity Type, simple::model::EntityType, \"\", \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredArrayElementAccessPrimitive()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Other Name 0, String, VARCHAR(1000), \"\"), (Firm Other Name 1, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Other Name 0, String, VARCHAR(1000), \"\"), (Firm Other Name 1, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredArrayElementAccessComplex()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address Line 0, String, VARCHAR(1000), \"\"), (Firm Address Line 1, String, VARCHAR(1000), \"\"), (Firm Address Line 2, String, VARCHAR(1000), \"\"), (Firm Address Line 3, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address Line 0, String, VARCHAR(1000), \"\"), (Firm Address Line 1, String, VARCHAR(1000), \"\"), (Firm Address Line 2, String, VARCHAR(1000), \"\"), (Firm Address Line 3, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredPropertyAccessAtNestedProperty()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Name, String, VARCHAR(1000), \"\"), (Manager Firm Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Name, String, VARCHAR(1000), \"\"), (Manager Manager Manager Firm Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Name, String, VARCHAR(1000), \"\"), (Manager Firm Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Name, String, VARCHAR(1000), \"\"), (Manager Manager Manager Firm Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
