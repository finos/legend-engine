...
public class TestSnowflakeSimpleSemiStructuredMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSemiStructuredDifferentDataTypePropertyAccess()
    {
        ...
        String snowflakeExpected =
                ...
                "      sql = select \"root\".FIRSTNAME as \"First Name\", \"root\".FIRM_DETAILS['legalName']::varchar as \"Firm Legal Name\", \"root\".FIRM_DETAILS['employeeCount']::number as \"Firm Employee Count\", \"root\".FIRM_DETAILS['mnc']::boolean as \"Firm MNC\", \"root\".FIRM_DETAILS['estDate']::date as \"Firm Est Date\", \"root\".FIRM_DETAILS['lastUpdate']::timestamp as \"Firm Last Update\", \"root\".FIRM_DETAILS['address']['street']::varchar as \"Firm Address Street\", \"root\".FIRM_DETAILS['entityType']::varchar as \"Firm Entity Type\" from PERSON_SCHEMA.PERSON_TABLE as \"root\"\n" +
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
