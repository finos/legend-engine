...
public class TestSnowflakeSemiStructuredInheritanceMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSemiStructuredPropertyAccessAtBaseClass()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address Name, String, VARCHAR(1000), \"\")]\n";
    ...
    public void testSemiStructuredPropertyAccessAtSubClass()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address 0 Line No, Integer, INT, \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address 0 Line No, Integer, INT, \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredPropertyAccessAtSubClassNested()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address 0 Line No, Integer, INT, \"\"), (Firm Address Street, String, VARCHAR(1000), \"\"), (Firm Address City, String, VARCHAR(1000), \"\"), (Firm Address State, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Address 0 Line No, Integer, INT, \"\"), (Firm Address Street, String, VARCHAR(1000), \"\"), (Firm Address City, String, VARCHAR(1000), \"\"), (Firm Address State, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
