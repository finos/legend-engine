...
public class TestSnowflakeExtractFromSemiStructuredSimple extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testDotAndBracketNotationAccess()
    {
        ...
        String snowflakeExpected =
                ...
                "    )\n";
        String TDSType = "  type = TDS[(Id, Integer, INT, \"\"), (Dot Only, StrictDate, \"\", \"\"), (Bracket Only, DateTime, \"\", \"\"), (Dot & Bracket, String, VARCHAR(1000), \"\")]\n";
    ...
    public void testArrayElementNoFlattenAccess()
    {
        ...
        String snowflakeExpected =
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Id, Integer, INT, \"\"), (Second Line of Address, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testAllDataTypesAccess()
    {
        ...
        String snowflakeExpected =
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(Id, Integer, INT, \"\"), (Legal Name, String, VARCHAR(1000), \"\"), (Est Date, StrictDate, \"\", \"\"), (Mnc, Boolean, \"\", \"\"), (Employee Count, Integer, INT, \"\"), (Last Update, DateTime, \"\", \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
