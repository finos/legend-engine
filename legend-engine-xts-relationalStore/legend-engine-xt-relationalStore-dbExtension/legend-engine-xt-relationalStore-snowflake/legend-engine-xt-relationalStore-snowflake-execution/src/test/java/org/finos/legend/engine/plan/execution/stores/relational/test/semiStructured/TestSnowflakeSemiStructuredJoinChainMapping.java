...
public class TestSnowflakeSemiStructuredJoinChainMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSingleJoinInChain()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\")]\n";
    ...
    public void testMultipleJoinsInChain()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup1, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup2, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup1, String, VARCHAR(1000), \"\"), (Manager Manager Firm Legal Name Dup2, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
