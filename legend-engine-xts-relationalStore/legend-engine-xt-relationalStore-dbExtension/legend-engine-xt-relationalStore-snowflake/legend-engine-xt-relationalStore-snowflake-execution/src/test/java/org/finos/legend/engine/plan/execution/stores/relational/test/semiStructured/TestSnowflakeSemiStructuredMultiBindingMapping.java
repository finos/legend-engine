...
public class TestSnowflakeSemiStructuredMultiBindingMapping extends AbstractTestSnowflakeSemiStructured
{
    ...
    public void testSemiStructuredPropertyAccessFromSingleBindingMapping()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Address Name, String, VARCHAR(1000), \"\")]\n";
    ...
    public void testSemiStructuredPropertyAccessFromMultipleBindingMapping()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Address Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Address Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
    ...
    public void testSemiStructuredRelOpWithJoinPropertyAccessFromMultipleBindingMapping()
    {
        ...
        String snowflakeExpected =
                "    Relational\n" +
                "    (\n" +
                "      type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Address Name, String, VARCHAR(1000), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\")]\n" +
                ...
                "      connection = RelationalDatabaseConnection(type = \"Snowflake\")\n" +
                "    )\n";
        String TDSType = "  type = TDS[(First Name, String, VARCHAR(100), \"\"), (Firm Legal Name, String, VARCHAR(1000), \"\"), (Address Name, String, VARCHAR(1000), \"\"), (Manager Firm Legal Name, String, VARCHAR(1000), \"\")]\n";
        Assert.assertEquals(wrapPreAndFinallyExecutionSqlQuery(TDSType, snowflakeExpected), snowflakePlan);
    }
