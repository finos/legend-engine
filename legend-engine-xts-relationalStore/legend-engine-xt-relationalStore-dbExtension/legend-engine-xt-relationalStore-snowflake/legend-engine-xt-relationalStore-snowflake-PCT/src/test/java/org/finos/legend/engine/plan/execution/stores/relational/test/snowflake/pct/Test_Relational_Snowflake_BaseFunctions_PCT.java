...
public class Test_Relational_Snowflake_BaseFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            // Contains
            one("meta::pure::functions::collection::tests::contains::testContainsNonPrimitive_Function_1__Boolean_1_", "Assert failure at (resource:/core_relational/relational/pureToSQLQuery/pureToSQLQuery.pure line:4373 column:18), \"Parameter to IN operation isn't a literal!\""),
