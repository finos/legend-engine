...
public class Test_Relational_Snowflake_PCT
{
    private static final Adapter SNOWFLAKE_ADAPTER = CoreRelationalSnowflakeCodeRepositoryProvider.snowflakeAdapter;
    ...
    public static Test suite()
    {
        ...
        return wrapSuite(
                ...
                () ->
                {
                    TestSuite suite = new TestSuite(Test_Relational_Snowflake_PCT.class.getName());
    ...
    private static MutableList<TestServerResource> snowflakeTestServerResources()
    {
        return Lists.mutable.with((TestServerResource) TestConnectionIntegrationLoader.extensions().select(c -> c.getDatabaseType() == DatabaseType.Snowflake).getFirst());
    }

    private abstract static class SnowflakePCTReportConfiguration extends PCTReportConfiguration
    {
        private final ReportScope reportScope;
        private final String manifestPath;

        protected SnowflakePCTReportConfiguration(ReportScope reportScope, String manifestPath)
        {
    ...
    public static class EssentialFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.essentialFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/EssentialFunctions_manifest.json";
    ...
    public static class GrammarFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.grammarFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/GrammarFunctions_manifest.json";
    ...
    public static class RelationFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = RelationCodeRepositoryProvider.relationFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/RelationFunctions_manifest.json";
    ...
    public static class ScenarioQuantFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreScenarioQuantCodeRepositoryProvider.scenario_Quant_Functions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/ScenarioQuantFunctions_manifest.json";
    ...
    public static class StandardFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreStandardFunctionsCodeRepositoryProvider.standardFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/StandardFunctions_manifest.json";
    ...
    public static class UnclassifiedFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreUnclassifiedFunctionsCodeRepositoryProvider.unclassifiedFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/UnclassifiedFunctions_manifest.json";
    ...
    public static class VariantFunctions extends SnowflakePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = VariantCodeRepositoryProvider.variantFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-snowflake/VariantFunctions_manifest.json";
