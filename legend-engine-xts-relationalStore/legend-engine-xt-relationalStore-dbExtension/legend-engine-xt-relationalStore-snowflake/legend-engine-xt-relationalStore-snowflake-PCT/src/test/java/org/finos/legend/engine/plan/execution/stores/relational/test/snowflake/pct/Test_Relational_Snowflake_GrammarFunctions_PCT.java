...
public class Test_Relational_Snowflake_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqNonPrimitive_Function_1__Boolean_1_", "\"Left multiplicity error. Please use 'exists' instead of '==' in the expression: [1 SideClass/].all() == [1 SideClass/].all()\""),
            ...
            one("meta::pure::functions::boolean::tests::equality::equal::testEqualNonPrimitive_Function_1__Boolean_1_", "\"Left multiplicity error. Please use 'exists' instead of '==' in the expression: [1 SideClass/].all() == [1 SideClass/].all()\""),
            ...
            // Plus
            one("meta::pure::functions::math::tests::plus::testDecimalPlus_Function_1__Boolean_1_", "class java.lang.Long cannot be cast to class java.math.BigDecimal (java.lang.Long and java.math.BigDecimal are in module java.base of loader 'bootstrap')"),
