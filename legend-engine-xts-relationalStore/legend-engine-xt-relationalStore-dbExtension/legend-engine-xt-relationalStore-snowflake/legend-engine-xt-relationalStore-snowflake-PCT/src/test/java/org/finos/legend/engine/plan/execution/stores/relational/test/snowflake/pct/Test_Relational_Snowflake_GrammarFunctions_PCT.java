...
public class Test_Relational_Snowflake_GrammarFunctions_PCT extends PCTReport
{
    private static final ReportScope reportScope = PlatformCodeRepositoryProvider.grammarFunctions;
    private static final String adapter = "meta::relational::tests::pct::testAdapterForRelationalWithSnowflakeExecution_Function_1__X_o_";
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqNonPrimitive_Function_1__Boolean_1_", "Assert failure at (resource:/core_relational/relational/pureToSQLQuery/pureToSQLQuery.pure line:6395 column:4), \"Left multiplicity error. Please use 'exists' instead of '==' in the expression: [1 SideClass/].all() == [1 SideClass/].all()\""),
            ...
            one("meta::pure::functions::boolean::tests::equality::equal::testEqualNonPrimitive_Function_1__Boolean_1_", "Assert failure at (resource:/core_relational/relational/pureToSQLQuery/pureToSQLQuery.pure line:6395 column:4), \"Left multiplicity error. Please use 'exists' instead of '==' in the expression: [1 SideClass/].all() == [1 SideClass/].all()\""),
            ...
            one("meta::pure::functions::math::tests::divide::testDivideWithNonTerminatingExpansion_Function_1__Boolean_1_", "Assert failure at (resource:/platform/pure/basics/tests/assert.pure line:21 column:5), \"\nexpected: 0.010416666666666666\nactual:   0.010417\""),
            ...
            one("meta::pure::functions::math::tests::plus::testPlusNumber_Function_1__Boolean_1_", "Assert failure at (resource:/platform/pure/basics/tests/assert.pure line:21 column:5), \"\nexpected: 32.0\nactual:   32\""),
