...
public class Test_Relational_Snowflake_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::fold::testFoldWithEmptyAccumulator_Function_1__Boolean_1_", "\"Nil is not managed yet!\"", AdapterQualifier.needsInvestigation),
            ...
            // Sort
            one("meta::pure::functions::collection::tests::sort::testMixedSortNoComparator_Function_1__Boolean_1_", "\"Number is not managed yet!\"", AdapterQualifier.unsupportedFeature),
