...
public class SnowflakeRelationalDatabaseManager implements RelationalDatabaseManager
{
    ...
    {
        return Lists.mutable.with(RelationalDatabaseType.SNOWFLAKE.getIdentifier());
    }
