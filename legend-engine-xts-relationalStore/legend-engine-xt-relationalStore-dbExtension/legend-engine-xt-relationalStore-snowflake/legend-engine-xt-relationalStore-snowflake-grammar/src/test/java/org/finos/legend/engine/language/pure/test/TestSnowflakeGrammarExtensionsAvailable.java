...
import org.finos.legend.engine.language.pure.grammar.from.SnowflakeGrammarParserExtension;
...
public class TestSnowflakeGrammarExtensionsAvailable
{
    @Test
    public void testCompilerExtensionAvailable()
    {
        ...
        Assert.assertTrue(compilerExtensions.contains(SnowflakeCompilerExtension.class));
    }
    ...
    public void testGrammarParserExtensionAvailable()
    {
        MutableList<Class<?>> relationalGrammarParserExtensions =
                Lists.mutable.withAll(ServiceLoader.load(IRelationalGrammarParserExtension.class))
                        .collect(Object::getClass);
        Assert.assertTrue(relationalGrammarParserExtensions.contains(SnowflakeGrammarParserExtension.class));
    }
    ...
    public void testGrammarComposerExtensionAvailable()
    {
        MutableList<Class<?>> pureGrammarComposerExtensions =
                Lists.mutable.withAll(ServiceLoader.load(PureGrammarComposerExtension.class))
                        .collect(Object::getClass);
        Assert.assertTrue(pureGrammarComposerExtensions.contains(SnowflakeGrammarComposerExtension.class));
    }
}
