...
public class Test_Relational_DbSpecific_Trino_UsingPureClientTestSuite extends Relational_DbSpecific_UsingPureClientTestSuite
{
    public static Test suite() throws Exception
    {
        return createSuite(
                "meta::relational::tests::sqlQueryToString::trino",
                "org/finos/legend/engine/server/test/userTestConfig_withTrinoTestConnection.json",
                new NamedType(TrinoTestDatabaseAuthenticationFlowProviderConfiguration.class, "trinoTest")
        );
    }
}