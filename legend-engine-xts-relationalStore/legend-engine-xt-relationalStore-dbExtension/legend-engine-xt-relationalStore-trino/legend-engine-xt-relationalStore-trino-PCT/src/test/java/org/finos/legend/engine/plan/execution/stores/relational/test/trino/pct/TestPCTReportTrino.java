...
public class TestPCTReportTrino
{
    @Test
    public void canFindPCTReport()
    {
        Assert.assertEquals(
                ...
                PCTReportProviderLoader.gatherReports().select(x -> x.adapterKey.adapter.name.equals("Trino")).collect(x -> x.reportScope.module).toSet()
        );
    }
}
