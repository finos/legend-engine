...
public class Test_Relational_Trino_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqVarIdentity_Function_1__Boolean_1_", "\"Filter expressions are only supported for Primitives and Enums. Filter contains a parameter of type BottomClass\""),
            ...
            one("meta::pure::functions::math::tests::minus::testLargeMinus_Function_1__Boolean_1_", "bigint subtraction overflow"),
            one("meta::pure::functions::math::tests::minus::testSingleMinus_Function_1__Boolean_1_", "line 1:11: mismatched input '<EOF>'. Expecting: '*', 'ALL', 'DISTINCT', <expression>"),
            ...
            one("meta::pure::functions::math::tests::plus::testLargePlus_Function_1__Boolean_1_", "bigint addition overflow"),
            ...
            one("meta::pure::functions::math::tests::times::testLargeTimes_Function_1__Boolean_1_", "bigint multiplication overflow"),
