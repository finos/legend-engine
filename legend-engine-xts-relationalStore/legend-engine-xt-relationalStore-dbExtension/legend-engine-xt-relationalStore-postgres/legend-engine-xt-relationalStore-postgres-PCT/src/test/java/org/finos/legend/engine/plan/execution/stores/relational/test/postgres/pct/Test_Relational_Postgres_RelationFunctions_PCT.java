...
public class Test_Relational_Postgres_RelationFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::over::testRange_ExplicitOffsets_WithNullValues_WithSinglePartition_WithOrderByASC_Function_1__Boolean_1_", "ERROR: RANGE PRECEDING is only supported with UNBOUNDED", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::relation::tests::over::testRange_ExplicitOffsets_WithNullValues_WithSinglePartition_WithOrderByDESC_Function_1__Boolean_1_", "ERROR: RANGE PRECEDING is only supported with UNBOUNDED", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::relation::tests::over::testRange_NPreceding_UnboundedFollowing_WithNullValues_WithSinglePartition_WithOrderByASC_Function_1__Boolean_1_", "ERROR: RANGE PRECEDING is only supported with UNBOUNDED", AdapterQualifier.needsInvestigation),
            one("meta::pure::functions::relation::tests::over::testRange_UnboundedPreceding_NFollowing_WithNullValues_WithSinglePartition_WithOrderByDESC_Function_1__Boolean_1_", "ERROR: RANGE FOLLOWING is only supported with UNBOUNDED", AdapterQualifier.needsInvestigation),
