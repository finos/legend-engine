...
public class Test_Relational_Postgres_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::date::tests::testAdjustByHoursBigNumber_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: interval out of range", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::date::tests::testAdjustByWeeksBigNumber_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: interval out of range", AdapterQualifier.needsInvestigation),
            ...
            // ParseInteger
            one("meta::pure::functions::string::tests::parseInteger::testParseInteger_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: value \"9999999999999992\" is out of range for type integer", AdapterQualifier.needsInvestigation)
    );
