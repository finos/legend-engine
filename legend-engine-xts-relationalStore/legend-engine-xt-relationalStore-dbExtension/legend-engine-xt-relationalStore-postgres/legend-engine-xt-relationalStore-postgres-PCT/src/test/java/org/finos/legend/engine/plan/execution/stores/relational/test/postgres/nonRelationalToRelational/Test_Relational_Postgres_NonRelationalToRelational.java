...
package org.finos.legend.engine.plan.execution.stores.relational.test.postgres.nonRelationalToRelational;
...
public class Test_Relational_Postgres_NonRelationalToRelational
{
    public static Test suite()
    {
        String testPackage = "meta::relational::tests::pct::postgres::nonRelationalToRelational";
