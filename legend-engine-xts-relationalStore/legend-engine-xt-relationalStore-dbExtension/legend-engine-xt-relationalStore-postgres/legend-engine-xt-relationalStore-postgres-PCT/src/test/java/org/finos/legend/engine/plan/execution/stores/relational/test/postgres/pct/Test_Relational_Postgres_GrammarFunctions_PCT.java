...
public class Test_Relational_Postgres_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::filter::testFilterLiteralFromVar_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::collection::tests::filter::testFilterLiteral_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::collection::tests::filter::testLambdaAsFunctionParameter_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.unsupportedFeature),

            // First
            one("meta::pure::functions::collection::tests::first::testFirstComplex_Function_1__Boolean_1_", "Expected at most one object, but found many", AdapterQualifier.needsImplementation),
            ...
            one("meta::pure::functions::math::tests::minus::testLargeMinus_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: bigint out of range", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::math::tests::minus::testSingleMinus_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: The column index is out of range: 1, number of columns: 0.", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::math::tests::plus::testLargePlus_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: bigint out of range", AdapterQualifier.needsInvestigation),
            ...
            one("meta::pure::functions::math::tests::times::testLargeTimes_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: bigint out of range", AdapterQualifier.needsInvestigation),
            ...
            // map / variant
            one("meta::pure::functions::collection::tests::map::testMap_FromVariantAsPrimitive_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::collection::tests::map::testMap_FromVariant_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.needsImplementation),

            // filter / variant
            one("meta::pure::functions::collection::tests::filter::testFilter_FromVariant_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::collection::tests::filter::testFilter_FromVariantAsPrimitive_Function_1__Boolean_1_", "[unsupported-api] relational lambda processing not supported for Database Type: Postgres", AdapterQualifier.needsImplementation),
