...
public class PostgresRelationalDatabaseManager implements RelationalDatabaseManager
{
    @Override
    public List<String> getIds()
    {
        return Lists.mutable.with("PostgreSQL", RelationalDatabaseType.POSTGRES.getIdentifier());
    }
