...
import org.finos.legend.engine.plan.execution.stores.relational.connection.driver.vendors.clickhouse.ClickHouseManager;

public class ClickHouseConnectionExtension implements ConnectionExtension
{
    @Override
    public String type()
    {
    ...
    {
        return Lists.mutable.of(new ClickHouseManager());
    }
}
