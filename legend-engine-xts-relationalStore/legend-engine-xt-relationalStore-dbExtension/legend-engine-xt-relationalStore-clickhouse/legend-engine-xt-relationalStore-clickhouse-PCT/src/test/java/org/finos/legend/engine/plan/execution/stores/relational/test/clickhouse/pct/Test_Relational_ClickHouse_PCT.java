...
public class Test_Relational_ClickHouse_PCT
{
    private static final Adapter CLICKHOUSE_ADAPTER = CoreRelationalClickHousePCTCodeRepositoryProvider.clickhouseAdapter;
    ...
    public static Test suite()
    {
        ...
        return wrapSuite(
                ...
                () ->
                {
                    TestSuite suite = new TestSuite(Test_Relational_ClickHouse_PCT.class.getName());
    ...
    private static MutableList<TestServerResource> clickhouseTestServerResources()
    {
        return Lists.mutable.with((TestServerResource) TestConnectionIntegrationLoader.extensions().select(c -> c.getDatabaseType() == DatabaseType.ClickHouse).getFirst());
    }

    private abstract static class ClickHousePCTReportConfiguration extends PCTReportConfiguration
    {
        private final ReportScope reportScope;
        private final String manifestPath;

        protected ClickHousePCTReportConfiguration(ReportScope reportScope, String manifestPath)
        {
    ...
    public static class EssentialFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.essentialFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/EssentialFunctions_manifest.json";
    ...
    public static class GrammarFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.grammarFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/GrammarFunctions_manifest.json";
    ...
    public static class RelationFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = RelationCodeRepositoryProvider.relationFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/RelationFunctions_manifest.json";
    ...
    public static class ScenarioQuantFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreScenarioQuantCodeRepositoryProvider.scenario_Quant_Functions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/ScenarioQuantFunctions_manifest.json";
    ...
    public static class StandardFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreStandardFunctionsCodeRepositoryProvider.standardFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/StandardFunctions_manifest.json";
    ...
    public static class UnclassifiedFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreUnclassifiedFunctionsCodeRepositoryProvider.unclassifiedFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/UnclassifiedFunctions_manifest.json";
    ...
    public static class VariantFunctions extends ClickHousePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = VariantCodeRepositoryProvider.variantFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-clickhouse/VariantFunctions_manifest.json";
