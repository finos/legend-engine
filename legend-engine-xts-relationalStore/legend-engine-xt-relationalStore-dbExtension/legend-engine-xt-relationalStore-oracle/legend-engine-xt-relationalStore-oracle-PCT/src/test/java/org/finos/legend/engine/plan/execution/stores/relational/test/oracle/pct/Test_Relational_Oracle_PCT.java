...
public class Test_Relational_Oracle_PCT
{
    private static final Adapter ORACLE_ADAPTER = CoreRelationalOraclePCTCodeRepositoryProvider.oracleAdapter;
    ...
    public static Test suite()
    {
        ...
        return wrapSuite(
                ...
                () ->
                {
                    TestSuite suite = new TestSuite(Test_Relational_Oracle_PCT.class.getName());
    ...
    private static MutableList<TestServerResource> oracleTestServerResources()
    {
        return Lists.mutable.with((TestServerResource) TestConnectionIntegrationLoader.extensions().select(c -> c.getDatabaseType() == DatabaseType.Oracle).getFirst());
    }

    private abstract static class OraclePCTReportConfiguration extends PCTReportConfiguration
    {
        private final ReportScope reportScope;
        private final String manifestPath;

        protected OraclePCTReportConfiguration(ReportScope reportScope, String manifestPath)
        {
    ...
    public static class EssentialFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.essentialFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/EssentialFunctions_manifest.json";
    ...
    public static class GrammarFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.grammarFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/GrammarFunctions_manifest.json";
    ...
    public static class RelationFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = RelationCodeRepositoryProvider.relationFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/RelationFunctions_manifest.json";
    ...
    public static class ScenarioQuantFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreScenarioQuantCodeRepositoryProvider.scenario_Quant_Functions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/ScenarioQuantFunctions_manifest.json";
    ...
    public static class StandardFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreStandardFunctionsCodeRepositoryProvider.standardFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/StandardFunctions_manifest.json";
    ...
    public static class UnclassifiedFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreUnclassifiedFunctionsCodeRepositoryProvider.unclassifiedFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/UnclassifiedFunctions_manifest.json";
    ...
    public static class VariantFunctions extends OraclePCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = VariantCodeRepositoryProvider.variantFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-oracle/VariantFunctions_manifest.json";
