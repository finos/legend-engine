...
public class Test_Relational_Oracle_GrammarFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // And
            pack("meta::pure::functions::boolean::tests::conjunctions::and", "class java.lang.String cannot be cast to class java.lang.Boolean"),

            // Not
            one("meta::pure::functions::boolean::tests::conjunctions::not::testNotFalseExpression_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            one("meta::pure::functions::boolean::tests::conjunctions::not::testNotFalse_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            ...
            one("meta::pure::functions::boolean::tests::conjunctions::not::testNotTrueExpression_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            one("meta::pure::functions::boolean::tests::conjunctions::not::testNotTrue_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            one("meta::pure::functions::boolean::tests::conjunctions::not::testOperatorScope_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),

            // Or
            pack("meta::pure::functions::boolean::tests::conjunctions::or", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqFloat_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            one("meta::pure::functions::boolean::tests::equality::eq::testEqInteger_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqPrimitiveExtension_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqVarIdentity_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean (java.lang.String and java.lang.Boolean are in module java.base of loader 'bootstrap')"),

            // Equal
            pack("meta::pure::functions::boolean::tests::equality::equal", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            ...
            pack("meta::pure::functions::boolean::tests::inequalities::greaterThan", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            pack("meta::pure::functions::boolean::tests::inequalities::greaterThanEqual", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            pack("meta::pure::functions::boolean::tests::inequalities::lessThan", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            pack("meta::pure::functions::boolean::tests::inequalities::lessThanEqual", "class java.lang.String cannot be cast to class java.lang.Boolean"),

            // Filter
            one("meta::pure::functions::collection::tests::filter::testFilterInstance_Function_1__Boolean_1_", "Error dynamically evaluating value specification"),
            one("meta::pure::functions::collection::tests::filter::testFilterLiteralFromVar_Function_1__Boolean_1_", "\"[unsupported-api] relational lambda processing not supported for Database Type: Oracle\""),
            one("meta::pure::functions::collection::tests::filter::testFilterLiteral_Function_1__Boolean_1_", "\"[unsupported-api] relational lambda processing not supported for Database Type: Oracle\""),
            one("meta::pure::functions::collection::tests::filter::testLambdaAsFunctionParameter_Function_1__Boolean_1_", "\"[unsupported-api] relational lambda processing not supported for Database Type: Oracle\""),
            ...
            //Is Empty boolean
            pack("meta::pure::functions::collection::tests::isEmpty", "class java.lang.String cannot be cast to class java.lang.Boolean"),
            ...
            one("meta::pure::functions::collection::tests::map::testMapRelationshipFromOneToOne_Function_1__Boolean_1_", "\"Error during dynamic reactivation: Error dynamically evaluating value specification"),

            // Range
            pack("meta::pure::functions::collection::tests::range", "\"[unsupported-api] The function 'range' (state: [Select, false]) is not supported yet\""),
            ...
            one("meta::pure::functions::string::tests::plus::testPlusInIterate_Function_1__Boolean_1_", "No relational processor matched function 'fold'. The function is registered in getContextBasedSupportedFunctions as a context-only entry; reaching this catchall means none of its earlier applicability predicates matched the current State during plan generation."),
            ...
            // NOT on a boolean literal surfaces as String on Oracle — needs investigation
            one("meta::pure::functions::boolean::tests::conjunctions::not::testBasicNot_Function_1__Boolean_1_", "class java.lang.String cannot be cast to class java.lang.Boolean", AdapterQualifier.needsInvestigation)
    );
