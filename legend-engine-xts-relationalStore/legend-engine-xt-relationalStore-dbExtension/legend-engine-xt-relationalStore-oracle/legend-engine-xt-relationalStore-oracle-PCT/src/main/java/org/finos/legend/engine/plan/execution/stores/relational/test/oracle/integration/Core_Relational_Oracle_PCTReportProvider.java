...
public class Core_Relational_Oracle_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Core_Relational_Oracle_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                ...
                "pct-reports/ADAPTER_scenario_quant_compiled_Oracle.json"
        );
    }
}
