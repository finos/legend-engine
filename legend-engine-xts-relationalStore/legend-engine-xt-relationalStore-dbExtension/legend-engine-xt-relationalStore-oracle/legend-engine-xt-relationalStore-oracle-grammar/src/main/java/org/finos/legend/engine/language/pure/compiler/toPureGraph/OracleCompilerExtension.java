...
import org.finos.legend.pure.generated.Root_meta_pure_alloy_connections_alloy_specification_OracleDatasourceSpecification;
import org.finos.legend.pure.generated.Root_meta_pure_alloy_connections_alloy_specification_OracleDatasourceSpecification_Impl;

import java.util.List;

public class OracleCompilerExtension implements IRelationalCompilerExtension
{
    @Override
    ...
    {
        return new OracleCompilerExtension();
    }

    @Override
    public List<DatabaseAuthenticationFlowKey> getFlowKeys()
    {
        return Lists.mutable.of(DatabaseAuthenticationFlowKey.newKey(DatabaseType.Oracle, OracleDatasourceSpecification.class, DelegatedKerberosAuthenticationStrategy.class),
                DatabaseAuthenticationFlowKey.newKey(DatabaseType.Oracle, OracleDatasourceSpecification.class, UserNamePasswordAuthenticationStrategy.class),
                DatabaseAuthenticationFlowKey.newKey(DatabaseType.Oracle, OracleDatasourceSpecification.class, TestDatabaseAuthenticationStrategy.class));
    }
}
