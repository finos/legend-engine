...
public class OracleGrammarComposerExtension implements IRelationalGrammarComposerExtension
{
    @Override
    public List<Function2<DatasourceSpecification, PureGrammarComposerContext, String>> getExtraDataSourceSpecificationComposers()
    {
        ...
        {
            if (_spec instanceof OracleDatasourceSpecification)
            {
                OracleDatasourceSpecification spec = (OracleDatasourceSpecification) _spec;
