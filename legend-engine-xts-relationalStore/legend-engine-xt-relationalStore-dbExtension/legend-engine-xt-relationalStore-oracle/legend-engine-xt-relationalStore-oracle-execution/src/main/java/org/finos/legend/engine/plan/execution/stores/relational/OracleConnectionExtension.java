...
public class OracleConnectionExtension implements PureProtocolExtension
{
    @Override
    public String type()
    {
    ...
    {
        return org.eclipse.collections.impl.factory.Lists.fixedSize.with(() -> org.eclipse.collections.impl.factory.Lists.fixedSize.with(
