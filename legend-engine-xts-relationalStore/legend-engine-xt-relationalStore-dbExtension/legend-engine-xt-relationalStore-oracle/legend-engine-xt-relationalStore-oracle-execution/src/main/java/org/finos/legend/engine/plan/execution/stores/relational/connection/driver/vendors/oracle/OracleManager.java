...
package org.finos.legend.engine.plan.execution.stores.relational.connection.driver.vendors.oracle;
...
public class OracleManager extends DatabaseManager
{
    ...
    {
        return Lists.mutable.with("Oracle");
    }
    ...
    {
        return "org.finos.legend.engine.plan.execution.stores.relational.connection.driver.vendors.oracle.OracleDriver";
    }
