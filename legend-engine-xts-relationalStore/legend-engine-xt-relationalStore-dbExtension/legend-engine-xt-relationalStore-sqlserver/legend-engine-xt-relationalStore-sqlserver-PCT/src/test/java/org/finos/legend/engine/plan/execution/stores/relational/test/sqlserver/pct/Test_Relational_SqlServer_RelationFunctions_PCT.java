...
public class Test_Relational_SqlServer_RelationFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::composition::testNestedJoinComplexComparisonExpression_Function_1__Boolean_1_", "Error while executing: Create Table leSchema"),
