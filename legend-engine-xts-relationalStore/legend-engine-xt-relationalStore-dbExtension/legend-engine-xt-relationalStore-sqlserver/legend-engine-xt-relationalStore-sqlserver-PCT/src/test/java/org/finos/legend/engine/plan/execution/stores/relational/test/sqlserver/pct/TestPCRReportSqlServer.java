...
public class TestPCRReportSqlServer
{
    @Test
    public void canFindPCTReport()
    {
        Assert.assertEquals(
                ...
                PCTReportProviderLoader.gatherReports().select(x -> x.adapterKey.adapter.name.equals("SqlServer")).collect(x -> x.reportScope.module).toSet()
        );
    }
}
