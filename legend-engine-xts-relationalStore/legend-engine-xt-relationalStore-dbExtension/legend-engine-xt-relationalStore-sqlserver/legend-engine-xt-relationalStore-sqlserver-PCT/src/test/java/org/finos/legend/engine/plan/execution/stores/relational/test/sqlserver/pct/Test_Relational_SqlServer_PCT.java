...
public class Test_Relational_SqlServer_PCT
{
    private static final Adapter SQLSERVER_ADAPTER = CoreRelationalSqlServerCodeRepositoryProvider.sqlserverAdapter;
    ...
    public static Test suite()
    {
        ...
        return wrapSuite(
                ...
                () ->
                {
                    TestSuite suite = new TestSuite(Test_Relational_SqlServer_PCT.class.getName());
    ...
    private static MutableList<TestServerResource> sqlserverTestServerResources()
    {
        return Lists.mutable.with((TestServerResource) TestConnectionIntegrationLoader.extensions().select(c -> c.getDatabaseType() == DatabaseType.SqlServer).getFirst());
    }

    private abstract static class SqlServerPCTReportConfiguration extends PCTReportConfiguration
    {
        private final ReportScope reportScope;
        private final String manifestPath;

        protected SqlServerPCTReportConfiguration(ReportScope reportScope, String manifestPath)
        {
    ...
    public static class EssentialFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.essentialFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/EssentialFunctions_manifest.json";
    ...
    public static class GrammarFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = PlatformCodeRepositoryProvider.grammarFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/GrammarFunctions_manifest.json";
    ...
    public static class RelationFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = RelationCodeRepositoryProvider.relationFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/RelationFunctions_manifest.json";
    ...
    public static class ScenarioQuantFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreScenarioQuantCodeRepositoryProvider.scenario_Quant_Functions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/ScenarioQuantFunctions_manifest.json";
    ...
    public static class StandardFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreStandardFunctionsCodeRepositoryProvider.standardFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/StandardFunctions_manifest.json";
    ...
    public static class UnclassifiedFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = CoreUnclassifiedFunctionsCodeRepositoryProvider.unclassifiedFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/UnclassifiedFunctions_manifest.json";
    ...
    public static class VariantFunctions extends SqlServerPCTReportConfiguration
    {
        private static final ReportScope REPORT_SCOPE = VariantCodeRepositoryProvider.variantFunctions;
        private static final String MANIFEST_PATH = "pct-manifests/relational-sqlserver/VariantFunctions_manifest.json";
