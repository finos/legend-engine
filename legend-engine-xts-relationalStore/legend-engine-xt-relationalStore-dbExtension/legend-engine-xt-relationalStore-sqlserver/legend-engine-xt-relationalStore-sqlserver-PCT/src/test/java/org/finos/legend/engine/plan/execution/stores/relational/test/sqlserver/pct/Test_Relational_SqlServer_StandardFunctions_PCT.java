...
public class Test_Relational_SqlServer_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::math::tests::average::testAverage_Round_Integers_Relation_Window_Function_1__Boolean_1_", "com.microsoft.sqlserver.jdbc.SQLServerException: The function 'round' is not a valid windowing function, and cannot be used with the OVER clause."),
