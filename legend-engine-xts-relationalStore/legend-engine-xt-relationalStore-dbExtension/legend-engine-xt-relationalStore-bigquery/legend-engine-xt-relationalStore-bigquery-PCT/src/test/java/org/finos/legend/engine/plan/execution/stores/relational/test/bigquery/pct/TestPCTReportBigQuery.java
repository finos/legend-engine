...
public class TestPCTReportBigQuery
{
    @Test
    public void canFindPCTReport()
    {
        Assert.assertEquals(
                ...
                PCTReportProviderLoader.gatherReports().select(x -> x.adapterKey.adapter.name.equals("BigQuery")).collect(x -> x.reportScope.module).toSet()
        );
    }
}
