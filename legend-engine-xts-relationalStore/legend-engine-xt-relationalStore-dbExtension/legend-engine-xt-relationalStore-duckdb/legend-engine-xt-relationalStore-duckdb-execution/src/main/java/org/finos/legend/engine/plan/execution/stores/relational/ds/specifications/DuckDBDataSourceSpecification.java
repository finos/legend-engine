...
public class DuckDBDataSourceSpecification extends DataSourceSpecification
{
    ...
    public static String DUCKDB_PATH = "legend_duckdb_path";

    public DuckDBDataSourceSpecification(
    ...
    )
    {
        ...
        this.extraDatasourceProperties.put(DUCKDB_PATH, key.getPath());
    }

    public DuckDBDataSourceSpecification(DuckDBDataSourceSpecificationKey key, DatabaseManager databaseManager, AuthenticationStrategy authenticationStrategy)
    {
