...
public class Test_Relational_DuckDB_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Fold
            one("meta::pure::functions::collection::tests::fold::testFoldCollectionAccumulator_Function_1__Boolean_1_", "The initial value type must be the same as the list child type or a common super type"),
            one("meta::pure::functions::collection::tests::fold::testFoldWithEmptyAccumulator_Function_1__Boolean_1_", "The initial value type must be the same as the list child type or a common super type"),
            one("meta::pure::functions::collection::tests::fold::testFoldWithSingleValue_Function_1__Boolean_1_", "The initial value type must be the same as the list child type or a common super type"),
            ...
            one("meta::pure::functions::collection::tests::fold::testFoldMixedAccumulatorTypes_Function_1__Boolean_1_", "java.sql.SQLException: Binder Error: The initial value type must be the same as the list child type or a common super type"),
            ...
            // JoinStrings
            one("meta::pure::functions::string::tests::joinStrings::testJoinStringsNoStrings_Function_1__Boolean_1_", "\"Match failure: null\""),
            ...
            one("meta::pure::functions::collection::tests::slice::testSliceError_Function_1__Boolean_1_", "No error was thrown"),
            one("meta::pure::functions::date::tests::testDayOfMonthError_Function_1__Boolean_1_", "DuckDB doesn't support YEAR and YEAR-MONTH"),
            one("meta::pure::functions::date::tests::testHourError_Function_1__Boolean_1_", "DuckDB doesn't support YEAR and YEAR-MONTH"),
            one("meta::pure::functions::date::tests::testMinuteError_Function_1__Boolean_1_", "DuckDB doesn't support YEAR and YEAR-MONTH"),
            ...
            one("meta::pure::functions::date::tests::testSecondError_Function_1__Boolean_1_", "DuckDB doesn't support YEAR and YEAR-MONTH"),
