...
public class Test_Relational_DuckDB_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::removeDuplicates::testRemoveDuplicatesPrimitiveStandardFunction_Function_1__Boolean_1_", "\"\nexpected: [1, 2, 3]\nactual:   [3, 2, 1]\"", AdapterQualifier.needsInvestigation),
