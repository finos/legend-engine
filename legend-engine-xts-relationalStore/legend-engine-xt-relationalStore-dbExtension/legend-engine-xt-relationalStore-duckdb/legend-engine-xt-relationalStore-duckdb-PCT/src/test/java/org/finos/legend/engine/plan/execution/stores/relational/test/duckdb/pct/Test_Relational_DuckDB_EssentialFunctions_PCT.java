...
public class Test_Relational_DuckDB_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::fold::testFoldMixedAccumulatorTypes_Function_1__Boolean_1_", "java.sql.SQLException: Binder Error: The initial value type must be the same as the list child type or a common super type", AdapterQualifier.needsInvestigation),
            ...
            // Mod
            one("meta::pure::functions::math::tests::mod::testModInEval_Function_1__Boolean_1_", "\"Unused format args. [3] arguments provided to expression \"cast(fmod(%s,%s) as integer)\"\"", AdapterQualifier.needsInvestigation),
            ...
            // JoinStrings
            one("meta::pure::functions::string::tests::joinStrings::testJoinStringsNoStrings_Function_1__Boolean_1_", "\"\nexpected: ''\nactual:   '[]'\"", AdapterQualifier.needsInvestigation),
