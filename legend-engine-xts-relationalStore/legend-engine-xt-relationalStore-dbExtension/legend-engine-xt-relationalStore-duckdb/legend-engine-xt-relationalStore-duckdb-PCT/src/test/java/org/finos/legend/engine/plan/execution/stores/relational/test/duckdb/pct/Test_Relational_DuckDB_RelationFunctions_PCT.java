...
public class Test_Relational_DuckDB_RelationFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::pivot::testStaticPivot_SingleMultiple_Function_1__Boolean_1_", "\"Static pivot is currently not supported in DuckDB\"", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::relation::tests::pivot::testStaticPivot_SingleSingle_Function_1__Boolean_1_", "\"Static pivot is currently not supported in DuckDB\"", AdapterQualifier.needsImplementation),
            one("meta::pure::functions::relation::tests::pivot::testStaticPivot_SingleSingle_StringPivotValue_Function_1__Boolean_1_", "\"Static pivot is currently not supported in DuckDB\"", AdapterQualifier.needsImplementation)
    );
