...
public class Test_Relational_DuckDB_StandardFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            // Least
            one("meta::pure::functions::collection::tests::least::testLeast_Boolean_Function_1__Boolean_1_", "java.sql.SQLException: java.sql.SQLException: Binder Error: No function matches the given name and argument types 'least(BOOLEAN, BOOLEAN)'. You might need to add explicit type casts.\n	Candidate functions:\n	least(BIGINT, [BIGINT...]) -> BIGINT\n	least(HUGEINT, [HUGEINT...]) -> HUGEINT\n	least(DOUBLE, [DOUBLE...]) -> DOUBLE\n	least(VARCHAR, [VARCHAR...]) -> VARCHAR\n	least(TIMESTAMP, [TIMESTAMP...]) -> TIMESTAMP\n	least(TIME, [TIME...]) -> TIME\n	least(DATE, [DATE...]) -> DATE\n	least(TIMESTAMP WITH TIME ZONE, [TIMESTAMP WITH TIME ZONE...]) -> TIMESTAMP WITH TIME ZONE\n	least(TIME WITH TIME ZONE, [TIME WITH TIME ZONE...]) -> TIME WITH TIME ZONE\n\nLINE 1: select least(true, false)\n               ^"),
