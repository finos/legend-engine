        ...
        try
        {
            return Lists.mutable.with(
                    JsonMapper.builder().build().readValue(
                            Core_Relational_DuckDB_PCTReportProvider.class.getResourceAsStream("/pct-reports/ADAPTER_unclassified_compiled_DuckDB.json"),
                            AdapterReport.class
                    ),
                    JsonMapper.builder().build().readValue(
                            Core_Relational_DuckDB_PCTReportProvider.class.getResourceAsStream("/pct-reports/ADAPTER_essential_compiled_DuckDB.json"),
                            AdapterReport.class
                    ),
                    JsonMapper.builder().build().readValue(
