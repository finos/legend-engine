...
public class DeephavenStartForPCTCommand extends NativeFunction
{
    private final FunctionExecutionInterpreted functionExecution;
    private final ModelRepository repository;

    public DeephavenStartForPCTCommand(FunctionExecutionInterpreted functionExecution, ModelRepository modelRepository)
    {
                                ...
                                ProcessorSupport processorSupport) throws PureExecutionException
    {
        ...
        Root_meta_pure_functions_io_http_URL url = DeephavenCommands.startServerForPCT(imageTag);
