    ...
    public static Test suite()
    {
        return PureTestHelper.wrapSuite(
                ...
                () ->
                {
                    ...
                    suite.addTest(PureTestHelper.buildSuite(TestCollection.collectTests("meta::external::format::json", executionSupport.getProcessorSupport(), ci -> PureTestHelper.satisfiesConditions(ci, executionSupport.getProcessorSupport())), executionSupport));
