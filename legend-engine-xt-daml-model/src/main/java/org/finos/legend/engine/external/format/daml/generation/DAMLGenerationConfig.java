...
{
    public Root_meta_external_language_daml_generation_DAMLConfig process(PureModel pureModel)
    {
        Root_meta_external_language_daml_generation_DAMLConfig damlConfig = core_external_language_daml_deprecated_generation.Root_meta_external_language_daml_generation_defaultConfig__DAMLConfig_1_(pureModel.getExecutionSupport());
        ...
        damlConfig._scopeElements((RichIterable<? extends PackageableElement>) scopeElements);
        return damlConfig;
    }
