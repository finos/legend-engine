...
public final class DemoLegendDefaultDatabaseAuthenticationFlowProvider extends AbstractDatabaseAuthenticationFlowProvider
{
    private DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration databaseAuthenticationFlowProviderConfiguration;

    public DemoLegendDefaultDatabaseAuthenticationFlowProvider()
    {
    ...
    {
        if (!(configuration instanceof DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration))
        {
            String message = "Mismatch in flow provider configuration. It should be an instance of " + DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration.class.getSimpleName();
            throw new RuntimeException(message);
        }
        this.databaseAuthenticationFlowProviderConfiguration = (DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration) configuration;
