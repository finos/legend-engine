...
public final class DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration extends DatabaseAuthenticationFlowProviderConfiguration
{
    private AWSConfig awsConfig;
    private GCPWorkloadConfig gcpWorkloadConfig;
    private String middleTierMACKeyVaultRefernce;

    public DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration()
    {
        // jackson
    }

    public DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration build()
        {
            return new DemoLegendDefaultDatabaseAuthenticationFlowProviderConfiguration(this);
        }
    }
