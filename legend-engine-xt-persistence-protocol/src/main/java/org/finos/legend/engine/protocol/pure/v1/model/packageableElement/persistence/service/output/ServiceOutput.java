...
@JsonSubTypes({
        @JsonSubTypes.Type(value = GraphFetchServiceOutput.class, name = "graphFetchServiceOutput"),
        @JsonSubTypes.Type(value = TdsServiceOutput.class, name = "tdsServiceOutput")
})
