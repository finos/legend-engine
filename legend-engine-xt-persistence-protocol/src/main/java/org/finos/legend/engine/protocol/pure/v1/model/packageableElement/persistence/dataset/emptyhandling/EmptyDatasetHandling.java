...
package org.finos.legend.engine.protocol.pure.v1.model.packageableElement.persistence.dataset.emptyhandling;
...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = DeleteTargetDataset.class, name = "deleteTargetDataset")
})
