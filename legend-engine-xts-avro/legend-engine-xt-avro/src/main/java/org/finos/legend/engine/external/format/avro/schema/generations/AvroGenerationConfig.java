...
public class AvroGenerationConfig extends GenerationConfiguration
{
    ...
    {
        Root_meta_external_format_avro_generation_AvroConfig avroConfig = core_external_format_avro_transformation_integration.Root_meta_external_format_avro_generation_defaultConfig__AvroConfig_1_(pureModel.getExecutionSupport());
