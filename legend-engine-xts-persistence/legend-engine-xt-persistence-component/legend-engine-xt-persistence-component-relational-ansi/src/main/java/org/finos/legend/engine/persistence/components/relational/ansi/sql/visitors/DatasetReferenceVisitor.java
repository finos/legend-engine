...
public class DatasetReferenceVisitor implements LogicalPlanVisitor<DatasetReference>
{

    @Override
    public VisitorResult visit(PhysicalPlanNode prev, DatasetReference current, VisitorContext context)
    {
