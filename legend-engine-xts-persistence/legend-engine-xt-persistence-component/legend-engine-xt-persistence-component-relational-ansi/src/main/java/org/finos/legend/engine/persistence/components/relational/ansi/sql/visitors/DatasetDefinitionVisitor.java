...
public class DatasetDefinitionVisitor implements LogicalPlanVisitor<DatasetDefinition>
{

    @Override
    public VisitorResult visit(PhysicalPlanNode prev, DatasetDefinition current, VisitorContext context)
    {
