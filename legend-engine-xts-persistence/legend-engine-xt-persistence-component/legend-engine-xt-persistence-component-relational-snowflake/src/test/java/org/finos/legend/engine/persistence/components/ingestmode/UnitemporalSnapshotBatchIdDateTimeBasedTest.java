...
public class UnitemporalSnapshotBatchIdDateTimeBasedTest extends org.finos.legend.engine.persistence.components.ingestmode.unitemporal.UnitemporalSnapshotBatchIdDateTimeBasedTest
{
    @Override
    ...
    {
        return SnowflakeTestArtifacts.expectedMetadataTableIngestQueryWithAdditionalMetadataWithBatchSuccessValueWithUpperCase;
    }
    ...
    {
        return SnowflakeTestArtifacts.dataErrorCheckSqlWithBizDateAsVersionUpperCase;
    }

    protected String getExpectedDataErrorQueryWithDistinctDigestUpperCase()
    {
        return SnowflakeTestArtifacts.dataErrorsSqlWithBizDateVersionUpperCase;
    }
}
