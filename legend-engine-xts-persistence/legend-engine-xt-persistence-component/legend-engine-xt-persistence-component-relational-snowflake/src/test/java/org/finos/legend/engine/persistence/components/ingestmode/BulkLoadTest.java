...
public class BulkLoadTest
{
    ...
    private static Field col5 = Field.builder()
            .name("col_decimal")
            .type(FieldType.of(DataType.DECIMAL, 4,  1))
            .columnNumber(6)
            .build();
    ...
    private static Field col10 = Field.builder()
            .name("col_time")
    ...
    private static Field col12 = Field.builder()
            .name("col_timestamp_12")
            .type(FieldType.of(DataType.TIMESTAMP, Optional.empty(), Optional.empty()))
            .columnNumber(1)
            .elementPath("col_timestamp_12")
            .build();
    ...
    public void testBulkLoadWithUpperCaseConversionAndNoEventId()
    {
        ...
        String expectedIngestSql = "COPY INTO \"MY_DB\".\"MY_NAME\" " +
                ...
                "LAKEHOUSE_MD5(CONCAT('COL_INT',CAST(legend_persistence_stage.$1 AS INTEGER),'COL_INTEGER',CAST(legend_persistence_stage.$2 AS INTEGER)))," +
    ...
    public void testBulkLoadWithDigest()
    {
        ...
        String expectedIngestSql = "COPY INTO \"my_db\".\"my_name\" " +
                ...
                "FROM " +
                "(SELECT legend_persistence_stage.$1 as \"col_int\",legend_persistence_stage.$2 as \"col_integer\"," +
                "LAKEHOUSE_UDF(CONCAT('col_int',CAST(legend_persistence_stage.$1 AS INTEGER),'col_integer',CAST(legend_persistence_stage.$2 AS INTEGER)))," +
                "(SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MY_NAME'),'2000-01-01 00:00:00.000000' " +
                "FROM my_location as legend_persistence_stage) " +
                "FILES = ('/path/xyz/file1.csv', '/path/xyz/file2.csv') " +
                "FILE_FORMAT = (FORMAT_NAME = 'my_file_format') " +
    ...
    public void testBulkLoadWithDigestAndTypeConversionUdfs()
    {
        ...
        String expectedIngestSql = "COPY INTO \"my_db\".\"my_name\" " +
                ...
                "LAKEHOUSE_UDF(CONCAT('col_bigint',longToString(CAST(legend_persistence_stage.$3 AS BIGINT)),'col_decimal',CAST(legend_persistence_stage.$5 AS NUMBER(4,1)),'col_int',intToString(CAST(legend_persistence_stage.$1 AS INTEGER)),'col_integer',intToString(CAST(legend_persistence_stage.$2 AS INTEGER))))," +
                "(SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MY_NAME'),'2000-01-01 00:00:00.000000' " +
                "FROM my_location as legend_persistence_stage) " +
                "FILES = ('/path/xyz/file1.csv', '/path/xyz/file2.csv') " +
                "FILE_FORMAT = (FORMAT_NAME = 'my_file_format') " +
    ...
    public void testBulkLoadWithDigestWithFieldsToExcludeAndForceOption()
    {
        ...
        String expectedIngestSql = "COPY INTO \"my_db\".\"my_name\" " +
                ...
                "FROM " +
                "(SELECT legend_persistence_stage.$1 as \"col_int\",legend_persistence_stage.$2 as \"col_integer\"," +
                "LAKEHOUSE_UDF(CONCAT('col_integer',CAST(legend_persistence_stage.$2 AS INTEGER)))," +
                "(SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MY_NAME'),'2000-01-01 00:00:00.000000' " +
                "FROM my_location as legend_persistence_stage) " +
                "PATTERN = '(/path/xyz/file1.csv)|(/path/xyz/file2.csv)' " +
                "FILE_FORMAT = (FORMAT_NAME = 'my_file_format') " +
    ...
    public void testBulkLoadWithDateForAvro()
    {
        ...
        Dataset stagedFilesDataset = StagedFilesDataset.builder()
                .stagedFilesDatasetProperties(
                        SnowflakeStagedFilesDatasetProperties.builder()
                                ...
                                .fileFormat(StandardFileFormat.builder().formatType(FileFormatType.AVRO).build())
                                .addAllFilePaths(filesList).build())
                .schema(SchemaDefinition.builder().addAllFields(Arrays.asList(col6, col7, col8, col9, col11, col12, col10)).build())
                .build();
        ...
        String expectedCreateTableSql = "CREATE TABLE IF NOT EXISTS \"my_db\".\"my_name\"(\"col_string\" VARCHAR,\"col_datetime\" DATETIME,\"col_date\" DATE,\"col_timestamp\" TIMESTAMP(3),\"col_timestamp_11\" TIMESTAMP(6),\"col_timestamp_12\" TIMESTAMP,\"col_time\" TIME,\"digest\" VARCHAR,\"batch_id\" INTEGER,\"append_time\" DATETIME)";

        String expectedIngestSql = "COPY INTO \"my_db\".\"my_name\" " +
                "(\"col_string\", \"col_datetime\", \"col_date\", \"col_timestamp\", \"col_timestamp_11\", \"col_timestamp_12\", \"col_time\", \"digest\", \"batch_id\", \"append_time\") " +
                ...
                "TO_TIMESTAMP_NTZ(legend_persistence_stage.$1:\"col_timestamp_12\"::NUMBER, 3) as \"col_timestamp_12\"," +
                ...
                "COLUMN_STRING_UDF('col_timestamp_12',CAST(TO_TIMESTAMP_NTZ(legend_persistence_stage.$1:\"col_timestamp_12\"::NUMBER, 3) AS TIMESTAMP))))," +
    ...
    @Test
    public void testBulkLoadWithDateStrForAvroBackwardCompatible()
    {
        BulkLoad bulkLoad = BulkLoad.builder()
                .batchIdField("batch_id")
                .digestGenStrategy(UDFBasedDigestGenStrategy.builder()
        ...
        String expectedIngestSql = "COPY INTO \"my_db\".\"my_name\" " +
                ...
                "legend_persistence_stage.$1:\"col_timestamp\" as \"col_timestamp\"," +
                "legend_persistence_stage.$1:\"col_time\" as \"col_time\"," +
                "LAKEHOUSE_UDF(CONCAT(" +
                "COLUMN_STRING_UDF('col_date',CAST(legend_persistence_stage.$1:\"col_date\" AS DATE))," +
                "COLUMN_STRING_UDF('col_datetime',CAST(legend_persistence_stage.$1:\"col_datetime\" AS DATETIME))," +
                "COLUMN_STRING_UDF('col_string',CAST(legend_persistence_stage.$1:\"col_string\" AS VARCHAR))," +
