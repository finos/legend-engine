...
public interface AppendOnlyAbstract extends IngestMode
{
    ...
    {
        if (digestField().isPresent() && !(digestGenStrategy() instanceof NoDigestGenStrategy))
        {
            throw new IllegalStateException("Cannot build AppendOnly, digest should either be provided by the user or generated by the library");
        }
    }
}
