...
public class UnenforcedUniqueIndexConstraint extends TableConstraint
{
    private static final String INDEX_NAME = "UNENFORCED_UNIQUE_INDEX";
    private final List<String> columnNames;
    private final String quoteIdentifier;

    public UnenforcedUniqueIndexConstraint(List<String> columnNames, String quoteIdentifier)
    {
    ...
    public void genSql(StringBuilder builder) throws SqlDomException
    {
        ...
        builder.append(Clause.UNIQUE + SqlGenUtils.WHITE_SPACE + Clause.KEY + SqlGenUtils.WHITE_SPACE);
        ...
        builder.append(Clause.UNENFORCED);
    }
