...
public class ShardKeyConstraint extends TableConstraint
{
    private static final String INDEX_NAME = "SHARD_INDEX";
    private final List<String> columnNames;
    private final String quoteIdentifier;

    public ShardKeyConstraint(List<String> columnNames, String quoteIdentifier)
    {
    ...
    public void genSql(StringBuilder builder) throws SqlDomException
    {
        ...
        builder.append(Clause.SHARD + SqlGenUtils.WHITE_SPACE + Clause.KEY + SqlGenUtils.WHITE_SPACE);
        builder.append(INDEX_NAME + SqlGenUtils.WHITE_SPACE);
        builder.append(SqlGenUtils.OPEN_PARENTHESIS);
        builder.append(uniqueColumns);
        builder.append(SqlGenUtils.CLOSING_PARENTHESIS);
    }
