...
public class UnitemporalSnapshotBatchIdBasedTest extends UnitmemporalSnapshotBatchIdBasedTestCases
{
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMainTableMultiPartitionKeysCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListNoDedupNoVersionWithDeletePartition(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(Arrays.asList(MemsqlTestArtifacts.expectedMainTableMultiPartitionKeysCreateQuery, MemsqlTestArtifacts.expectedMetadataTableCreateQuery), preActionsSql);
    ...
    public void verifyUnitemporalSnapshotWithPartitionDeleteAllNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMainTableBatchIdWithoutDigestBasedCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListDeleteAllNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMainTableMultiPartitionKeysWithoutDigestCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListDeleteAllNoDedupNoVersionInUpperCase(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMainTableMultiPartitionsWithoutDigestCreateQueryWithUpperCase, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQueryWithUpperCase, preActionsSql.get(1));
        Assertions.assertEquals(expectedMilestoneQuery, milestoningSql.get(0));
        Assertions.assertEquals(expectedUpsertQuery, milestoningSql.get(1));
        Assertions.assertEquals(getExpectedMetadataTableIngestQueryWithUpperCase(), metadataIngestSql.get(0));
    ...
    protected String getExpectedDeletePartitionQuery()
    {
        return "UPDATE `mydb`.`main` as sink SET" +
                " sink.`batch_id_out` = (SELECT COALESCE(MAX(batch_metadata.`table_batch_id`),0)+1 FROM batch_metadata as batch_metadata" +
                " WHERE UPPER(batch_metadata.`table_name`) = 'MAIN')-1 WHERE (sink.`batch_id_out` = 999999999)" +
                " AND (EXISTS (SELECT * FROM `mydb`.`delete_partition` as delete_partition_alias" +
