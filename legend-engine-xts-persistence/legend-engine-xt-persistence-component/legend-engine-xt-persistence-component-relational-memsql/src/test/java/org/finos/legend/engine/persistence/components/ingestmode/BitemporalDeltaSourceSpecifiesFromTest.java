...
public class BitemporalDeltaSourceSpecifiesFromTest extends BitemporalDeltaSourceSpecifiesFromTestCases
{
    ...
    public void verifyBitemporalDeltaBatchIdBasedNoDeleteIndWithDataSplits(List<GeneratorResult> operations, List<DataSplitRange> dataSplitRanges)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyMainTableWithVersionCreateQuery, operations.get(0).preActionsSql().get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, operations.get(0).preActionsSql().get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableWithVersionCreateQuery, operations.get(0).preActionsSql().get(2));
    ...
    public void verifyBitemporalDeltaBatchIdBasedWithDeleteIndNoDataSplits(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableCreateQuery, preActionsSql.get(2));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableWithDeleteIndicatorCreateQuery, preActionsSql.get(3));
    ...
    public void verifyBitemporalDeltaBatchIdBasedNoDeleteIndNoDataSplitsFilterDuplicates(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableCreateQuery, preActionsSql.get(2));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyStageWithoutDuplicatesTableCreateQuery, preActionsSql.get(3));
    ...
    public void verifyBitemporalDeltaBatchIdBasedNoDeleteIndWithDataSplitsFilterDuplicates(List<GeneratorResult> operations, List<DataSplitRange> dataSplitRanges)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, operations.get(0).preActionsSql().get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableWithVersionCreateQuery, operations.get(0).preActionsSql().get(2));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyStageWithVersionWithDataSplitWithoutDuplicatesTableCreateQuery, operations.get(0).preActionsSql().get(3));
    ...
    public void verifyBitemporalDeltaBatchIdBasedWithDeleteIndNoDataSplitsFilterDuplicates(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableCreateQuery, preActionsSql.get(2));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableWithDeleteIndicatorCreateQuery, preActionsSql.get(3));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyStageWithDeleteIndicatorWithoutDuplicatesTableCreateQuery, preActionsSql.get(4));
    ...
    public void verifyBitemporalDeltaBatchIdAndTimeBasedNoDeleteIndNoDataSplits(GeneratorResult operations)
    {
        ...
        String expectedStageToTemp = "INSERT INTO `mydb`.`temp` " +
                ...
                "legend_persistence_y.`legend_persistence_end_date`,(SELECT COALESCE(MAX(batch_metadata.`table_batch_id`),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.`table_name`) = 'MAIN'),999999999,'2000-01-01 00:00:00.000000','9999-12-31 23:59:59' " +
                "FROM " +
                "(SELECT stage.`id`,stage.`name`,stage.`amount`,stage.`validity_from_reference`,stage.`digest` FROM `mydb`.`staging` as stage) as legend_persistence_x " +
                "LEFT OUTER JOIN " +
                "(SELECT legend_persistence_x.`id`,legend_persistence_x.`name`,legend_persistence_x.`legend_persistence_start_date`,COALESCE(MIN(legend_persistence_y.`legend_persistence_start_date`),MIN(legend_persistence_x.`legend_persistence_end_date`)) as `legend_persistence_end_date` " +
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyMainTableBatchIdAndTimeBasedCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableBatchIdAndTimeBasedCreateQuery, preActionsSql.get(2));
    ...
    public void verifyBitemporalDeltaDateTimeBasedNoDeleteIndNoDataSplits(GeneratorResult operations)
    {
        ...
        String expectedStageToTemp = "INSERT INTO `mydb`.`temp` " +
                ...
                "(SELECT legend_persistence_x.`id`,legend_persistence_x.`name`,legend_persistence_x.`amount`,legend_persistence_x.`digest`,legend_persistence_x.`validity_from_reference` as `legend_persistence_start_date`," +
                "legend_persistence_y.`legend_persistence_end_date`,'2000-01-01 00:00:00.000000','9999-12-31 23:59:59' " +
                "FROM " +
                "(SELECT stage.`id`,stage.`name`,stage.`amount`,stage.`validity_from_reference`,stage.`digest` FROM `mydb`.`staging` as stage) as legend_persistence_x " +
                "LEFT OUTER JOIN " +
                "(SELECT legend_persistence_x.`id`,legend_persistence_x.`name`,legend_persistence_x.`legend_persistence_start_date`,COALESCE(MIN(legend_persistence_y.`legend_persistence_start_date`),MIN(legend_persistence_x.`legend_persistence_end_date`)) as `legend_persistence_end_date` " +
        ...
        String expectedMainToTemp = "INSERT INTO `mydb`.`temp` " +
                ...
                "'2000-01-01 00:00:00.000000','9999-12-31 23:59:59' FROM (SELECT sink.`id`,sink.`name`,sink.`amount`,sink.`digest`,sink.`batch_time_in`," +
        ...
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyMainTableDateTimeBasedCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedMetadataTableCreateQuery, preActionsSql.get(1));
        Assertions.assertEquals(MemsqlTestArtifacts.expectedBitemporalFromOnlyTempTableDateTimeBasedCreateQuery, preActionsSql.get(2));
