...
public class CreateTest
{
    ...
    public void testCreateTableWithColumnStoreSharded()
    {
        ...
        String expectedAdd = "CREATE TABLE IF NOT EXISTS `my_db`.`my_schema`.`my_table`(`col_int` INTEGER NOT NULL PRIMARY KEY,`col_integer` INTEGER NOT NULL UNIQUE,`col_bigint` BIGINT,UNIQUE KEY UNENFORCED_UNIQUE_INDEX (`col_int`) UNENFORCED,SHARD KEY SHARD_INDEX (`col_int`),KEY CLUSTERED_COLUMN_INDEX (`col_int`) USING CLUSTERED COLUMNSTORE)";
    ...
    public void testCreateTableWithColumnStoreUnsharded()
    {
        ...
        String expectedAdd = "CREATE REFERENCE TABLE IF NOT EXISTS `my_db`.`my_schema`.`my_table`(`col_int` INTEGER NOT NULL PRIMARY KEY,`col_integer` INTEGER NOT NULL UNIQUE,`col_bigint` BIGINT,KEY CLUSTERED_COLUMN_INDEX (`col_int`) USING CLUSTERED COLUMNSTORE)";
    ...
    @Test
    public void testCreateTableWithRowStoreWithShards()
    {
        DatasetDefinition dataset = DatasetDefinition.builder()
                .database("my_db")
                .group("my_schema")
                .name("my_table")
                .alias("my_alias")
                .schema(schemaWithRowStoreShards)
                .build();
        ...
        String expectedAdd = "CREATE TABLE IF NOT EXISTS `my_db`.`my_schema`.`my_table`(`col_int` INTEGER NOT NULL PRIMARY KEY,`col_integer` INTEGER NOT NULL UNIQUE,`col_bigint` BIGINT,SHARD KEY SHARD_INDEX (`col_int`))";
