...
class UnitemporalSnapshotTest extends BaseTest
{
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithoutPartitionWithCaseConversion() throws Exception
    {
        ...
        // Create staging table
        duckDBSink.executeStatement("CREATE TABLE IF NOT EXISTS \"TEST\".\"STAGING\"(\"ID\" INTEGER NOT NULL,\"NAME\" VARCHAR(64) NOT NULL,\"INCOME\" BIGINT,\"START_TIME\" TIMESTAMP NOT NULL,\"EXPIRY_DATE\" DATE,\"DIGEST\" VARCHAR,PRIMARY KEY (\"ID\", \"START_TIME\"))");
        ...
        String expectedDataPass3 = basePathForExpected + "without_partition/no_version/expected_pass3.csv";
        // 1. Truncate Staging table
        truncateStagingDataInUpperCase();
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 4);
        try
        {
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicMaxVersionWithPartitionFilterDuplicatesUpperCase() throws Exception
    {
        ...
        // Create staging table
        duckDBSink.executeStatement("CREATE TABLE IF NOT EXISTS \"TEST\".\"STAGING\"(\"DATE\" DATE NOT NULL,\"ENTITY\" VARCHAR NOT NULL,\"PRICE\" DECIMAL(20,2),\"VOLUME\" BIGINT,\"DIGEST\" VARCHAR,\"VERSION\" INTEGER)");
