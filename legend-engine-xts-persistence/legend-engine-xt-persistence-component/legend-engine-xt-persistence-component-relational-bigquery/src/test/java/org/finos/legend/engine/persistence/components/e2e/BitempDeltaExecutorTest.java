...
@Disabled
public class BitempDeltaExecutorTest extends BigQueryEndToEndTest
{
    /*
    ...
    */
    ...
    public void testMilestoning() throws Exception
    {
        ...
        IngestorResult result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass1, fixedClock_2000_01_01);
        ...
        Assertions.assertEquals(1, incomingRecords);
        ...
        result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass2, fixedClock_2000_01_02);
        ...
        result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass3, fixedClock_2000_01_03);
        ...
        incomingRecords = (long) result.statisticByName().get(INCOMING_RECORD_COUNT);
        rowsInserted = (long) result.statisticByName().get(ROWS_INSERTED);
        rowsUpdated = (long) result.statisticByName().get(ROWS_UPDATED);
        Assertions.assertEquals(1, incomingRecords);
        Assertions.assertEquals(1, rowsInserted);
        Assertions.assertEquals(1, rowsUpdated);
        ...
        result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass4, fixedClock_2000_01_04);
        ...
        result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass5, fixedClock_2000_01_05);
        ...
        rowsUpdated = (long) result.statisticByName().get(ROWS_UPDATED);
        Assertions.assertEquals(1, incomingRecords);
        Assertions.assertEquals(0, rowsInserted);
        Assertions.assertEquals(1, rowsUpdated);
        ...
        stagingFilter = DatasetFilter.of(balanceName, FilterType.EQUAL_TO, 110000);
        result = ingestViaExecutor(ingestMode, bitempStagingSchema, stagingFilter, pathPass6, fixedClock_2000_01_06);
