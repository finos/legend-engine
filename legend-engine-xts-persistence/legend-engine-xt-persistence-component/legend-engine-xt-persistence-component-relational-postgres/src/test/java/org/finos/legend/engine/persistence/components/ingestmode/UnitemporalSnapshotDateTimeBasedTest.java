...
import static org.finos.legend.engine.persistence.components.PostgresTestArtifacts.dataErrorsSqlWithBizDateVersion;
...
public class UnitemporalSnapshotDateTimeBasedTest extends UnitmemporalSnapshotDateTimeBasedTestCases
{
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        String expectedMilestoneQuery = "UPDATE \"mydb\".\"main\" as sink " +
                "SET \"batch_time_out\" = '2000-01-01 00:00:00.000000' " +
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableTimeBasedCreateQuery, preActionsSql.get(0));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionFailOnDupsMaxVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableTimeBasedCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.expectedBaseTempStagingTablePlusDigestWithCount, preActionsSql.get(2));

        Assertions.assertEquals(PostgresTestArtifacts.expectedTempStagingCleanupQuery, deduplicationAndVersioningSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedInsertIntoBaseTempStagingWithFilterDupsAndMaxVersion, deduplicationAndVersioningSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionWithUpperCaseOptimizer(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableTimeBasedCreateQueryWithUpperCase, preActionsSql.get(0));
