...
{
    private final String basePathForInput = "data/unitemporal-snapshot-milestoning/input/time_based/";
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithoutPartition() throws Exception
    {
        ...
        try
        {
            executePlansAndVerifyResults(ingestModeWithFailOnEmptyBatch, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_03, " order by \"id\", \"batch_time_in\"");
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithPartition() throws Exception
    {
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass1, expectedStats, fixedClock_2000_01_01, " order by \"date\", \"entity\", \"batch_time_in\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_02, " order by \"date\", \"entity\", \"batch_time_in\"");
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 0);
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_03, " order by \"date\", \"entity\", \"batch_time_in\"");
    }
