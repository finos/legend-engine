...
public class UnitemporalSnapshotBatchIdDateTimeBasedTest extends UnitmemporalSnapshotBatchIdDateTimeBasedTestCases
{
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionNoDedupNoVersioning(GeneratorResult operations)
    {
        ...
        String expectedMilestoneQuery = "UPDATE \"mydb\".\"main\" as sink " +
                "SET \"batch_id_out\" = (SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MAIN')-1,\"batch_time_out\" = '2000-01-01 00:00:00.000000' " +
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableCreateQuery, preActionsSql.get(0));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionNoDedupMaxVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.expectedBaseTempStagingTablePlusDigest, preActionsSql.get(2));

        Assertions.assertEquals(expectedMilestoneQuery, milestoningSql.get(0));
        Assertions.assertEquals(expectedUpsertQuery, milestoningSql.get(1));
        Assertions.assertEquals(getExpectedMetadataTableIngestQuery(), metadataIngestSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedTempStagingCleanupQuery, deduplicationAndVersioningSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedInsertIntoBaseTempStagingPlusDigestWithMaxVersionAndAllowDuplicates, deduplicationAndVersioningSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.dataErrorCheckSqlWithBizDateVersion, deduplicationAndVersioningErrorChecksSql.get(DedupAndVersionErrorSqlType.MAX_DATA_ERRORS));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionWithUpperCaseOptimizerFilterDupsMaxVersion(GeneratorResult operations)
    {
        ...
        String expectedMilestoneQuery = "UPDATE \"MYDB\".\"MAIN\" as sink SET \"BATCH_ID_OUT\" = " +
                ...
                "UPPER(BATCH_METADATA.\"TABLE_NAME\") = 'MAIN')-1,\"BATCH_TIME_OUT\" = '2000-01-01 00:00:00.000000' " +
        ...
        String expectedUpsertQuery = "INSERT INTO \"MYDB\".\"MAIN\" " +
                ...
                "WHERE NOT (stage.\"DIGEST\" IN (SELECT sink.\"DIGEST\" FROM \"MYDB\".\"MAIN\" as sink WHERE sink.\"BATCH_ID_OUT\" = 999999999)))";
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableCreateQueryWithUpperCase, preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQueryWithUpperCase(), preActionsSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.expectedBaseTempStagingTablePlusDigestWithCountUpperCase, preActionsSql.get(2));

        Assertions.assertEquals(PostgresTestArtifacts.expectedTempStagingCleanupQueryInUpperCase, deduplicationAndVersioningSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedInsertIntoBaseTempStagingPlusDigestWithMaxVersionAndFilterDuplicatesUpperCase, deduplicationAndVersioningSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.dataErrorCheckSqlWithBizDateAsVersionUpperCase, deduplicationAndVersioningErrorChecksSql.get(DedupAndVersionErrorSqlType.MAX_DATA_ERRORS));
    ...
    public void verifyUnitemporalSnapshotWithPlaceholders(GeneratorResult operations)
    {
        ...
        String expectedMilestoneQuery = "UPDATE \"mydb\".\"main\" as sink " +
                "SET \"batch_id_out\" = {BATCH_ID_PATTERN}-1,\"batch_time_out\" = '{BATCH_START_TS_PATTERN}' " +
                "WHERE (sink.\"batch_id_out\" = 999999999) " +
                "AND (NOT (EXISTS " +
                "(SELECT * FROM \"mydb\".\"staging\" as stage WHERE ((sink.\"id\" = stage.\"id\") AND (sink.\"name\" = stage.\"name\")) AND (sink.\"digest\" = stage.\"digest\"))))";
        ...
        Assertions.assertEquals(expectedMilestoneQuery, milestoningSql.get(0));
        Assertions.assertEquals(expectedUpsertQuery, milestoningSql.get(1));
        Assertions.assertEquals(PostgresTestArtifacts.expectedMetadataTableIngestQueryWithPlaceHolders, metadataIngestSql.get(0));
    }
    ...
    {
        return PostgresTestArtifacts.expectedMetadataTableIngestQueryWithAdditionalMetadataWithBatchSuccessWithUpperCase;
    }
