...
{
    private final String basePathForInput = "data/unitemporal-incremental-milestoning/input/time_based/";
    ...
    */
    ...
    void testMilestoning() throws Exception
    {
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass1,expectedStats, fixedClock_2000_01_01, " order by \"batch_time_in\", \"id\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_02, " order by \"batch_time_in\", \"id\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_03, " order by \"batch_time_in\", \"id\"");
    ...
    */
    ...
    void testMilestoningWithLessColumnsInStaging() throws Exception
    {
        ...
        expectedStats = createExpectedStatsMap(3, 0, 1, 1, 0);
        executePlansAndVerifyResults(ingestMode, options, datasets.withStagingDataset(stagingTable), schema, expectedDataPass2, expectedStats, fixedClock_2000_01_02, " order by \"batch_time_in\", \"id\"");
        ...
        // Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 0);
        executePlansAndVerifyResults(ingestMode, options, datasets.withStagingDataset(stagingTable), schema, expectedDataPass3, expectedStats, fixedClock_2000_01_03, " order by \"batch_time_in\", \"id\"");
    }
