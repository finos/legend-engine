...
{
    private final String basePathForInput = "data/unitemporal-snapshot-milestoning/input/batch_id_and_time_based/";
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithoutPartition() throws Exception
    {
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass1, expectedStats, fixedClock_2000_01_01, " order by \"id\", \"batch_id_in\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_01, " order by \"id\", \"batch_id_in\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"id\", \"batch_id_in\"");
    }
    ...
    void testUnitemporalSnapshotMilestoningLogicWithoutPartitionWithCaseConversion() throws Exception
    {
        ...
        // Create staging table
        postgresSink.executeStatement("CREATE TABLE IF NOT EXISTS \"TEST\".\"STAGING\"(\"ID\" INTEGER NOT NULL,\"NAME\" VARCHAR(64) NOT NULL,\"INCOME\" BIGINT,\"START_TIME\" TIMESTAMP NOT NULL,\"EXPIRY_DATE\" DATE,\"DIGEST\" VARCHAR,PRIMARY KEY (\"ID\", \"START_TIME\"))");
        ...
        // 2. Execute plans and verify results
        Map<String, Object> expectedStats = createExpectedStatsMap(3, 0, 3, 0, 0);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass1, expectedStats, fixedClock_2000_01_01, " order by \"ID\", \"BATCH_ID_IN\"");
        // 3. Assert that the staging table is NOT truncated
        List<Map<String, Object>> stagingTableList = postgresSink.executeQuery("select * from \"TEST\".\"STAGING\"");
        Assertions.assertEquals(stagingTableList.size(), 3);
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(4, 0, 1, 1, 0);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_01, " order by \"ID\", \"BATCH_ID_IN\"");
        ...
        try
        {
            executePlansAndVerifyForCaseConversion(ingestModeWithFailOnEmptyBatchStrategy, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"ID\", \"BATCH_ID_IN\"");
        ...
        executePlansAndVerifyForCaseConversion(ingestModeWithSkipEmptyBatchStrategy, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"ID\", \"BATCH_ID_IN\"");
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 4);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"ID\", \"BATCH_ID_IN\"");
    }
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithPartition() throws Exception
    {
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass1, expectedStats, fixedClock_2000_01_01, " order by \"date\", \"entity\", \"batch_id_in\"");
        ...
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_01, " order by \"date\", \"entity\", \"batch_id_in\"");
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 0);
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"date\", \"entity\", \"batch_id_in\"");
    }
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithLessColumnsInStaging() throws Exception
    {
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(4, 0, 1, 1, 0);
        executePlansAndVerifyResults(ingestMode, options, datasets.withStagingDataset(stagingTable), schema, expectedDataPass2, expectedStats, fixedClock_2000_01_01, " order by \"id\", \"batch_id_in\"");
    }
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicWithPartitionWithCleanStagingDataWithoutStatCollection() throws Exception
    {
        ...
        loadStagingDataForWithPartition(dataPass1);
        // 2. Execute plans and verify results
        executePlansAndVerifyResults(ingestMode, options, datasets, schema, expectedDataPass1, new HashMap<>(), fixedClock_2000_01_01, " order by \"date\", \"entity\", \"batch_id_in\"");
    ...
    */
    ...
    void testUnitemporalSnapshotMilestoningLogicMaxVersionWithPartitionFilterDuplicatesUpperCase() throws Exception
    {
        ...
        // Create staging table
        postgresSink.executeStatement("CREATE TABLE IF NOT EXISTS \"TEST\".\"STAGING\"(\"DATE\" DATE NOT NULL,\"ENTITY\" VARCHAR NOT NULL,\"PRICE\" DECIMAL(20,2),\"VOLUME\" BIGINT,\"DIGEST\" VARCHAR,\"VERSION\" INTEGER)");
        ...
        // 2. Execute plans and verify results
        Map<String, Object> expectedStats = createExpectedStatsMap(9, 0, 6, 0, 0);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass1, expectedStats, fixedClock_2000_01_01, " order by \"DATE\", \"ENTITY\", \"BATCH_ID_IN\"");
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(4, 0, 1, 1, 1);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass2, expectedStats, fixedClock_2000_01_01, " order by \"DATE\", \"ENTITY\", \"BATCH_ID_IN\"");
        ...
        // 2. Execute plans and verify results
        expectedStats = createExpectedStatsMap(0, 0, 0, 0, 0);
        executePlansAndVerifyForCaseConversion(ingestMode, options, datasets, schema, expectedDataPass3, expectedStats, fixedClock_2000_01_01, " order by \"DATE\", \"ENTITY\", \"BATCH_ID_IN\"");
    }
}
