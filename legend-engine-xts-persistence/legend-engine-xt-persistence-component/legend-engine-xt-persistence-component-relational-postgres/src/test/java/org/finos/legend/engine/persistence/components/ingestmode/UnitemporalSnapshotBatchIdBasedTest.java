...
public class UnitemporalSnapshotBatchIdBasedTest extends UnitmemporalSnapshotBatchIdBasedTestCases
{
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedLockInfoTableCreateQuery, preActionsSql.get(0));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionFailOnDupsNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedLockInfoTableCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedBaseTempStagingTablePlusDigestWithCount, preActionsSql.get(1));
        ...
        Assertions.assertEquals(PostgresTestArtifacts.maxDupsErrorCheckSql, deduplicationAndVersioningErrorChecksSql.get(DedupAndVersionErrorSqlType.MAX_DUPLICATES));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListNoDedupNoVersionWithDeletePartition(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(Arrays.asList(PostgresTestArtifacts.expectedMainTableMultiPartitionsCreateQuery, getExpectedMetadataTableCreateQuery()), preActionsSql);
    ...
    public void verifyUnitemporalSnapshotWithPartitionDeleteAllNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableBatchIdNoDigestBasedCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionDeleteAllFilterDuplicatesMaxVersion(GeneratorResult operations)
    {
        ...
        String expectedMilestoneQuery = "UPDATE \"mydb\".\"main\" as sink " +
            "SET \"batch_id_out\" = (SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MAIN')-1 " +
            "WHERE (sink.\"batch_id_out\" = 999999999) " +
            "AND (EXISTS (SELECT * FROM \"mydb\".\"staging_temp_staging_lp_yosulf\" as stage WHERE sink.\"biz_date\" = stage.\"biz_date\"))";
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedTempStagingCleanupQuery, deduplicationAndVersioningSql.get(0));
        Assertions.assertEquals(PostgresTestArtifacts.expectedInsertIntoBaseTempStagingWithMaxVersionAndFilterDuplicates, deduplicationAndVersioningSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListDeleteAllNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableMultiPartitionsNoDigestCreateQuery, preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(1));
    ...
    public void verifyUnitemporalSnapshotWithPartitionSpecListDeleteAllNoDedupNoVersionInUpperCase(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedMainTableMultiPartitionsNoDigestCreateQuery.toUpperCase(), preActionsSql.get(0));
        Assertions.assertEquals(getExpectedMetadataTableCreateQueryWithUpperCase(), preActionsSql.get(1));
        Assertions.assertEquals(expectedMilestoneQuery, milestoningSql.get(0));
        Assertions.assertEquals(expectedUpsertQuery, milestoningSql.get(1));
        Assertions.assertEquals(getExpectedMetadataTableIngestQueryWithUpperCase(), metadataIngestSql.get(0));
    ...
    @Override
    public void verifyUnitemporalSnapshotWithNoPartitionsAndDeleteAll(GeneratorResult operations)
    {
        List<String> milestoningSql = operations.ingestSql();
        List<String> metadataIngestSql = operations.metadataIngestSql();
    ...
    {
        return "UPDATE \"mydb\".\"main\" as sink SET " +
                "\"batch_id_out\" = (SELECT COALESCE(MAX(batch_metadata.\"table_batch_id\"),0)+1 " +
                "FROM batch_metadata as batch_metadata WHERE UPPER(batch_metadata.\"table_name\") = 'MAIN')-1 " +
                "WHERE (sink.\"batch_id_out\" = 999999999) AND (EXISTS (SELECT * FROM \"mydb\".\"delete_partition\" as delete_partition_alias " +
                "WHERE (sink.\"biz_date\" = delete_partition_alias.\"biz_date\") AND (sink.\"account_type\" = delete_partition_alias.\"account_type\")))";
    }
}
