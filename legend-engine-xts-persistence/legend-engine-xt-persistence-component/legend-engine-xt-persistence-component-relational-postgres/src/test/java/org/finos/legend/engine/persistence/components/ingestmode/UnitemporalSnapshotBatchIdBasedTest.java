...
public class UnitemporalSnapshotBatchIdBasedTest extends UnitmemporalSnapshotBatchIdBasedTestCases
{
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionNoDedupNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(PostgresTestArtifacts.expectedStagingTableWithDigestCreateQuery, preActionsSql.get(1));
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(2));
        Assertions.assertEquals(PostgresTestArtifacts.expectedLockInfoTableCreateQuery, preActionsSql.get(3));
    ...
    public void verifyUnitemporalSnapshotWithoutPartitionFailOnDupsNoVersion(GeneratorResult operations)
    {
        ...
        Assertions.assertEquals(getExpectedMetadataTableCreateQuery(), preActionsSql.get(2));
        Assertions.assertEquals(PostgresTestArtifacts.expectedLockInfoTableCreateQuery, preActionsSql.get(3));
        Assertions.assertEquals(PostgresTestArtifacts.expectedBaseTempStagingTablePlusDigestWithCount, preActionsSql.get(4));
