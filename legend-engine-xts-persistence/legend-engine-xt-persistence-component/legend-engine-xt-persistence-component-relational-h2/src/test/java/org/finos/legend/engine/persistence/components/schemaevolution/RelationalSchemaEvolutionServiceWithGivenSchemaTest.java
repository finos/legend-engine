...
public class RelationalSchemaEvolutionServiceWithGivenSchemaTest extends AbstractRelationalSchemaEvolutionServiceTest
{
    @Override
    ...
    {
        return evolutionService.evolve((DatasetDefinition) mainDataset, stagingDataset.schema(), JdbcConnection.of(h2Sink.connection()));
    }
}