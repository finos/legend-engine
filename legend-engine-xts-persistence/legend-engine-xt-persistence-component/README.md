...
**Step 4.2:** Use the generator object to extract the queries
    ...
    List<String> postCleanupSql = operations.postCleanupSql(); // drop temporal tables if any
...
| updatedDatasets | The enriched datasets                                                                                                       |
| schemaEvolutionSql | If schema evolution is enabled, this field will return the schema evolutions sqls those were trigerred if any               |
