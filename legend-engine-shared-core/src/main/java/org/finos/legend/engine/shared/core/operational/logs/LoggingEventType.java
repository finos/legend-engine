...
public enum LoggingEventType
{
    ...
    GENERATE_CPB_CODE_START,
    GENERATE_CPB_CODE_STOP,
    GENERATE_CPB_CODE_ERROR,
    GENERATE_CPB_CODE_INTERACTIVE_START,
    GENERATE_CPB_CODE_INTERACTIVE_STOP,
    GENERATE_CPB_CODE_INTERACTIVE_ERROR,
