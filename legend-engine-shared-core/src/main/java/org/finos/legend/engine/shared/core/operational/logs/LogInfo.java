...
public class LogInfo
{
    ...
    public LogInfo(Subject user, LoggingEventType eventType)
    {
        this.timeStamp = new Date();
        this.user = SubjectTools.getPrincipal(user);
        this.eventType = eventType;
    }

    public LogInfo(Subject user, LoggingEventType eventType, double duration)
    {
        this(user, eventType);
        this.duration = duration;
    }

    public LogInfo(Subject user, LoggingEventType eventType, String message)
    {
        this(user, eventType);
        this.message = message;
    }

    public LogInfo(Subject user, LoggingEventType eventType, Object info)
    {
        this(user, eventType);
        this.info = info;
    }

    public LogInfo(Subject user, LoggingEventType eventType, Object info, double duration)
    {
        this(user, eventType, info);
        this.duration = duration;
    }

    public LogInfo(Subject user, LoggingEventType eventType, Throwable t)
    {
        this(user, eventType);
