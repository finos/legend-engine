...
//corresponds to function templates coming with plan
    ...
    public void roleTransform() throws Exception
    {
        ...
        Map a = new HashMap(); a.put("userRole", "cadm");
        Map b  = new HashMap(); b.put("userRole","sales");
        maps.add(a); maps.add(b);
        Map rootMap = new HashMap(); rootMap.put("roleMap", maps);
    ...
    public Map getRootMap(String[] roles )
    {
        ...
        {
            Map roleMap =  new HashMap(); roleMap.put("userRole", role);
            roleList.add(roleMap);
        }
        Map rootMap = new HashMap(); rootMap.put("role", roleList);
        return rootMap;
    }
