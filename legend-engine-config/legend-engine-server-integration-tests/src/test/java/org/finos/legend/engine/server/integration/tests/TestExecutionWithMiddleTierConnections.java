...
public class TestExecutionWithMiddleTierConnections extends AbstractMiddleTierExecutionTest
{
    ...
    public void testWithExecutePlan_ExecutionNotAuthorized() throws Exception
    {
        ...
        String expectedOutput = "{\"authorizer\":\"RelationalMiddleTierPlanExecutionAuthorizer\",\"authorized\":false,\"summary\":\"Overall authorization was NOT successful. Authorizations granted=0, Authorizations denied=1\",\"authorizationInput\":{\"contextParams\":{\"legend.usageContext\":\"INTERACTIVE_EXECUTION\"}},\"authorizations\":[{\"status\":\"DENY\",\"summary\":\"Use of credential denied by policy\",\"subject\":\"Anonymous\",\"action\":\"use\",\"resource\":{\"credential\":\"reference1\"},\"policyParams\":{\"policy\":\"unused\",\"resource\":\"DB@test@localhost@64514\"},\"details\":[]}]}";
