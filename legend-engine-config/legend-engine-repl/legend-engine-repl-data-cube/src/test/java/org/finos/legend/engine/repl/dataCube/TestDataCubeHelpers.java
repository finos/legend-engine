...
public class TestDataCubeHelpers
{
    ...
    public void testExecuteSort()
    {
        ...
        String expectedResult = "{\"builder\":{\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"FIRSTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"},{\"name\":\"LASTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"}]},\"activities\":[{\"_type\":\"relational\",\"sql\":\"select \\\"test0_0\\\".FIRSTNAME as \\\"FIRSTNAME\\\", \\\"test0_0\\\".LASTNAME as \\\"LASTNAME\\\" from TEST0 as \\\"test0_0\\\" where \\\"test0_0\\\".FIRSTNAME <> 'Doe' or \\\"test0_0\\\".FIRSTNAME is null order by \\\"FIRSTNAME\\\" asc\"}],\"result\":{\"columns\":[\"FIRSTNAME\",\"LASTNAME\"],\"rows\":[{\"values\":[\"John\",\"Doe\"]},{\"values\":[\"Nicole\",\"Doe\"]},{\"values\":[\"Tim\",\"Smith\"]}]}}";
    ...
    public void testExecuteFilter()
    {
        ...
        String expectedResult = "{\"builder\":{\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"FIRSTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"},{\"name\":\"LASTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"}]},\"activities\":[{\"_type\":\"relational\",\"sql\":\"select \\\"test0_0\\\".FIRSTNAME as \\\"FIRSTNAME\\\", \\\"test0_0\\\".LASTNAME as \\\"LASTNAME\\\" from TEST0 as \\\"test0_0\\\" where (\\\"test0_0\\\".FIRSTNAME <> 'Doe' or \\\"test0_0\\\".FIRSTNAME is null) and (\\\"test0_0\\\".LASTNAME <> 'Doe' or \\\"test0_0\\\".LASTNAME is null) order by \\\"FIRSTNAME\\\" asc\"}],\"result\":{\"columns\":[\"FIRSTNAME\",\"LASTNAME\"],\"rows\":[{\"values\":[\"Tim\",\"Smith\"]}]}}";
        testExecuteQuery(expectedResult, lambda);
    }
