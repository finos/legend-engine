...
public class TestDataCubeHelpers
{
    ...
    public void testExecuteSort()
    {
        ...
        String expectedResult = "{\"builder\":{\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"FIRSTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"},{\"name\":\"LASTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"}]},\"activities\":[{\"_type\":\"relational\",\"sql\":\"select \\\"test0_0\\\".FIRSTNAME as \\\"FIRSTNAME\\\", \\\"test0_0\\\".LASTNAME as \\\"LASTNAME\\\" from TEST0 as \\\"test0_0\\\" where \\\"test0_0\\\".FIRSTNAME is distinct from 'Doe' order by \\\"FIRSTNAME\\\" asc\"}],\"result\":{\"columns\":[\"FIRSTNAME\",\"LASTNAME\"],\"rows\":[{\"values\":[\"John\",\"Doe\"]},{\"values\":[\"Nicole\",\"Doe\"]},{\"values\":[\"Tim\",\"Smith\"]}]}}";
    ...
    public void testExecuteFilter()
    {
        ...
        String expectedResult = "{\"builder\":{\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"FIRSTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"},{\"name\":\"LASTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"}]},\"activities\":[{\"_type\":\"relational\",\"sql\":\"select \\\"test0_0\\\".FIRSTNAME as \\\"FIRSTNAME\\\", \\\"test0_0\\\".LASTNAME as \\\"LASTNAME\\\" from TEST0 as \\\"test0_0\\\" where \\\"test0_0\\\".FIRSTNAME is distinct from 'Doe' and \\\"test0_0\\\".LASTNAME is distinct from 'Doe' order by \\\"FIRSTNAME\\\" asc\"}],\"result\":{\"columns\":[\"FIRSTNAME\",\"LASTNAME\"],\"rows\":[{\"values\":[\"Tim\",\"Smith\"]}]}}";
        testExecuteQuery(expectedResult, lambda);
    }
    ...
    public void testExecuteGroupBy()
    {
        ...
        String expectedResult = "{\"builder\":{\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"FIRSTNAME\",\"type\":\"meta::pure::precisePrimitives::Varchar\",\"relationalType\":\"VARCHAR(1024)\"},{\"name\":\"count\",\"type\":\"Integer\",\"relationalType\":\"INTEGER\"}]},\"activities\":[{\"_type\":\"relational\",\"sql\":\"select \\\"test0_0\\\".FIRSTNAME as \\\"FIRSTNAME\\\", count(\\\"test0_0\\\".FIRSTNAME) as \\\"count\\\" from TEST0 as \\\"test0_0\\\" where \\\"test0_0\\\".FIRSTNAME is distinct from 'Doe' group by \\\"FIRSTNAME\\\"\"}],\"result\":{\"columns\":[\"FIRSTNAME\",\"count\"],\"rows\":[{\"values\":[\"John\",1]},{\"values\":[\"Nicole\",1]},{\"values\":[\"Tim\",1]}]}}";
        testExecuteQuery(expectedResult, lambda);
    }
    ...
    public void testExtractRelationReturnTypeMultipleExtend()
    {
        ...
        String expectedResult = "{\"_type\":\"relationType\",\"columns\":[{\"genericType\":{\"multiplicityArguments\":[],\"rawType\":{\"_type\":\"packageableType\",\"fullPath\":\"meta::pure::precisePrimitives::Varchar\"},\"typeArguments\":[],\"typeVariableValues\":[{\"_type\":\"integer\",\"value\":200}]},\"multiplicity\":{\"lowerBound\":0,\"upperBound\":1},\"name\":\"FIRSTNAME\"},{\"genericType\":{\"multiplicityArguments\":[],\"rawType\":{\"_type\":\"packageableType\",\"fullPath\":\"meta::pure::precisePrimitives::Varchar\"},\"typeArguments\":[],\"typeVariableValues\":[{\"_type\":\"integer\",\"value\":200}]},\"multiplicity\":{\"lowerBound\":0,\"upperBound\":1},\"name\":\"LASTNAME\"},{\"genericType\":{\"multiplicityArguments\":[],\"rawType\":{\"_type\":\"packageableType\",\"fullPath\":\"String\"},\"typeArguments\":[],\"typeVariableValues\":[]},\"multiplicity\":{\"lowerBound\":1,\"upperBound\":1},\"name\":\"newCol\"},{\"genericType\":{\"multiplicityArguments\":[],\"rawType\":{\"_type\":\"packageableType\",\"fullPath\":\"meta::pure::precisePrimitives::Varchar\"},\"typeArguments\":[],\"typeVariableValues\":[{\"_type\":\"integer\",\"value\":200}]},\"multiplicity\":{\"lowerBound\":0,\"upperBound\":1},\"name\":\"colX\"}]}";
        testExtractRelationReturnType(expectedResult, lambda, pureModelContextData);
    }
