...
public class CastHandler extends FunctionHandler
{
    @Override
    ...
    {
        return proposeColumnNamesForEditColSpec(currentFunc, leftType, pureModel);
    }

    public static MutableList<CompletionItem> proposeColumnNamesForEditColSpec(AppliedFunction currentFunc, GenericType leftType, PureModel pureModel)
    {
        ...
        {
            return Lists.mutable.with(new CompletionItem("@" + M3Paths.Relation + "<("));
        }
