...
import org.finos.legend.engine.testData.generation.api.TestEmbeddedDataGeneration;
...
public class Server<T extends ServerConfiguration> extends Application<T>
{
    ...
    public void run(T serverConfiguration, Environment environment)
    {
        ...
        //TestData Generation
        environment.jersey().register(new TestEmbeddedDataGeneration(modelManager));
