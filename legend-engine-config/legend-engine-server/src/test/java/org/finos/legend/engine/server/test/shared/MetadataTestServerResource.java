...
public class MetadataTestServerResource implements TestServerResource
{
    private TestMetaDataServer metadataServer;

    @Override
    public void start() throws Exception
    {
        int metadataServerPort = DynamicPortGenerator.generatePort();
        this.metadataServer = new TestMetaDataServer(metadataServerPort, true);
