    ...
    public static Test suite() throws Exception
    {
        return wrapSuite(
                ...
                () ->
                {
                    ...
                    suite.addTest(PureTestHelper.buildSuite(TestCollection.collectTests("meta::relational::tests::mapping::union", executionSupport.getProcessorSupport(), ci -> !ci.getName().contains("testPksWithImportDataFlow") && satisfiesConditions(ci, executionSupport.getProcessorSupport())), executionSupport));
                    ...
                    suite.addTest(PureTestHelper.buildSuite(TestCollection.collectTests("meta::relational::graphFetch::tests::classMappingFilterWithInnerJoin", executionSupport.getProcessorSupport(), ci -> satisfiesConditions(ci, executionSupport.getProcessorSupport())), executionSupport));
                    ...
                    suite.addTest(PureTestHelper.buildSuite(TestCollection.collectTests("meta::relational::tests::functions::pureToSqlQuery::calendarAggregations", executionSupport.getProcessorSupport(), ci -> satisfiesConditions(ci, executionSupport.getProcessorSupport())), executionSupport));
