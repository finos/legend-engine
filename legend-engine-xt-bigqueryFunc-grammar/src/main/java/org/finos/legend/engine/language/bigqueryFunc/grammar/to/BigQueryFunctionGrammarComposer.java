...
package org.finos.legend.engine.language.bigqueryFunc.grammar.to;
...
import org.finos.legend.engine.language.bigqueryFunc.grammar.from.BigQueryFunctionGrammarParserExtension;
...
public class BigQueryFunctionGrammarComposer implements PureGrammarComposerExtension
{
    ...
    private static String renderBigQueryFunction(BigQueryFunction app)
    {
        ...
        return "BigQueryFunction " + packageName + "\n" +
                "{\n" +
