...
public class TestBigQueryParsing extends TestGrammarParser.TestGrammarParserTestSuite
{
    ...
    {
        // TODO HSO: Add stereotype, tagged handling?
        return null;
    }
    ...
    public void testGetParserErrorWrongProperty()
    {
        test("###BigQuery\n" +
                ...
                "{\n" +
                "   applicatioName : 'sass';\n" +
                "}\n", "PARSER error at [4:4-17]: Unexpected token 'applicatioName'. Valid alternatives: ['functionName', 'description', 'function', 'owner']");
    }
