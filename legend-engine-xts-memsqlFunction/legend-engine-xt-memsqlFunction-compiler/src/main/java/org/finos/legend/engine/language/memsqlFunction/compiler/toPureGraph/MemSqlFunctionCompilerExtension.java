...
public class MemSqlFunctionCompilerExtension implements CompilerExtension
{
    ...
    public Iterable<? extends Processor<?>> getExtraProcessors()
    {
        return Lists.fixedSize.of(
                Processor.newProcessor(
                        ...
                        Lists.fixedSize.with(MemSqlFunctionDeploymentConfiguration.class),
    ...
    public Root_meta_external_function_activator_memSqlFunction_MemSqlFunction buildMemSqlFunction(MemSqlFunction memSqlFunction, CompileContext context)
    {
        try
        {
            PackageableFunction<?> func = (PackageableFunction<?>) context.resolvePackageableElement(FunctionDescriptor.functionDescriptorToId(memSqlFunction.function), memSqlFunction.sourceInformation);
