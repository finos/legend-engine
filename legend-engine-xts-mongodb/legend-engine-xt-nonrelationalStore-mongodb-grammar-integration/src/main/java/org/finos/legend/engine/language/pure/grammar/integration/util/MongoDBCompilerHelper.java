...
public class MongoDBCompilerHelper
{
    ...
    public static <T> MappingClass<T> generateMappingClass(Class<T> pureClass, String id, RootMongoDBClassMapping mongoDBClassMapping, Mapping parent, CompileContext context)
    {
        MappingClass<T> mappingClass = new Root_meta_pure_mapping_MappingClass_Impl<>("");
        ...
        GenericType gType = new Root_meta_pure_metamodel_type_generics_GenericType_Impl("", null, context.pureModel.getClass("meta::pure::metamodel::type::generics::GenericType"))
                ...
                ._typeArguments(Lists.immutable.with(new Root_meta_pure_metamodel_type_generics_GenericType_Impl("", null, context.pureModel.getClass("meta::pure::metamodel::type::generics::GenericType"))._rawType(mappingClass)));
