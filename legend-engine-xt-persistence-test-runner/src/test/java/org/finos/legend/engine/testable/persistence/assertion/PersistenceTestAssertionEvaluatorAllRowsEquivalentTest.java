...
public class PersistenceTestAssertionEvaluatorAllRowsEquivalentTest
{

    @Test
    public void testEvaluatorAllRowsEquivalent() throws Exception
    {
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentWithRowsNotInOrder() throws Exception
    {
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentWithFieldsToIgnore() throws Exception
    {
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentWithActiveRowsFilterConditions() throws Exception
    {
        ...
        String expected = "[{\"ID\":1, \"NAME\":\"ANDY\", \"BATCH_ID_IN\":1, \"BATCH_ID_OUT\":1}," + "{\"ID\":2, \"NAME\":\"BRAD\", \"BATCH_ID_IN\":1, \"BATCH_ID_OUT\":999999999}," + "{\"ID\":3, \"NAME\":\"CATHY\", \"BATCH_ID_IN\":1, \"BATCH_ID_OUT\":999999999}," + "{\"ID\":4, \"NAME\":\"TOM\", \"BATCH_ID_IN\":1, \"BATCH_ID_OUT\":1}]";
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentObjectsValuesMismatch() throws Exception
    {
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentUnequalRows() throws Exception
    {
        String result = "[{\"ID\":1,\"NAME\":\"ANDY\"}," + "{\"ID\":2,\"NAME\":\"BRAD\"}," + "{\"NAME\":\"CATHY\",\"ID\":3}," + "{\"ID\":4,\"NAME\":\"TOMS\"}]";
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentExpectedJsonBadFormat() throws Exception
    {
        String result = "[{\"ID\":1, \"NAME\":\"ANDY\"}," + "{\"ID\":2, \"NAME\":\"BRAD\"}," + "{\"NAME\":\"CATHY\", \"ID\":3}," + "{\"ID\":4, \"NAME\":\"TOM\"}]";
        String expected = "[{\"ID\":1, \"NAME\":\"ANDY\"}," + "{\"ID\":2, \"NAME\":\"BRAD\"}," + "{\"ID\":3, \"NAME\":\"CATHY\"}," + "{\"ID\":4, \"NAME\":\"TOM\",}]";
    ...
    @Test
    public void testEvaluatorAllRowsEquivalentColumnNamesMismatch() throws Exception
    {
