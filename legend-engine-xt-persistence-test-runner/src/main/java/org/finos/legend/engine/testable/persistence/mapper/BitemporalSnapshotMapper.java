...
public class BitemporalSnapshotMapper
{
    ...
    public static Datasets enrichAndDeriveDatasets(BitemporalSnapshot bitemporalSnapshot, Dataset mainDataset, String testData)
    {
        TransactionMilestoning transactionMilestoning = bitemporalSnapshot.transactionMilestoning.accept(MappingVisitors.MAP_TO_COMPONENT_TRANSACTION_MILESTONING);
        ValidityMilestoning validityMilestoning = bitemporalSnapshot.validityMilestoning.accept(MappingVisitors.MAP_TO_COMPONENT_VALIDITY_MILESTONING);
