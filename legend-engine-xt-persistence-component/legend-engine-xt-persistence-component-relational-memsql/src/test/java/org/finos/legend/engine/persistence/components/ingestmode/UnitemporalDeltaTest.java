...
public class UnitemporalDeltaTest extends IngestModeTest
{
    ...
    {
        mainTable = DatasetDefinition.builder()
            .database(mainDbName).group("my_schema").name(mainTableName).alias(mainTableAlias)
            .schema(mainTableSchema)
            .build();

        stagingTable = DatasetDefinition.builder()
            .database(stagingDbName).group("my_schema").name(stagingTableName).alias(stagingTableAlias)
            .schema(baseTableSchemaWithDigest)
            .build();
    ...
    {
        mainTable = DatasetDefinition.builder()
            .group("my_schema").name(mainTableName).alias(mainTableAlias)
            .schema(mainTableSchema)
            .build();

        stagingTable = DatasetDefinition.builder()
            .group("my_schema").name(stagingTableName).alias(stagingTableAlias)
            .schema(baseTableSchemaWithDigest)
            .build();
