...
public class CreateTest
{
    ...
    public void testCreateTableWithColumnStoreShards()
    {
        ...
        String expectedAdd = "CREATE TABLE IF NOT EXISTS `my_db`.`my_schema`.`my_table`(`col_int` INTEGER PRIMARY KEY,`col_integer` INTEGER NOT NULL UNIQUE,`col_bigint` BIGINT,UNIQUE KEY UNENFORCED_UNIQUE_INDEX (`col_int`) UNENFORCED,SHARD KEY SHARD_INDEX (`col_int`),KEY CLUSTERED_COLUMN_INDEX (`col_int`) USING CLUSTERED COLUMNSTORE)";
    ...
    public void testCreateTableWithRowStoreWithShards()
    {
        ...
        String expectedAdd = "CREATE TABLE IF NOT EXISTS `my_db`.`my_schema`.`my_table`(`col_int` INTEGER PRIMARY KEY,`col_integer` INTEGER NOT NULL UNIQUE,`col_bigint` BIGINT,SHARD KEY SHARD_INDEX (`col_int`))";
