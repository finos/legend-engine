...
public class UnitemporalSnapshotTest extends IngestModeTest
{
    ...
    @Test
    public void testPostRunStatisticsAndPostActionsSqlForBatchIdModeWithCleanStagingDataWithoutStatCollection()
    {
        UnitemporalSnapshot ingestMode = UnitemporalSnapshot.builder()
            .digestField(digestField)
            .addAllKeyFields(primaryKeysList)
    ...
    @Test
    public void testPostRunStatisticsAndPostActionsSqlForBatchIdModeWithoutCleanStagingDataWithStatCollection()
    {
        UnitemporalSnapshot ingestMode = UnitemporalSnapshot.builder()
            .digestField(digestField)
            .addAllKeyFields(primaryKeysList)
    ...
    @Test
    void testUnitemporalSnapshotMilestoningWithMetadataOperationsDisabled()
    {
        UnitemporalSnapshot ingestMode = UnitemporalSnapshot.builder()
            .digestField(digestField)
            .addAllKeyFields(primaryKeysList)
    ...
    @Test
    void testGeneratePhysicalPlanWithoutPartitionWithPlaceHolders()
    {
        UnitemporalSnapshot ingestMode = UnitemporalSnapshot.builder()
            .digestField(digestField)
            .addAllKeyFields(primaryKeysList)
