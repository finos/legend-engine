...
public class Test_JAVA_GrammarFunction_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::boolean::tests::equality::eq::testEqPrimitiveExtension_Function_1__Boolean_1_", "\"Unsupported type: meta::pure::functions::boolean::tests::equalitymodel::ExtendedInteger\"", AdapterQualifier.needsInvestigation),
            // Equal
            ...
            one("meta::pure::functions::boolean::tests::equality::equal::testEqualPrimitiveExtension_Function_1__Boolean_1_", "\"Unsupported type: meta::pure::functions::boolean::tests::equalitymodel::ExtendedInteger\"", AdapterQualifier.needsInvestigation),
