...
public class Test_JAVA_GrammarFunction_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::lang::tests::letFn::testLetAsLastStatement_Function_1__Boolean_1_", "Error in 'test::testFunction': Function does not exist 'letAsLastStatement()'"),
            one("meta::pure::functions::lang::tests::letFn::testLetChainedWithAnotherFunction_Function_1__Boolean_1_", "Error in 'test::testFunction': Function does not exist 'letChainedWithAnotherFunction(Class<TestClass>[1])'"),
            one("meta::pure::functions::lang::tests::letFn::testLetWithParam_Function_1__Boolean_1_", "Error in 'test::testFunction': Function does not exist 'letWithParam(String[1])'"),
