...
public class Test_JAVA_RelationFunction_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::composition::testMultiCoalesceInProject_Function_1__Boolean_1_", "Error in 'test::testFunction': Can't find a match for function 'new(Class<PersonTypeForCompositionTests>[1],String[1])'.", AdapterQualifier.unsupportedFeature),
