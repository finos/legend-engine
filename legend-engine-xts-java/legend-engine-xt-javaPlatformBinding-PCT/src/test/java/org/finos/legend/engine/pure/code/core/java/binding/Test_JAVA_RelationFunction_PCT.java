...
public class Test_JAVA_RelationFunction_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::relation::tests::composition::testExistsVariableArity_Function_1__Boolean_1_", "\"Instance of type 'meta::pure::metamodel::relation::TDS' can't be translated\"",  AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::relation::tests::composition::testFilterVariableArity_Function_1__Boolean_1_", "\"Instance of type 'meta::pure::metamodel::relation::TDS' can't be translated\"", AdapterQualifier.unsupportedFeature),
            one("meta::pure::functions::relation::tests::composition::testNestedJoinVariableArity_Function_1__Boolean_1_", "\"Instance of type 'meta::pure::metamodel::relation::TDS' can't be translated\"", AdapterQualifier.unsupportedFeature)
    );
