...
public class ServiceGrammarComposerExtension implements IServiceGrammarComposerExtension
{
    ...
    {
        StringBuilder serviceBuilder = new StringBuilder().append(HelperDomainGrammarComposer.renderDocumentation(service.taggedValues, "")).append("Service").append(" ").append(HelperDomainGrammarComposer.renderAnnotations(service.stereotypes, HelperDomainGrammarComposer.withoutDocumentation(service.taggedValues))).append(PureGrammarComposerUtility.convertPath(service.getPath()));
