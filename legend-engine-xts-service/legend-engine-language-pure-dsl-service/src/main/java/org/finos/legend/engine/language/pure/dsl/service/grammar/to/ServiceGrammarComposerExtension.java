...
public class ServiceGrammarComposerExtension implements IServiceGrammarComposerExtension
{
    ...
    {
        StringBuilder serviceBuilder = new StringBuilder().append(HelperDomainGrammarComposer.renderDocumentation(service.taggedValues, "", context.isAlwaysRenderDocumentation())).append("Service").append(" ").append(HelperDomainGrammarComposer.renderAnnotations(service.stereotypes, HelperDomainGrammarComposer.withoutDocumentation(service.taggedValues, context.isAlwaysRenderDocumentation()))).append(PureGrammarComposerUtility.convertPath(service.getPath()));
