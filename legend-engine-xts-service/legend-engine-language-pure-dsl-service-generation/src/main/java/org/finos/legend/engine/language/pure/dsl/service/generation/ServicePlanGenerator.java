...
public class ServicePlanGenerator
{
    ...
    public static CompositeExecutionPlan generateCompositeExecutionPlan(PureMultiExecution multiExecution, Root_meta_pure_runtime_ExecutionContext context, PureModel pureModel, String clientVersion, PlanPlatform platform, String planId, RichIterable<? extends Root_meta_pure_extension_Extension> extensions, Iterable<? extends PlanTransformer> transformers)
    {
        ...
        {
            Root_meta_legend_service_metamodel_ExecutionEnvironmentInstance pureExecEnv = org.finos.legend.pure.generated.core_service_service_helperFunctions.Root_meta_legend_service_getExecutionEnvironmentFromFunctionDefinition_FunctionDefinition_1__ExecutionEnvironmentInstance_1_(lambda, pureModel.getExecutionSupport());
            ...
            if (pureExecEnv._executionParameters().getFirst() instanceof Root_meta_legend_service_metamodel_SingleExecutionParameters)
            {
                Map<String, SingleExecutionPlan> plans = execEnvWithIndex.toMap(
                        ...
                        ep -> getSingleExecutionPlan(null, context, pureModel, clientVersion, platform, (planId != null ? planId + "_" + ep.getTwo().toString() : null), extensions, transformers, null, null,
                                (LambdaFunction<?>) org.finos.legend.pure.generated.core_service_service_helperFunctions.Root_meta_legend_service_assignValueInFunctionDefinitionForKey_FunctionDefinition_1__String_1__FunctionDefinition_1_(lambda, ((Root_meta_legend_service_metamodel_SingleExecutionParameters)ep.getOne())._key(), pureModel.getExecutionSupport())));
                ...
                String execKey = org.finos.legend.pure.generated.core_service_service_helperFunctions.Root_meta_legend_service_getKeyFromFunctionDefinition_FunctionDefinition_1__String_1_(lambda, pureModel.getExecutionSupport());
