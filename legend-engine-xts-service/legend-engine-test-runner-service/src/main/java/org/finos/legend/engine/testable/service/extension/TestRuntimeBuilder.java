        ...
        for (ConnectionStores connectionStores : engineRuntime.connectionStores)
        {
            ...
            for (ConnectionTestData connectionTestData : connectionTestDataList)
            {
                if (connectionTestData != null)
                {
                    ...
                    {
                        DataElement dataElement = Iterate.detect(pureModelContextData.getElementsOfType(DataElement.class), e -> ((DataElementReference) connectionTestData.data).dataElementPointer.path.equals(e.getPath()));
