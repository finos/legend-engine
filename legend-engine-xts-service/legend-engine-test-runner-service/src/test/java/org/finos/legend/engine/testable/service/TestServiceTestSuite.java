...
public class TestServiceTestSuite
{
    ...
    public void testServiceTestSuiteWithServiceStore()
    {
        ...
        PureModel pureModelWithDefaultSerializationFormat = Compiler.compile(modelDataWithDefaultSerializationFormat, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithEmbeddedData = Compiler.compile(modelDataWithEmbeddedData, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithFailingTest = Compiler.compile(modelDataWithFailingTest, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithMultipleAsserts = Compiler.compile(modelDataWithMultipleAsserts, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithMultipleAsserts2 = Compiler.compile(modelDataWithMultipleAsserts2, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithMultipleTests1 = Compiler.compile(modelDataWithMultipleTests1, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithMultipleTests2 = Compiler.compile(modelDataWithMultipleTests2, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithMultipleTestSuites = Compiler.compile(modelDataWithMultipleTestSuites, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithParameters = Compiler.compile(modelDataWithParameters, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithTestError = Compiler.compile(modelDataWithTestError, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithInlineService = Compiler.compile(modelDataWithInlineService, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
    ...
    public void testServiceTestSuiteWithBindingServices()
    {
        ...
        PureModel pureModelForServiceWithStringParam = Compiler.compile(modelDataForServiceWithStringParam, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelForServiceWithByteStreamParam = Compiler.compile(modelDataForServiceWithByteStreamParam, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelForServiceWithTestFailing = Compiler.compile(modelDataForServiceWithTestFailing, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
    ...
    public void testMultiExecutionServiceTestSuite()
    {
        ...
        PureModel pureModelWithAllTestPassing = Compiler.compile(modelDataWithAllTestPassing, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithDifferentConnections = Compiler.compile(modelDataWithDifferentConnections, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
        ...
        PureModel pureModelWithTestFailing = Compiler.compile(modelDataWithTestFailing, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
    ...
    public void testTestExecutionForLimitedTestIds()
    {
        ...
        PureModel pureModelWithMultiExecutionService = Compiler.compile(modelDataWithMultiExecutionService, DeploymentMode.TEST, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
