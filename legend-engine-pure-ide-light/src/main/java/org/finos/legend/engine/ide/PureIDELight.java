...
public class PureIDELight extends PureIDEServer
{
    ...
    protected MutableList<RepositoryCodeStorage> buildRepositories(SourceLocationConfiguration sourceLocationConfiguration)
    {
        return Lists.mutable.<RepositoryCodeStorage>empty()
                ...
                .with(this.buildCore("legend-engine-xt-functionActivator-pure", "function_activator"))
                .with(this.buildCore("legend-engine-xt-snowflakeApp-pure", "snowflakeapp"))
                ...
                .with(this.buildCore("legend-engine-xt-relationalStore-memsql-pure", "relational_memsql"))
