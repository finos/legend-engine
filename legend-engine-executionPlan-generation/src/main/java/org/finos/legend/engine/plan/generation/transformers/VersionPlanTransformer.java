...
public class VersionPlanTransformer implements PlanTransformer
{
    ...
    {
        return !"vX_X_X".equals(version) && PureClientVersions.versionAGreaterThanOrEqualsVersionB(version, "v1_18_0");
    }
    ...
    public Object transformToVersionedModel(Root_meta_pure_executionPlan_ExecutionPlan purePlan, String version, RichIterable<? extends Root_meta_pure_router_extension_RouterExtension> extensions, ExecutionSupport executionSupport)
    {
        try
        {
            ...
            Method method = cl.getMethod("Root_meta_protocols_pure_" + version + "_transformation_fromPureGraph_executionPlan_transformPlan_ExecutionPlan_1__RouterExtension_MANY__ExecutionPlan_1_", Root_meta_pure_executionPlan_ExecutionPlan.class, RichIterable.class, ExecutionSupport.class);
