...
package org.finos.legend.engine.shared.core.identity.kerberos;
...
public class SystemAccountLoginConfiguration extends Configuration
{
    ...
    public SystemAccountLoginConfiguration(String keytabLocation, String principal, boolean initiator)
    {
