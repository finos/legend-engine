...
public class PureIDELight extends PureIDEServer
{
    ...
    protected MutableList<RepositoryCodeStorage> buildRepositories(SourceLocationConfiguration sourceLocationConfiguration)
    {
        return Lists.mutable.<RepositoryCodeStorage>empty()
                ...
                .with(this.buildCore("legend-engine-xts-data-product/legend-engine-xt-data-product-pure-metamodel", "data_space_metamodel"))
                ...
                .with(this.buildCore("legend-engine-xts-data-product/legend-engine-xt-data-product-pure-metamodel", "data-product-metamodel"))
                .with(this.buildCore("legend-engine-xts-data-product/legend-engine-xt-data-product-pure", "data-product"))
