...
public class PureIDEMcpToolDefinitions
{
    ...
    private static final String SERVER_DESCRIPTION =
        "MCP server exposing Pure IDE capabilities";
    ...
    public static Function3<
        Tool, Map<String, Object>,
        Identity, List<ContentBlock>>
        getToolExecutor(
    ...
    private static void addReadTools(
            List<Tool> tools)
    {
        tools.add(new Tool(
            null,
    ...
    private static void addWriteTools(
            List<Tool> tools)
    {
        tools.add(new Tool(
            null,
    ...
    private static void addExecutionTools(
            List<Tool> tools)
    {
        tools.add(new Tool(
            null,
    ...
    private static void addNavigationTools(
            List<Tool> tools)
    {
        tools.add(new Tool(
            null,
    ...
    private static List<ContentBlock> dispatch(
            Tool tool,
            Map<String, Object> params,
            PureRuntime pureRuntime,
            MutableRepositoryCodeStorage cs,
            FunctionExecution fe)
    {
        switch (tool.getName())
        {
            ...
            case "find_in_sources":
                return handleFindInSources(
                    pureRuntime, params);
            case "find_pure_file":
                return handleFindPureFile(
                    pureRuntime, params);
            case "create_file":
            ...
            case "delete_file":
                return handleDeleteFile(
                    pureRuntime, params);
            case "execute_pure":
                return handleExecutePure(
                    pureRuntime, fe, params);
            case "execute_go":
                return handleExecuteGo(
                    pureRuntime, fe, params);
            case "run_tests":
                return handleRunTests(
                    pureRuntime, fe, params);
            case "get_concept_info":
                return handleGetConceptInfo(
                    pureRuntime, params);
    ...
    private static List<ContentBlock>
        handleReadFile(
            MutableRepositoryCodeStorage cs,
            Map<String, Object> params)
    {
            ...
            Map<String, Object> params)
    {
        String path =
            (String) params.get("path");
        RichIterable<CodeStorageNode> nodes =
            cs.getFiles(path);
            ...
            Map<String, Object> params)
    {
        ...
        boolean regex =
            params.get("regex") != null
                && (Boolean) params.get("regex");
        boolean caseSensitive =
            params.get("caseSensitive") == null
                || (Boolean) params
                    .get("caseSensitive");
        ...
        if (regex)
        {
            ...
            results = runtime.getSourceRegistry()
                .find(pattern, null);
        }
        else
        {
            results = runtime.getSourceRegistry()
                .find(query, caseSensitive, null);
        }
            ...
            String query)
    {
        ...
        for (SourceCoordinates sc : results)
        {
            ...
            sb.append(sc.getSourceId())
                .append(':')
                .append(sc.getStartLine())
                .append(':')
                .append(sc.getStartColumn());
            if (sc.getPreview() != null)
            {
                sb.append(" | ")
                    .append(sc.getPreview()
                        .getBeforeText())
                    .append(">>>")
                    .append(sc.getPreview()
                        .getFoundText())
            ...
            Map<String, Object> params)
    {
        ...
        if (regex)
        {
            ...
            matches = runtime.getSourceRegistry()
                .findSourceIds(pattern);
        }
        else
        {
            matches = runtime.getSourceRegistry()
    ...
    {
        String function =
            (String) params.get("function");
        if (fe == null
            || !fe
                .isFullyInitializedForExecution())
        {
            return Collections.singletonList(
                new TextContent(null, null,
                    "Pure runtime is not"
        ...
        CoreInstance result = fe.start(func,
            org.eclipse.collections.impl
                .factory.Lists.mutable.empty());
        return Collections.singletonList(
            new TextContent(null, null,
                result != null
                    ? result.toString()
        ...
        try
        {
            ...
            if (fe != null
                && fe
                    .isFullyInitializedForExecution())
            {
                return executeGoFunc(
                    runtime, fe, modifiedFiles);
            }
            return Collections.singletonList(
                new TextContent(null, null,
                    "Code compiled"
    ...
    private static List<ContentBlock> doRunTests(
            PureRuntime runtime,
            FunctionExecution fe,
            String path)
    {
        CoreInstance coreInstance =
            runtime.getCoreInstance(path);
        ...
        org.finos.legend.pure.m3.navigation
            .ProcessorSupport processorSupport =
            runtime.getProcessorSupport();
        org.finos.legend.pure.m3.execution.test
            .TestCollection collection =
            org.finos.legend.pure.m3.execution
                .test.TestCollection.collectTests(
                    coreInstance,
                    processorSupport,
                    fn -> org.finos.legend.pure
                        .m3.execution.test
                        .TestCollection
                        .collectTestsFromPure(
                            fn, fe),
                    org.eclipse.collections.impl
                        .block.factory.Predicates
                        .alwaysTrue());

        int totalTests =
            collection.getTestCount();
        StringBuilder sb = new StringBuilder();
        sb.append("Found ")
            .append(totalTests)
            .append(" test(s) at path: ")
            .append(path).append('\n');
    ...
    private static void appendTestResults(
            StringBuilder sb,
            org.finos.legend.pure.m3.execution
                .test.TestCollection collection,
            FunctionExecution fe)
    {
        int passed = 0;
        int failed = 0;
        ...
        for (CoreInstance test
            : collection.getAllTestFunctions())
        {
            try
            {
                fe.start(test,
            ...
            Map<String, Object> params)
    {
        ...
        int line =
            ((Number) params.get("line"))
                .intValue();
        int column =
            ((Number) params.get("column"))
                .intValue();

        Source source =
            runtime.getSourceById(file);
        if (source == null)
        {
            return Collections.singletonList(
                new TextContent(null, null,
        ...
        CoreInstance element = source.navigate(
            line, column,
            runtime.getProcessorSupport());
        if (element == null)
        {
        ...
        sb.append("Element: ")
            ...
            .append('\n');
        if (element.getSourceInformation()
            != null)
        {
            ...
            Map<String, Object> params)
    {
        ...
        try
        {
            ...
            if (ci
                instanceof
                org.finos.legend.pure.m3
                    .coreinstance.Package)
            {
                return formatPackageChildren(
                    ci, path);
            }

            String clsName =
                ci.getClassifier() != null
                    ? ci.getClassifier().getName()
                    : "unknown";
            return Collections.singletonList(
                new TextContent(null, null,
                    "Element: " + ci.getName()
