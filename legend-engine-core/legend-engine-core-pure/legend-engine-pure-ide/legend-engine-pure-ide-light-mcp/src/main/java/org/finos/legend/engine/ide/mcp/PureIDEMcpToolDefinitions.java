...
public class PureIDEMcpToolDefinitions
{
    ...
    public static List<Tool> getTools()
    {
        ...
        tools.add(new Tool(
                ...
                new Tool.Schema(null,
                        mapOf("path", mapOf("type", "string", "description", "The file path (e.g. /platform/pure/grammar.pure)")),
                        Collections.singletonList("path")),
                "read_file", null, "Read File"
        ));
        ...
        tools.add(new Tool(
                ...
                null, null,
                new Tool.Schema(null,
                        mapOf("path", mapOf("type", "string", "description", "The directory path (e.g. / or /platform)")),
                        Collections.singletonList("path")),
                "list_directory", null, "List Directory"
        ));
        ...
        tools.add(new Tool(
                ...
                new Tool.Schema(null,
                        mapOf(
                                "query", mapOf("type", "string", "description", "The search string or regex pattern"),
                                "regex", mapOf("type", "boolean", "description", "Whether to treat query as a regex pattern (default false)"),
                                "caseSensitive", mapOf("type", "boolean", "description", "Whether search is case sensitive (default true)"),
                                "limit", mapOf("type", "integer", "description", "Maximum number of results to return")
                        ),
                        Collections.singletonList("query")),
                "find_in_sources", null, "Find in Sources"
        ));
        ...
        tools.add(new Tool(
                ...
                new Tool.Schema(null,
                        mapOf(
                                "file", mapOf("type", "string", "description", "The file name or pattern to search for"),
                                "regex", mapOf("type", "boolean", "description", "Whether to treat file as a regex pattern (default false)")
                        ),
                        Collections.singletonList("file")),
                "find_pure_file", null, "Find Pure File"
        ));

        tools.add(new Tool(
                null,
                new ToolAnnotations(true, false, false, false, null),
                "Create a new Pure source file",
                null, null,
                new Tool.Schema(null,
                        mapOf(
                                "path", mapOf("type", "string", "description", "The file path to create (e.g. /myRepo/myFile.pure)"),
                                "content", mapOf("type", "string", "description", "Optional initial content for the file")
                        ),
                        Collections.singletonList("path")),
                "create_file", null, "Create File"
        ));
        ...
        tools.add(new Tool(
                ...
                null, null,
                new Tool.Schema(null,
                        mapOf("path", mapOf("type", "string", "description", "The file path to delete")),
                        Collections.singletonList("path")),
                "delete_file", null, "Delete File"
        ));

        tools.add(new Tool(
                null,
                new ToolAnnotations(false, false, false, false, null),
                "Execute a Pure function by fully-qualified name. The Pure runtime must be initialized.",
                null, null,
                new Tool.Schema(null,
                        mapOf("function", mapOf("type", "string", "description", "The fully-qualified function name to execute (e.g. go():Any[*])")),
        ...
        tools.add(new Tool(
                null,
                new ToolAnnotations(false, false, false, false, null),
                "Compile and execute a Pure code block. Modifies the source at the given path, compiles, and runs the go():Any[*] function.",
                null, null,
                new Tool.Schema(null,
                        mapOf(
                                "code", mapOf("type", "string", "description", "The Pure code to compile and execute"),
                                "path", mapOf("type", "string", "description", "The source file path for the code (defaults to /ide_mcp_exec.pure)")
                        ),
        ...
        tools.add(new Tool(
                null,
                new ToolAnnotations(false, false, false, true, null),
                "Run Pure tests matching a path pattern",
                null, null,
                new Tool.Schema(null,
                        mapOf(
                                "path", mapOf("type", "string", "description", "The test path or package to run (e.g. meta::pure::functions::string)"),
                                "pctAdapter", mapOf("type", "string", "description", "Optional PCT adapter to use")
                        ),
                        Collections.singletonList("path")),
        ...
        tools.add(new Tool(
                null,
                new ToolAnnotations(false, true, false, true, null),
                "Get documentation/concept info for a symbol at a given source location",
                null, null,
                new Tool.Schema(null,
                        mapOf(
                                "file", mapOf("type", "string", "description", "The source file path"),
                                "line", mapOf("type", "integer", "description", "The line number (1-based)"),
                                "column", mapOf("type", "integer", "description", "The column number (1-based)")
                        ),
                        Arrays.asList("file", "line", "column")),
                "get_concept_info", null, "Get Concept Info"
        ));

        tools.add(new Tool(
                null,
                new ToolAnnotations(false, true, false, true, null),
                "Get code completion suggestions for a path. Returns matching elements in the given package.",
                null, null,
                new Tool.Schema(null,
                        mapOf("path", mapOf("type", "string", "description", "The package path to get suggestions for (e.g. meta::pure::functions)")),
                        Collections.singletonList("path")),
                "get_suggestions", null, "Get Suggestions"
        ));

        return tools;
    }

    public static Function3<Tool, Map<String, Object>, Identity, List<ContentBlock>> getToolExecutor(
            ...
            FunctionExecution functionExecution)
    {
        return (tool, params, identity) ->
        {
            try
            {
                ...
                {
                    case "read_file":
                        return handleReadFile(codeStorage, params);
                    case "list_directory":
                        return handleListDirectory(codeStorage, params);
                    ...
                    case "execute_pure":
                        return handleExecutePure(pureRuntime, functionExecution, params);
                    case "execute_go":
                        return handleExecuteGo(pureRuntime, functionExecution, params);
                    case "run_tests":
                        return handleRunTests(pureRuntime, functionExecution, params);
    ...
    public static LegendStatelessMcpServerOrchestrator createOrchestrator(
            PureRuntime pureRuntime,
            MutableRepositoryCodeStorage codeStorage,
            FunctionExecution functionExecution)
    {
    ...
    private static List<ContentBlock> handleReadFile(MutableRepositoryCodeStorage codeStorage, Map<String, Object> params)
    {
        String path = (String) params.get("path");
        byte[] content = codeStorage.getContentAsBytes(path);
        if (content == null)
        {
    ...
    private static List<ContentBlock> handleListDirectory(MutableRepositoryCodeStorage codeStorage, Map<String, Object> params)
    {
        String path = (String) params.get("path");
        RichIterable<CodeStorageNode> nodes = codeStorage.getFiles(path);
    ...
    private static List<ContentBlock> handleFindInSources(PureRuntime runtime, Map<String, Object> params)
    {
        ...
        for (SourceCoordinates sc : results)
        {
            ...
            sb.append(sc.getSourceId())
                    .append(':').append(sc.getStartLine())
                    .append(':').append(sc.getStartColumn());
            if (sc.getPreview() != null)
            {
                sb.append(" | ").append(sc.getPreview().getBeforeText())
                        .append(">>>").append(sc.getPreview().getFoundText()).append("<<<")
                        .append(sc.getPreview().getAfterText());
            }
            count++;
        }
        if (count == 0)
    ...
    private static List<ContentBlock> handleExecutePure(PureRuntime runtime, FunctionExecution functionExecution, Map<String, Object> params)
    {
        String function = (String) params.get("function");
        if (functionExecution == null || !functionExecution.isFullyInitializedForExecution())
        {
        ...
        CoreInstance result = functionExecution.start(func, org.eclipse.collections.impl.factory.Lists.mutable.empty());
        return Collections.singletonList(new TextContent(null, null, result != null ? result.toString() : "null"));
    }

    private static List<ContentBlock> handleExecuteGo(PureRuntime runtime, FunctionExecution functionExecution, Map<String, Object> params)
    {
    ...
    private static List<ContentBlock> handleRunTests(PureRuntime runtime, FunctionExecution functionExecution, Map<String, Object> params)
    {
        String path = (String) params.get("path");
        ...
        try
        {
            ...
            org.finos.legend.pure.m3.execution.test.TestCollection collection =
                    org.finos.legend.pure.m3.execution.test.TestCollection.collectTests(
                            coreInstance,
                            processorSupport,
                            fn -> org.finos.legend.pure.m3.execution.test.TestCollection.collectTestsFromPure(fn, functionExecution),
            ...
            if (totalTests > 0)
            {
                // Execute each test function individually
                int passed = 0;
                int failed = 0;
                ...
                for (CoreInstance test : collection.getAllTestFunctions())
                {
                    try
                    {
                        functionExecution.start(test, org.eclipse.collections.impl.factory.Lists.mutable.empty());
                        passed++;
                    }
                    catch (Exception e)
                    {
    ...
    private static List<ContentBlock> handleGetConceptInfo(PureRuntime runtime, Map<String, Object> params)
    {
        ...
        if (element.getSourceInformation() != null)
        {
            sb.append("Defined at: ").append(element.getSourceInformation().getSourceId())
                    .append(':').append(element.getSourceInformation().getStartLine())
                    .append(':').append(element.getSourceInformation().getStartColumn()).append('\n');
        }
        sb.append("Classifier: ").append(element.getClassifier() != null ? element.getClassifier().getName() : "unknown");
    ...
    private static List<ContentBlock> handleGetSuggestions(PureRuntime runtime, Map<String, Object> params)
    {
        ...
        try
        {
            ...
            if (coreInstance instanceof org.finos.legend.pure.m3.coreinstance.Package)
            {
                org.eclipse.collections.api.list.ListIterable<? extends CoreInstance> children =
                        coreInstance.getValueForMetaPropertyToMany("children");
            ...
            return Collections.singletonList(new TextContent(null, null, "Element: " + coreInstance.getName() + " (type: " + (coreInstance.getClassifier() != null ? coreInstance.getClassifier().getName() : "unknown") + ")"));
        }
        catch (Exception e)
        {
