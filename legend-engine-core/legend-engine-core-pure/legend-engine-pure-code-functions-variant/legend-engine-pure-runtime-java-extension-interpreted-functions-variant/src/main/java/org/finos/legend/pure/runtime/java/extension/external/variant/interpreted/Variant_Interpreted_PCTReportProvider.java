...
public class Variant_Interpreted_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Variant_Interpreted_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
