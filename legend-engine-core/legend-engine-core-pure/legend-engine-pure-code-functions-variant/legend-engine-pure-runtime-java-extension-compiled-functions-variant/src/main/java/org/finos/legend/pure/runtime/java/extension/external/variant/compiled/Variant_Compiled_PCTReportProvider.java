...
public class Variant_Compiled_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Variant_Compiled_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
