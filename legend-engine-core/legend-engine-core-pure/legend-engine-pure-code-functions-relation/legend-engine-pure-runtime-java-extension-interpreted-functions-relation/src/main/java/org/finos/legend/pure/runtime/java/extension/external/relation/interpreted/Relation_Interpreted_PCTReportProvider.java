...
public class Relation_Interpreted_PCTReportProvider implements PCTReportProvider
{
    ...
    {
        return PCTReportProviderTool.load(Relation_Interpreted_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                "pct-reports/ADAPTER_relation_interpreted_Native.json"
        );
    }
}
