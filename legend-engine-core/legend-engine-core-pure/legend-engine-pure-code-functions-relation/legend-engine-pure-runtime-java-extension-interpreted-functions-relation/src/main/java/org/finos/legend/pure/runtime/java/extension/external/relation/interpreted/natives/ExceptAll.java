...
public class ExceptAll extends AbstractSetOperation
{
    public ExceptAll(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(functionExecution, repository, "exceptAll");
    }

    @Override
    protected TestTDS apply(TestTDS tds1, TestTDS tds2)
    {
        return tds1.except(tds2, true);
    }
}
