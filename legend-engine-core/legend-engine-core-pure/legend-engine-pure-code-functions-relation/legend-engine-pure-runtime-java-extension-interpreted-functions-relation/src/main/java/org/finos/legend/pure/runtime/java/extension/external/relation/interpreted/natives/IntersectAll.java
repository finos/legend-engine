...
public class IntersectAll extends AbstractSetOperation
{
    public IntersectAll(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(functionExecution, repository, "intersectAll");
    }

    @Override
    protected TestTDS apply(TestTDS tds1, TestTDS tds2)
    {
        return tds1.intersect(tds2, true);
    }
}
