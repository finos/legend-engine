...
public class Intersect extends AbstractSetOperation
{
    public Intersect(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(functionExecution, repository, "intersect");
    }

    @Override
    protected TestTDS apply(TestTDS tds1, TestTDS tds2)
    {
        return tds1.intersect(tds2, false);
    }
}
