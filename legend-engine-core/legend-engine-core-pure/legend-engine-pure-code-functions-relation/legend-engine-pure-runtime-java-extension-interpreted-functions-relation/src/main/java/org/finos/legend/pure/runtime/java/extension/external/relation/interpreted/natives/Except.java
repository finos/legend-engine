...
public class Except extends AbstractSetOperation
{
    public Except(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(functionExecution, repository, "except");
    }

    @Override
    protected TestTDS apply(TestTDS tds1, TestTDS tds2)
    {
        return tds1.except(tds2, false);
    }
}
