...
public class Union extends AbstractSetOperation
{
    public Union(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(functionExecution, repository, "union");
    }

    @Override
    protected TestTDS apply(TestTDS tds1, TestTDS tds2)
    {
        return tds1.union(tds2);
    }
}
