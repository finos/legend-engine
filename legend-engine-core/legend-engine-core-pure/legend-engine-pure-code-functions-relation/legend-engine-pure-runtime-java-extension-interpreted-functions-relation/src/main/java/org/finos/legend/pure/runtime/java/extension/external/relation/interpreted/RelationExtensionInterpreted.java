...
public class RelationExtensionInterpreted extends BaseInterpretedExtension
{
    public RelationExtensionInterpreted()
    {
        super(Tuples.pair("concatenate_Relation_1__Relation_1__Relation_1_", Concatenate::new),
                ...
                Tuples.pair("aggregate_Relation_1__AggColSpec_1__Relation_1_", GroupBy::new),
                Tuples.pair("aggregate_Relation_1__AggColSpecArray_1__Relation_1_", GroupBy::new),
                Tuples.pair("groupBy_Relation_1__ColSpec_1__FuncColSpec_1__Relation_1_", GroupBy::new),
                Tuples.pair("groupBy_Relation_1__ColSpec_1__FuncColSpecArray_1__Relation_1_", GroupBy::new),
                Tuples.pair("groupBy_Relation_1__ColSpecArray_1__FuncColSpec_1__Relation_1_", GroupBy::new),
                Tuples.pair("groupBy_Relation_1__ColSpecArray_1__FuncColSpecArray_1__Relation_1_", GroupBy::new),
                Tuples.pair("aggregate_Relation_1__FuncColSpec_1__Relation_1_", GroupBy::new),
                Tuples.pair("aggregate_Relation_1__FuncColSpecArray_1__Relation_1_", GroupBy::new),
                ...
                Tuples.pair("reduce_Relation_1___Window_1__T_1__Function_1__Function_1__U_m_", org.finos.legend.pure.runtime.java.extension.external.relation.interpreted.natives.Reduce::new)
        );
    }
