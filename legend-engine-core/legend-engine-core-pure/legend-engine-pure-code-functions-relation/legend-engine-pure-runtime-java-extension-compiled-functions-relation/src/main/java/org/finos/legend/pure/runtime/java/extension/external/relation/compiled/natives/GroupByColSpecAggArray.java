...
public class GroupByColSpecAggArray extends AbstractNative implements Native
{
    public GroupByColSpecAggArray()
    {
        super("groupBy_Relation_1__ColSpec_1__AggColSpecArray_1__Relation_1_");
    }
