...
public class AggregateArray extends AbstractNative implements Native
{
    public AggregateArray()
    {
        super("aggregate_Relation_1__AggColSpecArray_1__Relation_1_");
    }
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        result.append(", ");
        processAggColSpec(result, "Lists.mutable.withAll(" + transformedParams.get(1) + "._aggSpecs())", false);
        result.append(", es)");
