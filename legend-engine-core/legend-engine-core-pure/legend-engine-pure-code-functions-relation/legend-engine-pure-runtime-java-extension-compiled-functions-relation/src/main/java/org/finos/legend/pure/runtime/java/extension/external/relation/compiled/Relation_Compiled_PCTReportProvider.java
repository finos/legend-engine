...
public class Relation_Compiled_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Relation_Compiled_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                "pct-reports/ADAPTER_relation_compiled_Native.json"
        );
    }
}
