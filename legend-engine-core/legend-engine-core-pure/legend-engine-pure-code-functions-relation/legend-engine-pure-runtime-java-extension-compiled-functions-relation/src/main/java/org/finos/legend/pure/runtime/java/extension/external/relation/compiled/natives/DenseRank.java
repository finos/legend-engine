...
public class DenseRank extends AbstractNative implements Native
{
    public DenseRank()
    {
        super("denseRank_Relation_1___Window_1__T_1__Integer_1_");
    }

    @Override
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        StringBuilder result = new StringBuilder("org.finos.legend.pure.runtime.java.extension.external.relation.compiled.RelationNativeImplementation.denseRank(");
