...
public class GroupByColSpecAgg extends AbstractNative implements Native
{
    public GroupByColSpecAgg()
    {
        super("groupBy_Relation_1__ColSpec_1__AggColSpec_1__Relation_1_");
    }
    ...
    public String buildBody()
    {
        return "new SharedPureFunction<Object>()\n" +
                ...
                "   {\n" +
                "       return " + getString(Lists.mutable.with("(org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.relation.Relation<? extends Object>)vars.get(0)", "(org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.relation.ColSpec<?>)vars.get(1)", "(org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.relation.AggColSpec<? extends Object, ? extends Object, ? extends Object>)vars.get(2)")) + ";" +
                "   }\n" +
                "\n}";
    }
    ...
    private static String getString(ListIterable<String> transformedParams)
    {
        ...
        result.append(", ");
        processAggColSpec(result, "Lists.mutable.with(" + transformedParams.get(2) + ")", false);
        result.append(", es)");
        return result.toString();
    }

    static void processAggColSpec(StringBuilder result, String parameter, boolean twoArgs)
    {
        String className = "AggColSpecTrans" + (twoArgs ? "2" : "1");

        result.append(parameter + ".collect(");
