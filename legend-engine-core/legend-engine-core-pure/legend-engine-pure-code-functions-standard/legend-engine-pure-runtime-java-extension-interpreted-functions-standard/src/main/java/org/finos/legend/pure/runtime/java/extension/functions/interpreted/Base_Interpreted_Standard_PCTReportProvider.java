...
public class Base_Interpreted_Standard_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Base_Interpreted_Standard_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                "pct-reports/ADAPTER_standard_interpreted_Native.json"
        );
    }
}
