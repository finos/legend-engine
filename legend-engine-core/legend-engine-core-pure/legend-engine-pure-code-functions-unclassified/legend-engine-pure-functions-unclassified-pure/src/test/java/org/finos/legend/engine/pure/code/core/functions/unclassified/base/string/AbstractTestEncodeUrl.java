...
public abstract class AbstractTestEncodeUrl extends AbstractPureTestWithCoreCompiled
{
    @After
    ...
    public void testBasicUrlEncoding()
    {
        compileTestSource("fromString.pure",
                "function test():Boolean[1]\n" +
                        "{\n" +
                        "   assert('abc%2Cxyz+%25+%2B' == 'abc,xyz % +'->encodeUrl(), | '');\n" +
                        "}\n");
    ...
    public void testUrlEncodingWithNonDefaultCharset()
    {
        compileTestSource("fromString.pure",
                "function test():Boolean[1]\n" +
                        "{\n" +
                        "   assert('abc%2Cxyz+%25+%2B' == 'abc,xyz % +'->encodeUrl('ascii'), | '');\n" +
                        "}\n");
        this.execute("test():Boolean[1]");
    }
}
