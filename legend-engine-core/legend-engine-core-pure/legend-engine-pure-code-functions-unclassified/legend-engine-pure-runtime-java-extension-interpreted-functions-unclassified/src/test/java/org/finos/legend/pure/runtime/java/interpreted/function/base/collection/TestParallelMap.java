...
public class TestParallelMap extends AbstractTestParallelMap
{
    public TestParallelMap()
    {
    }
    ...
    {
        return new FunctionExecutionInterpreted(Executors.newFixedThreadPool(4));
    }
}
