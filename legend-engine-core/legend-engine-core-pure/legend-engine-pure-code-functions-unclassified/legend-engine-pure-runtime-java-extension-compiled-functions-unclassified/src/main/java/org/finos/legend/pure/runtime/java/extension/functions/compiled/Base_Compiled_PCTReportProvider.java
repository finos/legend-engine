...
public class Base_Compiled_PCTReportProvider implements PCTReportProvider
{
    @Override
    ...
    {
        return PCTReportProviderTool.load(Base_Compiled_PCTReportProvider.class.getClassLoader(), AdapterReport.class,
                "pct-reports/ADAPTER_unclassified_compiled_Native.json"
        );
    }
}
