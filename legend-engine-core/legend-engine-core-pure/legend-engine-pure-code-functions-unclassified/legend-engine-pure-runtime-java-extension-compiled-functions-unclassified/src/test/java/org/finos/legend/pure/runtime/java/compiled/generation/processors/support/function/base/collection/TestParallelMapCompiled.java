...
public class TestParallelMapCompiled extends AbstractTestParallelMap
{
    public TestParallelMapCompiled()
    {
    }
    ...
    {
        return new FunctionExecutionCompiledBuilder().withExecutorService(Executors.newFixedThreadPool(4)).build();
    }
}
