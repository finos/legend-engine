...
public class JsonSerializationMultiplicityMany<T> extends JsonPropertySerialization<T>
{
    public JsonSerializationMultiplicityMany(AbstractProperty property, boolean isFromAssociation, Conversion<T, Object> conversion, Type type)
    {
