...
public class JsonDeserializationMultiplicityOne<T> extends JsonPropertyDeserialization<T>
{
    public JsonDeserializationMultiplicityOne(AbstractProperty property, boolean isFromAssociation, Conversion<Object, T> conversion, Type type)
    {
