...
public class JsonSerializationMultiplicityRange<T> extends JsonPropertySerialization<T>
{
    public JsonSerializationMultiplicityRange(AbstractProperty property, boolean isFromAssociation, Conversion<T, Object> conversion, Type type, Multiplicity multiplicity)
    {
