...
public class JsonSerializationMultiplicityOne<T> extends JsonPropertySerialization<T>
{
    public JsonSerializationMultiplicityOne(AbstractProperty property, boolean isFromAssociation, Conversion<T, Object> conversion, Type type)
    {
