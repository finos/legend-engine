...
public class PureGrammarParserExtensions
{
    ...
    private final ImmutableList<Function2<DataElementReference, PureModelContextData, List<EmbeddedData>>> dataReferenceParsers;
    ...
    public EmbeddedData getEmbeddedDataFromDataElement(DataElementReference dataElementReference, PureModelContextData pureModelContextData)
    {
    ...
    private static MapIterable<String, TestAssertionParser> indexTestAssertionDataParsers(Iterable<? extends PureGrammarParserExtension> extensions)
    {
        return indexByKey(LazyIterate.flatCollect(extensions, PureGrammarParserExtension::getExtraTestAssertionParsers),
                ...
                "Conflicting parsers for mapping include types");
    }

    private static MapIterable<String, MappingIncludeParser> indexMappingIncludeParsers(Iterable<? extends PureGrammarParserExtension> extensions)
    {
    ...
    private ImmutableList<Function2<DataElementReference, PureModelContextData, List<EmbeddedData>>> indexDataReferenceParsers(ImmutableList<PureGrammarParserExtension> extensions)
    {
