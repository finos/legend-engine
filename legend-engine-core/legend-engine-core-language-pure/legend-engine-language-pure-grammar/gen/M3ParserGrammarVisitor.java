...
public interface M3ParserGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#columnBuilders}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColumnBuilders(M3ParserGrammar.ColumnBuildersContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#oneColSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOneColSpec(M3ParserGrammar.OneColSpecContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#colSpecArray}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColSpecArray(M3ParserGrammar.ColSpecArrayContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#extraFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtraFunction(M3ParserGrammar.ExtraFunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#primitiveValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitiveValue(M3ParserGrammar.PrimitiveValueContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#primitiveValueVector}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitiveValueVector(M3ParserGrammar.PrimitiveValueVectorContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#primitiveValueAtomic}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimitiveValueAtomic(M3ParserGrammar.PrimitiveValueAtomicContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#toBytesLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitToBytesLiteral(M3ParserGrammar.ToBytesLiteralContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#dslExtension}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDslExtension(M3ParserGrammar.DslExtensionContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#dslExtensionContent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDslExtensionContent(M3ParserGrammar.DslExtensionContentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#functionIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionIdentifier(M3ParserGrammar.FunctionIdentifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#islandDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIslandDefinition(M3ParserGrammar.IslandDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link M3ParserGrammar#islandContent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIslandContent(M3ParserGrammar.IslandContentContext ctx);
}