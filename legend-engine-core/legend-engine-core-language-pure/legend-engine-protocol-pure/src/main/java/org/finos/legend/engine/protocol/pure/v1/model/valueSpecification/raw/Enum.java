...
@Deprecated
@JsonDeserialize(using = Enum.EnumDeserializer.class)
public class Enum extends PackageableElementPtr
{
    private Enum()
    {
    }
    ...
    public static class EnumDeserializer extends JsonDeserializer<ValueSpecification>
    {
        @Override
