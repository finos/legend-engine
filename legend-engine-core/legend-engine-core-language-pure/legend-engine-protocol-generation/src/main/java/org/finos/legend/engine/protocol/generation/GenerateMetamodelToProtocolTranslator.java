...
public class GenerateMetamodelToProtocolTranslator extends GenerateJavaProject
{
    ...
    {
        return core_protocol_generation_generation.Root_meta_protocols_generation_java_translation_generateMetamodelToProtocolTranslation_String_1__String_MANY__Project_1_(argument.configJson, argument.dependencies, executionSupport);
    }
}
