...
public class FunctionExpressionBuilderRegistrationInfo
{
    List<Integer> coordinates;
    FunctionExpressionBuilder functionExpressionBuilder;

    public FunctionExpressionBuilderRegistrationInfo(List<Integer> coordinates, FunctionExpressionBuilder functionExpressionBuilder)
    {
