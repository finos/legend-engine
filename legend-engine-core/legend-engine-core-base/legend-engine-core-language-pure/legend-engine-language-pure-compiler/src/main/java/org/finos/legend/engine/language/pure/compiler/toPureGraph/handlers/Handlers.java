...
public class Handlers
{
    ...
    {
        return this.pureModel.getTaxoMap();
    }
    ...
    public static final ParametersInference LambdaColCollectionInference = (parameters, valueSpecificationBuilder) ->
    {
        ...
        {
            final GenericType gt2 = valueSpecificationBuilder.getContext().pureModel.taxonomyTypes("cov_relation_Relation").contains(gt._rawType().getName()) ? gt._typeArguments().getFirst() : gt;
    ...
    public static List<ValueSpecification> processRelationAndColSpecParams(List<org.finos.legend.engine.protocol.pure.m3.valuespecification.ValueSpecification> parameters, ValueSpecificationBuilder valueSpecificationBuilder, String columnType)
    {
        ...
        specs.forEach(colSpec ->
        {
            ...
            if (StringUtils.isNotBlank(columnType) && !valueSpecificationBuilder.getContext().taxonomyContains("cov_" + columnType, colType))
            {
    ...
    public Handlers(PureModel pureModel, MutableMap<String, org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.function.Function<? extends Object>> fcache)
    {
        ...
        register(m(
                        m(
                                h("meta::pure::functions::relation::_range_Number_1__Number_1___Range_1_", "_range", false, ps -> res("meta::pure::functions::relation::_Range", "one"), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                                h("meta::pure::functions::relation::_range_UnboundedFrameValue_1__Number_1___Range_1_", "_range", false, ps -> res("meta::pure::functions::relation::_Range", "one"), ps -> ps.size() == 2 && typeOne(ps.get(0), "UnboundedFrameValue") && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                                h("meta::pure::functions::relation::_range_Number_1__UnboundedFrameValue_1___Range_1_", "_range", false, ps -> res("meta::pure::functions::relation::_Range", "one"), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number"))),
        ...
        register(m(
                        ...
                        m(
                                ...
                                h("meta::pure::functions::relation::over_ColSpecArray_1__SortInfo_1___RangeInterval_1___Window_1_", "over", false, ps -> OverReturnInference(ps, this.pureModel), ps -> Lists.fixedSize.of(ps.get(0)._genericType()), ps -> ps.size() == 3 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_relation_ColSpecArray")) && typeOne(ps.get(2), "meta::pure::functions::relation::_RangeInterval")),
...
//                ps -> Lists.fixedSize.of(ps.get(0)._genericType()),
        ...
        register(h("meta::pure::functions::lang::extractEnumValue_Enumeration_1__String_1__T_1_", "extractEnumValue", true, ps -> res(ps.get(0)._genericType()._typeArguments().getFirst(), "one"), ps -> typeOne(ps.get(1), "String")),
                h("meta::pure::functions::lang::extractEnumValue_Enumeration_1__String_$0_1$__T_$0_1$_", "extractEnumValue", false, ps -> res(ps.get(0)._genericType()._typeArguments().getFirst(), "zeroOne"), ps -> typeZeroOne(ps.get(1), "String")));
        ...
        // Enumeration-mapping helpers -- T recovered from the Enumeration<T> argument at position 1.
        register(h("meta::pure::mapping::getSourceEnumValues_Mapping_1__Enumeration_1__Enum_MANY_", "getSourceEnumValues", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroMany"), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_mapping_Mapping"))));
        register(h("meta::pure::mapping::getSourceEnumValuesByName_Mapping_1__Enumeration_1__String_1__Enum_MANY_", "getSourceEnumValuesByName", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroMany"), ps -> ps.size() == 3 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_mapping_Mapping")) && typeOne(ps.get(2), "String")));
        register(h("meta::pure::mapping::getEnumerationMappingValueByName_Mapping_1__Enumeration_1__String_1__Any_1__Enum_$0_1$_", "getEnumerationMappingValueByName", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroOne"), ps -> ps.size() == 4 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_mapping_Mapping")) && typeOne(ps.get(2), "String")));
        register(h("meta::pure::mapping::mapToEnumValue_Enum_1__Enumeration_1__Mapping_1__Enum_1_", "mapToEnumValue", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "one"), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_mapping_Mapping"))));
        register(h("meta::pure::mapping::mapToEnumValueOptional_Enum_$0_1$__Enumeration_1__Mapping_1__Enum_$0_1$_", "mapToEnumValueOptional", false, ps -> res(ps.get(1)._genericType()._typeArguments().getFirst(), "zeroOne"), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_mapping_Mapping"))));
        ...
        register(h("meta::pure::tds::limit_TabularDataSet_1__Integer_1__TabularDataSet_1_", "limit", false, ps -> res("meta::pure::tds::TabularDataSet", "one"), ps -> typeOne(ps.get(0), "TabularDataSet") && typeOne(ps.get(1), "Integer")),
                ...
                h("meta::pure::functions::relation::limit_Relation_1__Integer_1__Relation_1_", "limit", true, ps -> res(ps.get(0)._genericType(), "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_relation_Relation"))),
    ...
    private void registerFunctionDispatch()
    {
        CompileContext context = this.pureModel.getContext();
        ListIterate.flatCollect(context.getCompilerExtensions().getExtraFunctionHandlerDispatchBuilderInfoCollectors(), collector -> collector.valueOf(this)).forEach(info -> this.dispatchMap.put(info.functionName, info.dispatch));
    }
    ...
    private void registerTDS()
    {
        ...
        register(
                m(
                        m(
                                h("meta::pure::mapping::from_FunctionDefinition_1__Runtime_1__T_m_", "from", false, ps -> res(funcReturnType(ps.get(0)), funcReturnMul(ps.get(0))), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_function_FunctionDefinition")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_FunctionDefinition_1__PackageableRuntime_1__T_m_", "from", false, ps -> res(funcReturnType(ps.get(0)), funcReturnMul(ps.get(0))), ps -> ps.size() == 2 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_function_FunctionDefinition")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime"))),
                                h("meta::pure::mapping::from_T_m__Runtime_1__T_m_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 2 && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_T_m__PackageableRuntime_1__T_m_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 2 && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime")))
                        ),
                        m(
                                h("meta::pure::mapping::from_FunctionDefinition_1__Mapping_1__Runtime_1__T_m_", "from", false, ps -> res(funcReturnType(ps.get(0)), funcReturnMul(ps.get(0))), ps -> ps.size() == 3 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_function_FunctionDefinition")) && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_FunctionDefinition_1__Mapping_1__PackageableRuntime_1__T_m_", "from", false, ps -> res(funcReturnType(ps.get(0)), funcReturnMul(ps.get(0))), ps -> ps.size() == 3 && typeOne(ps.get(0), pureModel.taxonomyTypes("cov_function_FunctionDefinition")) && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime"))),
                                h("meta::pure::mapping::from_TabularDataSet_1__Mapping_1__Runtime_1__TabularDataSet_1_", "from", false, ps -> res("meta::pure::tds::TabularDataSet", "one"), ps -> ps.size() == 3 && "TabularDataSet".equals(ps.get(0)._genericType()._rawType()._name()) && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_TabularDataSet_1__Mapping_1__PackageableRuntime_1__TabularDataSet_1_", "from", false, ps -> res("meta::pure::tds::TabularDataSet", "one"), ps -> ps.size() == 3 && "TabularDataSet".equals(ps.get(0)._genericType()._rawType()._name()) && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime"))),
                                h("meta::pure::mapping::from_T_m__Mapping_1__Runtime_1__T_m_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_T_m__Mapping_1__PackageableRuntime_1__T_m_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime")))
                        ),
                        m(
                                h("meta::pure::mapping::from_TabularDataSet_1__Mapping_1__Runtime_1__ExecutionContext_1__TabularDataSet_1_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 4 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::from_TabularDataSet_1__Mapping_1__PackageableRuntime_1__ExecutionContext_1__TabularDataSet_1_", "from", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 4 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime")))
                        )
                )
        );
        ...
        register(
                m(
                        m(
                                h("meta::pure::mapping::with_T_m__Runtime_1__T_m_", "with", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 2 && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::with_T_m__PackageableRuntime_1__T_m_", "with", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 2 && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime")))
                        ),
                        m(
                                h("meta::pure::mapping::with_T_m__Mapping_1__Runtime_1__T_m_", "with", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_Runtime"))),
                                h("meta::pure::mapping::with_T_m__Mapping_1__PackageableRuntime_1__T_m_", "with", false, ps -> res(ps.get(0)._genericType(), ps.get(0)._multiplicity()), ps -> ps.size() == 3 && typeOne(ps.get(2), pureModel.taxonomyTypes("cov_runtime_PackageableRuntime")))
                        )
                )
        );
    ...
    {
        register(h("meta::pure::functions::date::dateDiff_Date_1__Date_1__DurationUnit_1__Integer_1_", "dateDiff", true, ps -> res("Integer", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
        ...
        register(h("meta::pure::functions::date::datePart_Date_1__Date_1_", "datePart", true, ps -> res("Date", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::datePart_Date_$0_1$__Date_$0_1$_", "datePart", false, ps -> res("Date", "zeroOne"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::dayOfWeek_Date_1__DayOfWeek_1_", "dayOfWeek", false, ps -> res("meta::pure::functions::date::DayOfWeek", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
        ...
        register(h("meta::pure::functions::date::isAfterDay_Date_1__Date_1__Boolean_1_", "isAfterDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isAfterDay_Date_$0_1$__Date_1__Boolean_1_", "isAfterDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isAfterDay_Date_1__Date_$0_1$__Boolean_1_", "isAfterDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isAfterDay_Date_$0_1$__Date_$0_1$__Boolean_1_", "isAfterDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::isBeforeDay_Date_1__Date_1__Boolean_1_", "isBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isBeforeDay_Date_$0_1$__Date_1__Boolean_1_", "isBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isBeforeDay_Date_1__Date_$0_1$__Boolean_1_", "isBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isBeforeDay_Date_$0_1$__Date_$0_1$__Boolean_1_", "isBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::isOnDay_Date_1__Date_1__Boolean_1_", "isOnDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnDay_Date_$0_1$__Date_1__Boolean_1_", "isOnDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnDay_Date_1__Date_$0_1$__Boolean_1_", "isOnDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnDay_Date_$0_1$__Date_$0_1$__Boolean_1_", "isOnDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::isOnOrAfterDay_Date_1__Date_1__Boolean_1_", "isOnOrAfterDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrAfterDay_Date_$0_1$__Date_1__Boolean_1_", "isOnOrAfterDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrAfterDay_Date_1__Date_$0_1$__Boolean_1_", "isOnOrAfterDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrAfterDay_Date_$0_1$__Date_$0_1$__Boolean_1_", "isOnOrAfterDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::isOnOrBeforeDay_Date_1__Date_1__Boolean_1_", "isOnOrBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrBeforeDay_Date_$0_1$__Date_1__Boolean_1_", "isOnOrBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrBeforeDay_Date_1__Date_$0_1$__Boolean_1_", "isOnOrBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::isOnOrBeforeDay_Date_$0_1$__Date_$0_1$__Boolean_1_", "isOnOrBeforeDay", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::monthNumber_Date_1__Integer_1_", "monthNumber", true, ps -> res("Integer", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::monthNumber_Date_$0_1$__Integer_$0_1$_", "monthNumber", false, ps -> res("Integer", "zeroOne"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));

        register(h("meta::pure::functions::date::month_Date_1__Month_1_", "month", false, ps -> res("meta::pure::functions::date::Month", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
        ...
        register(h("meta::pure::functions::date::quarter_Date_1__Quarter_1_", "quarter", false, ps -> res("meta::pure::functions::date::Quarter", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
        ...
        register(h("meta::pure::functions::date::year_Date_1__Integer_1_", "year", true, ps -> res("Integer", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::date::year_Date_$0_1$__Integer_$0_1$_", "year", false, ps -> res("Integer", "zeroOne"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        ...
        register(h("meta::pure::functions::date::hasDay_Date_1__Boolean_1_", "hasDay", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        register(h("meta::pure::functions::date::hasHour_Date_1__Boolean_1_", "hasHour", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        register(h("meta::pure::functions::date::hasMinute_Date_1__Boolean_1_", "hasMinute", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        register(h("meta::pure::functions::date::hasMonth_Date_1__Boolean_1_", "hasMonth", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        register(h("meta::pure::functions::date::hasSecond_Date_1__Boolean_1_", "hasSecond", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
        register(h("meta::pure::functions::date::hasSubsecondWithAtLeastPrecision_Date_1__Integer_1__Boolean_1_", "hasSubsecondWithAtLeastPrecision", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), "Integer")));
        register(h("meta::pure::functions::date::hasSubsecond_Date_1__Boolean_1_", "hasSubsecond", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date"))));
    ...
    private void registerMathInequalities()
    {
        register(grp(SingleColumnRelationInference.apply("greaterThan"),
                ...
                h("meta::pure::functions::boolean::greaterThan_Date_1__Date_1__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThan_Date_1__Date_$0_1$__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThan_Date_$0_1$__Date_1__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThan_Date_$0_1$__Date_$0_1$__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThan_Number_1__Number_1__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThan_Number_1__Number_$0_1$__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThan_Number_$0_1$__Number_1__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThan_Number_$0_1$__Number_$0_1$__Boolean_1_", "greaterThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
        ...
        register(grp(SingleColumnRelationInference.apply("greaterThanEqual"),
                ...
                h("meta::pure::functions::boolean::greaterThanEqual_Date_1__Date_1__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Date_1__Date_$0_1$__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Date_$0_1$__Date_1__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Date_$0_1$__Date_$0_1$__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Number_1__Number_1__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Number_1__Number_$0_1$__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Number_$0_1$__Number_1__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::greaterThanEqual_Number_$0_1$__Number_$0_1$__Boolean_1_", "greaterThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
        ...
        register(grp(SingleColumnRelationInference.apply("lessThan"),
                ...
                h("meta::pure::functions::boolean::lessThan_Date_1__Date_1__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThan_Date_1__Date_$0_1$__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThan_Date_$0_1$__Date_1__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThan_Date_$0_1$__Date_$0_1$__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThan_Number_1__Number_1__Boolean_1_", "lessThan", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThan_Number_1__Number_$0_1$__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThan_Number_$0_1$__Number_1__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThan_Number_$0_1$__Number_$0_1$__Boolean_1_", "lessThan", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
        ...
        register(grp(SingleColumnRelationInference.apply("lessThanEqual"),
                ...
                h("meta::pure::functions::boolean::lessThanEqual_Date_1__Date_1__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThanEqual_Date_1__Date_$0_1$__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThanEqual_Date_$0_1$__Date_1__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThanEqual_Date_$0_1$__Date_$0_1$__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Date")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Date"))),
                h("meta::pure::functions::boolean::lessThanEqual_Number_1__Number_1__Boolean_1_", "lessThanEqual", true, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThanEqual_Number_1__Number_$0_1$__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThanEqual_Number_$0_1$__Number_1__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
                h("meta::pure::functions::boolean::lessThanEqual_Number_$0_1$__Number_$0_1$__Boolean_1_", "lessThanEqual", false, ps -> res("Boolean", "one"), ps -> typeZeroOne(ps.get(0), pureModel.taxonomyTypes("cov_Number")) && typeZeroOne(ps.get(1), pureModel.taxonomyTypes("cov_Number"))),
    ...
    private void registerUnitFunctions()
    {
        ...
        register(h("meta::pure::executionPlan::engine::java::unitValue_Any_1__Number_1_", "unitValue", false, ps -> res("Number", "one"), ps -> typeOneMany(ps.get(0), pureModel.taxonomyTypes("cov_Number"))));
    ...
    public <T> boolean check(T val, Function<T, Boolean> func)
    {
    ...
    public FunctionType funcType(GenericType gt)
    {
    ...
    public boolean matchZeroOne(Multiplicity mul)
    {
    ...
    public boolean matchOneMany(Multiplicity mul)
    {
