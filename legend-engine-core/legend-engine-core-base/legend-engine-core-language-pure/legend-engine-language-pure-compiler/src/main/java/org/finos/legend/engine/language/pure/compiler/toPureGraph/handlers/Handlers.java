...
//                ps -> Lists.fixedSize.of(ps.get(0)._genericType()),
    ...
    private void registerDates()
    {
        ...
        register("meta::pure::functions::date::formatDateTime_DateTime_1__DateTimeFormat_1__String_1_", "formatDateTime", false, ps -> res("String", "one"));
        register("meta::pure::functions::date::formatDate_Date_1__DateFormat_1__String_1_", "formatDate", false, ps -> res("String", "one"));
