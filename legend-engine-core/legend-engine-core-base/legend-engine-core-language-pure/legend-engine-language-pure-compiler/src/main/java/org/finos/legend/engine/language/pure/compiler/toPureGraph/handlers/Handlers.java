    ...
    public Handlers(PureModel pureModel)
    {
        ...
        register(m(
                        ...
                        m(
                                ...
                                h("meta::pure::functions::relation::over_ColSpecArray_1__Frame_1___Window_1_", false, ps -> OverReturnInference(ps, this.pureModel), ps -> Lists.fixedSize.of(ps.get(0)._genericType()), ps -> true),
...
//-------------------------------------------------------------------------------------------------
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::pure::functions::relation::over_ColSpecArray_1__Frame_1___Window_1_", (List<ValueSpecification> ps) -> ps.size() == 2 && isOne(ps.get(0)._multiplicity()) && taxoMap.get("cov_relation_ColSpecArray").contains(ps.get(0)._genericType()._rawType()._name()) && isOne(ps.get(1)._multiplicity()) && taxoMap.get("cov_relation_Frame").contains(ps.get(1)._genericType()._rawType()._name()));
