...
public class Handlers
{
    ...
    public static final ParametersInference ExtendInference = (parameters, ov, cc, pc) ->
    {
        ...
        {
            if (parameters.get(1) instanceof AppliedFunction && ((AppliedFunction) parameters.get(1)).function.equals("over"))
            {
    ...
    public Handlers(PureModel pureModel)
    {
        ...
        register(grp(TDSAggInference, h("meta::pure::tds::extensions::groupBy_TabularDataSet_1__String_MANY__AggregateValue_MANY__GroupBySpecialAggregation_1__TabularDataSet_1_", false, ps -> res("meta::pure::tds::TabularDataSet", "one"), ps -> ps.size() == 4)));
        ...
        register(m(
                        m(
                                h("meta::pure::functions::relation::over_ColSpec_1___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_Frame_1___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_ColSpecArray_1___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_SortInfo_MANY___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true)),
                        m(
                                h("meta::pure::functions::relation::over_ColSpecArray_1__SortInfo_MANY___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_ColSpec_1__Frame_1___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_ColSpec_1__SortInfo_MANY___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true),
                                h("meta::pure::functions::relation::over_SortInfo_MANY__Frame_1___Window_1_", false, ps -> res("meta::pure::functions::relation::_Window", "one"), ps -> true)
                        )
                )
        );
        ...
        register("meta::pure::tds::wavg_String_1__String_1__String_1__GroupBySpecialAggregation_1_", false, ps -> res("meta::pure::tds::GroupBySpecialAggregation", "one"));
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::pure::tds::wavg_String_1__String_1__String_1__GroupBySpecialAggregation_1_", (List<ValueSpecification> ps) -> ps.size() == 3 && isOne(ps.get(0)._multiplicity()) && ("Nil".equals(ps.get(0)._genericType()._rawType()._name()) || "String".equals(ps.get(0)._genericType()._rawType()._name())) && isOne(ps.get(1)._multiplicity()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "String".equals(ps.get(1)._genericType()._rawType()._name())) && isOne(ps.get(2)._multiplicity()) && ("Nil".equals(ps.get(2)._genericType()._rawType()._name()) || "String".equals(ps.get(2)._genericType()._rawType()._name())));
        ...
        map.put("meta::pure::tds::extensions::groupBy_TabularDataSet_1__String_MANY__AggregateValue_MANY__GroupBySpecialAggregation_1__TabularDataSet_1_", (List<ValueSpecification> ps) -> ps.size() == 4 && isOne(ps.get(0)._multiplicity()) && Sets.immutable.with("Nil","TabularDataSet","TabularDataSetImplementation","IndexTDS","TableTDS").contains(ps.get(0)._genericType()._rawType()._name()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "String".equals(ps.get(1)._genericType()._rawType()._name())) && ("Nil".equals(ps.get(2)._genericType()._rawType()._name()) || "AggregateValue".equals(ps.get(2)._genericType()._rawType()._name())) && isOne(ps.get(3)._multiplicity()) && Sets.immutable.with("Nil","GroupBySpecialAggregation","WavgAggregation").contains(ps.get(3)._genericType()._rawType()._name()));
