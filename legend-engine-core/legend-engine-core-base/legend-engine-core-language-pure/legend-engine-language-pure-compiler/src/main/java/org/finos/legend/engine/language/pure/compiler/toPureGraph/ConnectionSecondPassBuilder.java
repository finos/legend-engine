...
public class ConnectionSecondPassBuilder implements ConnectionVisitor<Root_meta_core_runtime_Connection>
{
    private final CompileContext context;
    private final Root_meta_core_runtime_Connection pureConnection;

    public ConnectionSecondPassBuilder(CompileContext context, Root_meta_core_runtime_Connection pureConnection)
    {
