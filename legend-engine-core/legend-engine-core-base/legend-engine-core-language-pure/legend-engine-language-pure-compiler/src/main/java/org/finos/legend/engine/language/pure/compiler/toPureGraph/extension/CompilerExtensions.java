...
public class CompilerExtensions
{
    ...
    private final ImmutableList<Function5<org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.PackageableElement, Root_meta_pure_data_EmbeddedData, CompileContext, Boolean, SourceInformation, Root_meta_pure_data_EmbeddedData>> extraPackageableElementToEmbeddedDataProcessors;
    ...
    private CompilerExtensions(Iterable<? extends CompilerExtension> extensions)
    {
        ...
        this.extraPackageableElementToEmbeddedDataProcessors = this.extensions.flatCollect(CompilerExtension::getPackageableElementToEmbeddedDataProcessors);
    ...
    {
        return this.extraPackageableElementToEmbeddedDataProcessors.castToList();
    }
