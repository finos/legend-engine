    ...
    public Iterable<? extends Processor<?>> getExtraProcessors()
    {
        return Lists.fixedSize.of(
                Processor.newProcessor(
                        ...
                        (Association srcAssociation, CompileContext context) ->
                        {
                            ...
                            return association._stereotypes(ListIterate.collect(srcAssociation.stereotypes, stereotype -> HelperCoreBuilder.resolveStereotype(stereotype, context)))
                                    ._taggedValues(ListIterate.collect(srcAssociation.taggedValues, taggedValue -> HelperCoreBuilder.newTaggedValue(taggedValue, context)));
                        },
                        (Association srcAssociation, CompileContext context) ->
                        {
                            String packageString = context.pureModel.buildPackageString(srcAssociation._package, srcAssociation.name);
