...
public class AggregationAwareClassMapping extends ClassMapping
{
    public ClassMapping mainSetImplementation;
    public List<PropertyMapping> propertyMappings;
    public List<AggregateSetImplementationContainer> aggregateSetImplementations;
