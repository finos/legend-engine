...
public class AlloySDLCLoader
{
    ...
    public String getMetaDataApiUrl(Identity identity, AlloySDLC alloySDLC, String clientVersion)
    {
        ...
        return (isLatestRevision(alloySDLC)) ?
                metaDataServerConfiguration.getAlloy().getBaseUrl() + "/projects/" + alloySDLC.groupId + "/" + alloySDLC.artifactId + "/revisions/latest/pureModelContextData?convertToNewProtocol=false&clientVersion=" + clientVersion :
                metaDataServerConfiguration.getAlloy().getBaseUrl() + "/projects/" + alloySDLC.groupId + "/" + alloySDLC.artifactId + "/versions/" + alloySDLC.version + "/pureModelContextData?convertToNewProtocol=false&clientVersion=" + clientVersion;
    }
