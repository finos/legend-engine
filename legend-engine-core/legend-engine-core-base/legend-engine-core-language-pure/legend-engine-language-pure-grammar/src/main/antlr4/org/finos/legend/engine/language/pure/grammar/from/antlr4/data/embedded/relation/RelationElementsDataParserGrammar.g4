...
parser grammar RelationElementsDataParserGrammar;

import M3ParserGrammar;

options
{
    tokenVocab = RelationElementsDataLexerGrammar;
}
...
;
columnNames:                           cell (ROW_COMMA cell)*
;
rows:                                  (NEWLINE rowValues)*
;
