...
public class RelationFunctionMappingParseTreeWalker
{
    ...
    {
        relationFunctionClassMapping.relationFunction = PureGrammarParserUtility.fromQualifiedName(ctx.qualifiedName().packagePath() == null ? Collections.emptyList() : ctx.qualifiedName().packagePath().identifier(), ctx.qualifiedName().identifier());
