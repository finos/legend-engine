...
import org.finos.legend.pure.generated.Root_meta_external_format_shared_transformation_tests_ExampleSchema;
import org.finos.legend.pure.generated.Root_meta_external_format_shared_transformation_tests_ExampleSchemaToModelConfiguration_Impl;
import org.finos.legend.pure.generated.Root_meta_external_format_shared_transformation_tests_ExampleSchema_Impl;
import org.finos.legend.pure.generated.Root_meta_external_format_shared_transformation_tests_ModelToExampleSchemaConfiguration_Impl;
...
public class ExampleExternalFormatExtension implements ExternalFormatSchemaGenerationExtension<Root_meta_external_format_shared_transformation_tests_ExampleSchema, ModelToExampleSchemaConfiguration>, ExternalFormatModelGenerationExtension<Root_meta_external_format_shared_transformation_tests_ExampleSchema, ExampleSchemaToModelConfiguration>
{
    ...
    @Override
    public Root_meta_external_format_shared_transformation_tests_ExampleSchema compileSchema(ExternalSchemaCompileContext context)
    {
        return new Root_meta_external_format_shared_transformation_tests_ExampleSchema_Impl("", null, context.getPureModel().getClass("meta::external::format::shared::transformation::tests::ExampleSchema"));
    }

    @Override
    public String metamodelToText(Root_meta_external_format_shared_transformation_tests_ExampleSchema schemaDetail, PureModel pureModel)
    {
        return "";
    }

    @Override
    public Root_meta_external_format_shared_transformation_fromPure_ModelToSchemaConfiguration compileModelToSchemaConfiguration(ModelToExampleSchemaConfiguration configuration, PureModel pureModel)
    {
        return new Root_meta_external_format_shared_transformation_tests_ModelToExampleSchemaConfiguration_Impl("", null, pureModel.getClass("meta::external::format::shared::transformation::tests::ModelToExampleSchemaConfiguration"));
    }

    @Override
    public Root_meta_external_format_shared_transformation_toPure_SchemaToModelConfiguration compileSchemaToModelConfiguration(ExampleSchemaToModelConfiguration configuration, PureModel pureModel)
    {
        return new Root_meta_external_format_shared_transformation_tests_ExampleSchemaToModelConfiguration_Impl("", null, pureModel.getClass("meta::external::format::shared::transformation::tests::ExampleSchemaToModelConfiguration"));
    }
}
