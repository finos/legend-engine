...
public class TestExecuteFunctionExecutionPlan
{
    private Result getResultFromFunctionGrammar(String functionGrammar, Map<String, ?> params, String funcName)
    {
        ...
        PureModel pureModelForFunction = Compiler.compile(pmcd, DeploymentMode.TEST_IGNORE_FUNCTION_MATCH, IdentityFactoryProvider.getInstance().getAnonymousIdentity());
