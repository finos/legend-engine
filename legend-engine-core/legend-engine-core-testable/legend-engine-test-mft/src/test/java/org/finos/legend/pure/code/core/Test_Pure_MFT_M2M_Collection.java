...
public class Test_Pure_MFT_M2M_Collection
{
    public static MFTTestCollection buildCollection(CompiledExecutionSupport support)
    {
        return buildMFTTestCollection("meta::pure::mapping::modelToModel::test::mft",  "modelToModel",   support.getProcessorSupport());
    }
