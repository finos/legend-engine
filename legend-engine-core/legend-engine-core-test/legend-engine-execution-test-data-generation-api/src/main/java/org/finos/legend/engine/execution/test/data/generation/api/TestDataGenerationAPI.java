...
public class TestDataGenerationAPI
{
    ...
    public Response seed_data_generate(@Context HttpServletRequest request, SeedDataGenerationInput seedDataGenerationInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
