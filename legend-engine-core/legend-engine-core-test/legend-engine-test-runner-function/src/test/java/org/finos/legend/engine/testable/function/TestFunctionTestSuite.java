...
public class TestFunctionTestSuite
{
    ...
    {
        List<TestResult> inlineServiceStoreTestResults = executeFunctionTest("legend-testable-relational-function-test-model-relational.pure", "model::PersonQuery__TabularDataSet_1_");
    ...
    {
        List<TestResult> inlineServiceStoreTestResults = executeFunctionTest("legend-testable-relational-function-test-model-m2m.pure", "model::PersonQuery__String_1_");
        Assert.assertEquals(1, inlineServiceStoreTestResults.size());
        Assert.assertTrue(inlineServiceStoreTestResults.get(0) instanceof TestExecuted);
        TestExecuted testExecuted = (TestExecuted) inlineServiceStoreTestResults.get(0);
        Assert.assertEquals(TestExecutionStatus.PASS, testExecuted.testExecutionStatus);
    ...
    {
        List<TestResult> testResults = executeFunctionTest("legend-testable-relational-function-test-model-relational.pure", "model::PersonWithParams_String_1__TabularDataSet_1_");
