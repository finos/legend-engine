...
public class MappingModelCoverageAnalysisLightGraphBuilder
{
    public static PureModelContextData buildLightGraph(Root_meta_analytics_mapping_modelCoverage_MappingModelCoverageAnalysisResult analysisResult, PureModel pureModel, PureModelContextData pureModelContextData, String clientVersion)
    {
        ...
        return builder.build().combine(classes).combine(enums).combine(_profiles).combine(associations);
    }
}
