...
public class Test_Analytics_Lineage_Relational_MFT extends LineageRelationalMFTReport
{
    ...
    public static Test suite()
    {
        ...
        TestSuite suite = MFTTestSuitBuilder.buildMFTTestSuiteWithExecutorFunctionFromList(testCollection(support), exclusions, evaluatorFunction(),  "meta::relational::mft::relationalMockAdaptor__MFTAdapter_1_",support);
