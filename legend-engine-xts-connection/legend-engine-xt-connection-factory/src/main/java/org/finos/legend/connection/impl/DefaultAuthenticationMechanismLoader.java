...
import org.finos.legend.connection.AuthenticationMechanismLoader;
...
{
    public List<AuthenticationMechanism> load()
    {
        return Lists.mutable.of(AuthenticationMechanismType.values());
    }
}
