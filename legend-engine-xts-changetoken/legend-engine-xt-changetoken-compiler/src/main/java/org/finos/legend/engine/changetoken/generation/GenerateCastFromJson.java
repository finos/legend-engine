...
public class GenerateCastFromJson extends GenerateCastFromVersions
{
    private final String jsonString;

    public GenerateCastFromJson(String outputDirectory, String jsonString, String outputClassName)
    {
        super(outputDirectory, null, outputClassName);
    ...
    {
        return super.doExecute(core_pure_changetoken_cast_generation.Root_meta_pure_changetoken_cast_generation_jsonToVersions_String_1__String_1__Versions_1_(jsonString, this.getTypeKeyName(), executionSupport), executionSupport);
    }
}
