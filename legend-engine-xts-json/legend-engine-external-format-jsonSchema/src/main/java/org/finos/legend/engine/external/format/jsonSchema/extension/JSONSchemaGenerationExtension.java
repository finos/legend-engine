...
public class JSONSchemaGenerationExtension implements GenerationExtension
{
    ...
    public GenerationConfigurationDescription getGenerationDescription()
    {
        return new GenerationConfigurationDescription()
        {
            ...
            {
                return FileGenerationDescription.extractGenerationProperties(core_external_format_json_transformation_toBeRefactored_jsonSchema
                        .Root_meta_external_format_json_schema_generation_describeConfiguration__GenerationParameter_MANY_(pureModel.getExecutionSupport()));
            }
        };
    }
