...
{
    void setTypeWriter(boolean includeType, String typeKeyName, boolean fullyQualifiedTypePath);

    void setIncludeEnumType(boolean includeEnumType);

    void setDateTimeFormat(String dateTimeFormat);

    void setRemovePropertiesWithEmptySets(boolean removePropertiesWithEmptySets);

    void setRemovePropertiesWithNullValues(boolean removePropertiesWithNullValues);
