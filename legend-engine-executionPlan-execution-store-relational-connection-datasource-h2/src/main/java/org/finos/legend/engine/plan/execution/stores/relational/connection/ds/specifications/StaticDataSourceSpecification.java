...
{
    public StaticDataSourceSpecification(StaticDataSourceSpecificationKey key, AuthenticationStrategy authenticationStrategy, RelationalExecutorInfo info)
    {
        this(key, authenticationStrategy, new Properties(), info);
    }

    public StaticDataSourceSpecification(StaticDataSourceSpecificationKey key, AuthenticationStrategy authenticationStrategy, Properties extraUserDataSourceProperties, RelationalExecutorInfo info)
    {
        super(key, authenticationStrategy, extraUserDataSourceProperties, info);
