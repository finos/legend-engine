...
public class GenerateMetaClasses extends GenerateJavaProject
{
    ...
    {
        return core_pure_protocol_generation.Root_meta_protocols_generation_java_generateProtocolClasses_String_1__String_1__Project_1_(fromPurePackage, toJavaPackage, executionSupport);
    }
}
