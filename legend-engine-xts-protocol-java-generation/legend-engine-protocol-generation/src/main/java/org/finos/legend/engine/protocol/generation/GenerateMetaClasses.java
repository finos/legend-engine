...
public class GenerateMetaClasses extends GenerateJavaProject
{
    ...
    {
        return Root_meta_protocols_generation_java_generateProtocolProject_String_1__String_MANY__Project_1_(argument.configJson, argument.dependencies, executionSupport);
    }
}
