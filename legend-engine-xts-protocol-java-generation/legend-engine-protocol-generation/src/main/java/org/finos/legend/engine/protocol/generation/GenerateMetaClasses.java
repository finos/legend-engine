...
public class GenerateMetaClasses extends GenerateJavaProject
{
    ...
    {
        return core_protocol_generation_generation.Root_meta_protocols_generation_java_generateProtocolClasses_String_1__String_MANY__Project_1_(argument.configJson, argument.dependencies, executionSupport);
    }
}
