...
import static org.finos.legend.pure.generated.core_protocol_generation_javaGeneration_transformation_transform_ProtocolToMetamodel.Root_meta_protocols_generation_java_translation_generateProtocolToMetamodelTranslation_String_1__String_MANY__Project_1_;

public class GenerateProtocolToMetamodelTranslator extends GenerateJavaProject
{
    public static void main(String[] args) throws Exception
    {
        new GenerateProtocolToMetamodelTranslator(GenerationArgument.fromArgs(args)).execute();
    }

    private final GenerationArgument argument;

    protected GenerateProtocolToMetamodelTranslator(GenerationArgument argument)
    {
