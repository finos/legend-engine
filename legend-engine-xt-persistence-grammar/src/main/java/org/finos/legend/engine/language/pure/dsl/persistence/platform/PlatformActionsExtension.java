...
public interface PlatformActionsExtension
{
    Class<? extends Root_meta_pure_persistence_metamodel_context_PersistencePlatform> platformType();

    void validate(Root_meta_pure_persistence_metamodel_PersistenceContext context, PureModel model);

    void install(Root_meta_pure_persistence_metamodel_PersistenceContext context, PureModel model);
}
