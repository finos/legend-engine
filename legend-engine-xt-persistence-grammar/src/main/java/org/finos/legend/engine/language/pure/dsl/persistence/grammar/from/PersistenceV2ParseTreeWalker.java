...
public class PersistenceV2ParseTreeWalker
{
    private final ParseTreeWalkerSourceInformation walkerSourceInformation;

    public PersistenceV2ParseTreeWalker(ParseTreeWalkerSourceInformation walkerSourceInformation)
    {
    ...
    public ServiceOutputTarget visitServiceOutputTarget()
    {
        return null;
    }
}
