...
parser grammar ActiveRowsEquivalentToJsonAssertionParserGrammar;

import CoreParserGrammar;

options
{
    tokenVocab = ActiveRowsEquivalentToJsonAssertionLexerGrammar;
}


// -------------------------------------- IDENTIFIER -------------------------------------

identifier:                            VALID_STRING | STRING | ACTIVE_ROWS_EQUIVALENT_TO_JSON | EXPECTED
;
