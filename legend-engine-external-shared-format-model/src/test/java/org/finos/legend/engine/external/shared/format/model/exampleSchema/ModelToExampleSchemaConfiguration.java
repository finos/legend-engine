...
public class ModelToExampleSchemaConfiguration extends ModelToSchemaConfiguration
{
    public ModelToExampleSchemaConfiguration()
    {
        super(ExampleExternalFormatExtension.TYPE);
    }
}
