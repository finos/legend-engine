...
public class DatasetEntitlementAccessApprovedReport extends DatasetEntitlementReport
{
    public DatasetEntitlementAccessApprovedReport(DatasetSpecification dataset)
    {
        super(dataset);
    }

    public DatasetEntitlementAccessApprovedReport()
    {
