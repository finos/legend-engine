...
public class DatasetEntitlementReport
{
    private DatasetSpecification storeSpecification;
    private EntitlementStatus entitlementStatus;

    public DatasetEntitlementReport(DatasetSpecification storeSpecification, EntitlementStatus entitlementStatus)
    {
        this.storeSpecification = storeSpecification;
        this.entitlementStatus = entitlementStatus;
    }

    public DatasetSpecification getStoreSpecification()
    {
