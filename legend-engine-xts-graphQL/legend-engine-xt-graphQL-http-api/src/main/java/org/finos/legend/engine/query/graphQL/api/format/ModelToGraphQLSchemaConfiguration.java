...
public class ModelToGraphQLSchemaConfiguration extends ModelToSchemaConfiguration
{
    public ModelToGraphQLSchemaConfiguration()
    {
        super(GraphQLSDLFormatExtension.TYPE);
    }
