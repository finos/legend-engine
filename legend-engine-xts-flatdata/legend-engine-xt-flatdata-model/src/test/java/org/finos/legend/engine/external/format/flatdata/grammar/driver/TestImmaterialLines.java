...
public class TestImmaterialLines extends AbstractDriverTest
{
    ...
    public void canReadAndSkipImmaterialLines()
    {
        ...
        assertSource(1, 4, "John Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "John Doe")), records.get(0));
        Assert.assertEquals("John Doe", records.get(0).getValue().name);
        assertSource(2, 5, "Jane Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "Jane Doe")), records.get(1));
    ...
    public void canReadAndSkipHeaderAndTrailer()
    {
        ...
        records.forEach(this::assertNoDefects);
        assertSource(1, 5, "John Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "John Doe")), records.get(0));
        Assert.assertEquals("John Doe", records.get(0).getValue().name);
        assertSource(2, 6, "Jane Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "Jane Doe")), records.get(1));
        Assert.assertEquals("Jane Doe", records.get(1).getValue().name);
    }
