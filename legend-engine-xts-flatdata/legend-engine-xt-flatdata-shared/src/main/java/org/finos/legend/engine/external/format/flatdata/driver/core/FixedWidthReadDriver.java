...
import org.finos.legend.engine.external.format.flatdata.driver.core.data.AddressedFlatDataFactory;
...
public class FixedWidthReadDriver<T> extends StreamingReadDriver<T>
{
    ...
    FixedWidthReadDriver(FlatDataSection section, FlatDataProcessingContext context)
    {
        ...
        this.addresses = new String[section.recordType.fields.size()];
    ...
    public void start()
    {
        ...
        this.objectFactory = context.createToObjectFactory(new FieldHandlerRecordType(helper.section.recordType, fieldHandlers));
    }
