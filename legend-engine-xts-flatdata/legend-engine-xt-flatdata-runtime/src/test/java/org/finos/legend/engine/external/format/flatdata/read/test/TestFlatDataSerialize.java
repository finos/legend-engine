...
public class TestFlatDataSerialize
{
    ...
    {
        meta_external_format_shared_executionPlan_tests_model_firm_Person_Impl jason = new meta_external_format_shared_executionPlan_tests_model_firm_Person_Impl();
        ...
        meta_external_format_shared_executionPlan_tests_model_firm_Person_Impl nancy = new meta_external_format_shared_executionPlan_tests_model_firm_Person_Impl();
