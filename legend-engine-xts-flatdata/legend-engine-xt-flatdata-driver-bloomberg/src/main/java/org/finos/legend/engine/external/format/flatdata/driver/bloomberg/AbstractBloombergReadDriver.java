...
import org.finos.legend.engine.external.format.flatdata.driver.core.StreamingDriverHelper;
import org.finos.legend.engine.external.format.flatdata.driver.core.StreamingReadDriver;
...
import org.finos.legend.engine.external.format.flatdata.driver.core.util.SimpleLineReader;
...
abstract class AbstractBloombergReadDriver<T> extends StreamingReadDriver<T>
{
    ...
    AbstractBloombergReadDriver(FlatDataSection section, FlatDataProcessingContext context, String programName)
    {
        ...
        this.mandatory = FlatDataUtils.getBoolean(section.sectionProperties, MANDATORY_SECTION_PROPERTY);

        List<FlatDataProperty> properties = section.sectionProperties;
    ...
    {
        ArrayList<FlatDataProperty> newProperties = new ArrayList<>(section.sectionProperties);
        ...
        section.sectionProperties = newProperties;
        return section;
    }
