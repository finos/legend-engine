...
public class BloombergActionsReadDriver<T> extends AbstractBloombergReadDriver<T>
{
    ...
    BloombergActionsReadDriver(FlatDataSection section, FlatDataProcessingContext context)
    {
        ...
        this.includeNoActionRecords = FlatDataUtils.getBoolean(section.sectionProperties, INCLUDE_NO_ACTION_RECORDS);
    ...
    public void start()
    {
        ...
        ParsedFlatDataToObject<? extends T> objectFactory = context.createToObjectFactory(new FieldHandlerRecordType(section.recordType, fieldHandlers));
        this.dataFactories = new ExtendedDataFactories<>(context.getDefiningPath(), objectFactory, fieldHandlers);

        actionsRecordType.set(section.recordType);
