...
public class ServiceStorePureCoreExtension implements PureCoreExtension
{
    @Override
    public RichIterable<? extends Root_meta_pure_extension_Extension> extraPureCoreExtensions(ExecutionSupport es)
    {
        try
        {
            Class<?> cl = Class.forName("org.finos.legend.pure.generated.core_servicestore_extensions_extension");
            Method m = cl.getMethod("Root_meta_external_store_service_extension_serviceStoreExtension__Extension_1_", ExecutionSupport.class);
