...
package org.finos.legend.engine.plan.execution.stores.service.deprecatedGrammar.features.batching;
...
public class TestServiceStoreBatching extends ServiceStoreTestSuite
{
    ...
    {
        setupServer("deprecatedGrammar/features/batching");
        ...
        String serviceStoreConnection =
                "###Connection\n" +
                        ...
                        "}";
        pureGrammar = ServiceStoreTestUtils.readGrammarFromPureFile("/deprecatedGrammar/features/batching/testGrammar.pure") + "\n\n" + serviceStoreConnection;
    }
    ...
    public void serviceStoreBatchingWithMultiplePropertiesInCrossRelationship()
    {
        String serviceStoreConnection =
                "###Connection\n" +
                        ...
                        "    baseUrl : 'http://127.0.0.1:" + getPort() + "';\n" +
                        "}";
        String pureGrammar = ServiceStoreTestUtils.readGrammarFromPureFile("/deprecatedGrammar/features/batching/testGrammar2.pure") + "\n\n" + serviceStoreConnection;
