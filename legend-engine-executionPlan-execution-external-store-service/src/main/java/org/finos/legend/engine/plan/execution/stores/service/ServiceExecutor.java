...
public class ServiceExecutor
{
    public static InputStreamResult executeHttpService(String url, List<ServiceParameter> params, HttpMethod httpMethod, String mimeType, List<SecurityScheme> securitySchemes, ExecutionState state, MutableList<CommonProfile> profiles)
    {
        ...
        InputStream response = executeRequest(httpMethod, uri, headers, mimeType, securitySchemes, profiles);
    ...
    public static InputStream executeRequest(HttpMethod httpMethod, URI uri, List<Header> headers, String mimeType, List<SecurityScheme> securitySchemes, MutableList<CommonProfile> profiles)
    {
        Span span = GlobalTracer.get().activeSpan();
