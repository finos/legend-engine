...
public interface DataSpaceAnalyticsExtension
{
    default void enrich(DataSpaceAnalysisResult result, Root_meta_pure_metamodel_dataSpace_DataSpace dataSpace, DataSpace dataSpaceProtocol, PureModel pureModel)
    {
    }
}
