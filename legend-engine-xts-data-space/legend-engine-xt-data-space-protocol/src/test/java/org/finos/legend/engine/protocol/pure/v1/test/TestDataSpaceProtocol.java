...
public class TestDataSpaceProtocol
{
    ...
    {
        PureModelContextData context = objectMapper.readValue(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("dataSpace_TestData.json")), PureModelContextData.class);
