...
public class BloombergFileDriverDescription extends StreamingDriverDescription implements FlatDataValidator
{
    @Override
    public String getId()
    {
    ...
    public FlatDataReadDriver newReadDriver(FlatDataSection section, FlatDataProcessingContext context)
    {
        ...
        return new BloombergFileReadDriver(section, context);
    }
