...
package org.finos.legend.engine.external.format.daml.generation.api;
...
import org.finos.legend.engine.external.format.daml.generation.DAMLGenerationConfig;
import org.finos.legend.engine.external.format.daml.generation.DAMLGenerationInput;
...
public class DAMLGenerationService
{
    ...
    private Response exec(DAMLGenerationConfig damlConfig, Function0<PureModel> pureModelFunc, boolean interactive, Identity identity)
    {
        try
        {
