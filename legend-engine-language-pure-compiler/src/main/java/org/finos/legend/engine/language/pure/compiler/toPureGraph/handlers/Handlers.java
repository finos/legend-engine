...
public class Handlers
{
    ...
    private void registerStrings()
    {
        ...
        register("meta::pure::functions::string::splitAt_String_1__String_1__Integer_1__String_1_", false, ps -> res("String", "one"));
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::pure::functions::string::splitAt_String_1__String_1__Integer_1__String_1_", (List<ValueSpecification> ps) -> ps.size() == 3 && isOne(ps.get(0)._multiplicity()) && ("Nil".equals(ps.get(0)._genericType()._rawType()._name()) || "String".equals(ps.get(0)._genericType()._rawType()._name())) && isOne(ps.get(1)._multiplicity()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "String".equals(ps.get(1)._genericType()._rawType()._name())) && isOne(ps.get(2)._multiplicity()) && ("Nil".equals(ps.get(2)._genericType()._rawType()._name()) || "Integer".equals(ps.get(2)._genericType()._rawType()._name())));
