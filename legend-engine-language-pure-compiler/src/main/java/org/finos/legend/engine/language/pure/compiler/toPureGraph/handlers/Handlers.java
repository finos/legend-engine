...
public class Handlers
{
    ...
    private static Collection toCollection(org.finos.legend.engine.protocol.pure.v1.model.valueSpecification.ValueSpecification vs)
    {
        ...
        c.values = Lists.mutable.with(vs);
        return c;
    }
    ...
    public Handlers(PureModel pureModel)
    {
        ...
        register(h("meta::pure::graphFetch::calculateSourceTree_RootGraphFetchTree_1__Mapping_1__RouterExtension_MANY__RootGraphFetchTree_1_", false, ps -> res("meta::pure::graphFetch::RootGraphFetchTree", "one"), ps -> true));
        ...
        ListIterate.flatCollect(context.extraFunctionExpressionBuilderRegistrationInfoCollectors, collector -> collector.valueOf(this)).forEach(this::register);
        ListIterate.flatCollect(context.extraFunctionHandlerRegistrationInfoCollectors, collector -> collector.valueOf(this)).forEach(this::register);
    }
    ...
    private void registerTDS()
    {
        ...
        register(m(m(h("meta::pure::mapping::from_TabularDataSet_1__Mapping_1__Runtime_1__TabularDataSet_1_", false, ps -> res("meta::pure::tds::TabularDataSet", "one"), ps -> ps.size() == 3 && "TabularDataSet".equals(ps.get(0)._genericType()._rawType()._name())),
    ...
    {
        register(h("meta::java::codeGeneration::functions::unit::unitType_Any_1__String_1_", false, ps -> res("String", "one"), ps -> typeOneMany(ps.get(0), "String")));
        register(h("meta::java::codeGeneration::functions::unit::unitValue_Any_1__Number_1_", false, ps -> res("Number", "one"), ps -> typeOneMany(ps.get(0), NUMBER)));
        ...
        register(h("meta::java::codeGeneration::functions::unit::convert_Any_1__Unit_1__Any_1_", false, ps -> res("meta::pure::metamodel::type::Any", "one"), ps -> typeOneMany(ps.get(0), "Any")));
    }
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::java::codeGeneration::functions::unit::convert_Any_1__Unit_1__Any_1_", (List<ValueSpecification> ps) -> ps.size() == 2 && isOne(ps.get(0)._multiplicity()) && isOne(ps.get(1)._multiplicity()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "Unit".equals(ps.get(1)._genericType()._rawType()._name())));
        map.put("meta::java::codeGeneration::functions::unit::unitType_Any_1__String_1_", (List<ValueSpecification> ps) -> ps.size() == 1 && isOne(ps.get(0)._multiplicity()));
        map.put("meta::java::codeGeneration::functions::unit::unitValue_Any_1__Number_1_", (List<ValueSpecification> ps) -> ps.size() == 1 && isOne(ps.get(0)._multiplicity()));
        ...
        map.put("meta::pure::graphFetch::calculateSourceTree_RootGraphFetchTree_1__Mapping_1__RouterExtension_MANY__RootGraphFetchTree_1_", (List<ValueSpecification> ps) -> ps.size() == 3 && isOne(ps.get(0)._multiplicity()) && Sets.immutable.with("Nil", "RootGraphFetchTree", "ExtendedRootGraphFetchTree", "RoutedRootGraphFetchTree", "SerializeTopRootGraphFetchTree").contains(ps.get(0)._genericType()._rawType()._name()) && isOne(ps.get(1)._multiplicity()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "Mapping".equals(ps.get(1)._genericType()._rawType()._name())) && ("Nil".equals(ps.get(2)._genericType()._rawType()._name()) || "RouterExtension".equals(ps.get(2)._genericType()._rawType()._name())));
        ...
        ListIterate.flatCollect(context.extraFunctionHandlerDispatchBuilderInfoCollectors, collector -> collector.valueOf(this)).forEach(info -> map.put(info.functionName, info.dispatch));
        return map;
    }
}
