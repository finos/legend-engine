...
import org.finos.legend.pure.generated.Root_meta_external_store_service_metamodel_data_EqualToPattern_Impl;

public class EqualToContentPatternCompiler implements ContentPatternCompiler
{
    @Override
    ...
    public Root_meta_external_store_service_metamodel_data_ContentPattern compile(ContentPattern contentPattern)
    {
        ...
        return new Root_meta_external_store_service_metamodel_data_EqualToPattern_Impl("")
                ._expectedValue(equalToPattern.expectedValue);
    }
}
