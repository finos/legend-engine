...
import org.finos.legend.engine.language.pure.grammar.from.data.contentPattern.EqualToJsonContentPatternGrammarParser;
...
public class EqualToJsonContentPatternGrammarComposer implements ContentPatternGrammarComposer
{
    @Override
    ...
    {
        String content = context.getIndentationString() + "expected:" + PureGrammarComposerUtility.convertString(((EqualToJsonPattern) contentPattern).expectedValue, false) + ";";
        return new ContentWithType(EqualToJsonContentPatternGrammarParser.TYPE, content);
    }
}
