...
public class H2StaticWithStaticUserPasswordFlow implements DatabaseAuthenticationFlow<StaticDatasourceSpecification, TestDatabaseAuthenticationStrategy>
{
    @Override
