...
public class TestIdentityFactoryForKerberosProfile
{
    ...
    {
        Subject subject = new Subject(false, Sets.mutable.with(new KerberosPrincipal("dummy@example.com")), Sets.mutable.empty(), Sets.mutable.empty());
        ...
        Subject subjectFromIdentity = KerberosUtils.getSubjectFromIdentity(identity);
    ...
    {
        Subject subject1 = new Subject(false, Sets.mutable.with(new KerberosPrincipal("dummy@example.com")), Sets.mutable.empty(), Sets.mutable.empty());
        subject1.getPrivateCredentials().add(new Object());
        KerberosProfile kerberosProfile1 = new KerberosProfile(subject1, null);
        Subject subject2 = new Subject();
        subject2.getPrivateCredentials().add(new Object());
