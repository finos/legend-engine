...
public class Core_External_PythonPandasAPI_ReversePCTReportProvider implements PCTReportProvider
{
    public static final AdapterReverse PandasAPIAdapter = new AdapterReverse(
            "PythonPandasAPI",
            "Reverse_PCT",
            "meta::external::python::reversePCT::pandasAPI::pythonPandasAPIReversePCTAdapter_Function_1__X_o_",
            "meta::external::python::reversePCT::pandasAPI::pythonPandasAPIReverses__ReverseInformation_1_"
    );
