...
public class PythonPandasAPIReversePCTHelper
{
    public static Test buildSuite(ReportScope reportScope, Adapter adapter, MutableList<ExclusionSpecification> expectedFailures)
    {
        return wrapSuite(
                () -> true,
