    ...
    public Result visit(ExecutionNode executionNode)
    {
        if (executionNode instanceof RelationalBlockExecutionNode)
        {
            ...
            if (relationalBlockExecutionNode.connection != null)
            {
                try
                {
                    connectionAwareState.inScopeDatabaseConnection = relationalBlockExecutionNode.connection;
                    connectionAwareState.inScopeConnection = getConnection(relationalBlockExecutionNode, profiles, connectionAwareState);
        ...
        else if (executionNode instanceof CreateAndPopulateTempTableExecutionNode)
        {
            ...
            if (executionState.inScopeConnection != null && createAndPopulateTempTableExecutionNode.childNodes().stream().anyMatch(UpdateSqlExecutionNode.class::isInstance))
            {
