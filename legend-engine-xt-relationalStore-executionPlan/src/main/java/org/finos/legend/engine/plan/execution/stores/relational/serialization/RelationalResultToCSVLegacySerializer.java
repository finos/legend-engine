 ...
 */
@Deprecated
public class RelationalResultToCSVLegacySerializer extends CsvSerializer
{
    private final RelationalResult relationalResult;
    private final CSVFormat csvFormat;

    public RelationalResultToCSVLegacySerializer(RelationalResult relationalResult)
    {
        this(relationalResult, false);
    }

    public RelationalResultToCSVLegacySerializer(RelationalResult relationalResult, boolean withHeader)
    {
    ...
    public RelationalResultToCSVLegacySerializer(RelationalResult relationalResult, CSVFormat csvFormat)
    {
        this.relationalResult = relationalResult;
