...
import org.finos.legend.engine.plan.execution.stores.relational.RequestIdGeneratorImplForTest;
...
public class TestPlanExecutionForIn extends AlloyTestServer
{
    ...
    public void testInExecutionWithStringListAndFilterPushDown()
    {
        ...
        String expectedResWithMultipleValues = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"addressName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(255)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".name as \\\"addressName\\\" from Address as \\\"root\\\" left outer join Street as \\\"street_0\\\" on (\\\"root\\\".name = \\\"street_0\\\".address_name and \\\"street_0\\\".address_name in ('Hoboken','NYC')) where (\\\"root\\\".name in ('Hoboken','NYC') and \\\"street_0\\\".name in ('Hoboken','NYC'))\"},\"sql\":\"Drop table if exists tempTableForIn_names_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"addressName\"], \"rows\" : [{\"values\": [\"Hoboken\"]}]}}";
        Assert.assertEquals(expectedResWithMultipleValues, executePlan(plan, paramWithMultipleValues, new RequestIdGeneratorImplForTest()));
    }
    ...
    public void testInExecutionWithStringList()
    {
        ...
        String expectedResWithEmptyList = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".fullName in (null)\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_names_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : []}}";
        String expectedResWithSingleValue = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".fullName in ('P1')\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_names_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]}]}}";
        String expectedResWithMultipleValues = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".fullName in ('P1','P2')\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_names_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]},{\"values\": [\"P2\"]}]}}";

        Assert.assertEquals(expectedResWithEmptyList, executePlan(plan, paramWithEmptyList, new RequestIdGeneratorImplForTest()));
        Assert.assertEquals(expectedResWithSingleValue, executePlan(plan, paramWithSingleValue, new RequestIdGeneratorImplForTest()));
        Assert.assertEquals(expectedResWithMultipleValues, executePlan(plan, paramWithMultipleValues, new RequestIdGeneratorImplForTest()));
    }
    ...
    public void testInExecutionWithIntegerList()
    {
        ...
        String expectedResWithEmptyList = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where char_length(\\\"root\\\".fullName) in (null)\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_nameLengths_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : []}}";
        String expectedResWithSingleValue = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where char_length(\\\"root\\\".fullName) in (2)\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_nameLengths_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]},{\"values\": [\"P2\"]},{\"values\": [\"P3\"]},{\"values\": [\"P4\"]},{\"values\": [\"P5\"]}]}}";
        String expectedResWithMultipleValues = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where char_length(\\\"root\\\".fullName) in (2,3)\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_nameLengths_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]},{\"values\": [\"P10\"]},{\"values\": [\"P2\"]},{\"values\": [\"P3\"]},{\"values\": [\"P4\"]},{\"values\": [\"P5\"]}]}}";
    ...
    public void testInExecutionWithDateTimeList()
    {
        ...
        String expectedResWithEmptyList = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".birthTime in (null)\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_birthTime_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : []}}";
        String expectedResWithSingleValue = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".birthTime in ('2020-12-12 20:00:00')\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_birthTime_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]}]}}";
        String expectedResWithMultipleValues = "{\"builder\": {\"_type\":\"tdsBuilder\",\"columns\":[{\"name\":\"fullName\",\"type\":\"String\",\"relationalType\":\"VARCHAR(100)\"}]}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".fullName as \\\"fullName\\\" from PERSON as \\\"root\\\" where \\\"root\\\".birthTime in ('2020-12-12 20:00:00','2020-12-13 20:00:00')\"},{\"_type\":\"relational\",\"sql\":\"Drop table if exists tempTableForIn_birthTime_requestIDForTest;\"}], \"result\" : {\"columns\" : [\"fullName\"], \"rows\" : [{\"values\": [\"P1\"]},{\"values\": [\"P2\"]}]}}";
    ...
    public void testTempTableFlowWithoutRelationalCommands()
    {
        try
        {
            ...
            Assert.assertEquals(expectedResult, executePlan(plan, new RequestIdGeneratorImplForTest()));
        }
        catch (IOException e)
        {
