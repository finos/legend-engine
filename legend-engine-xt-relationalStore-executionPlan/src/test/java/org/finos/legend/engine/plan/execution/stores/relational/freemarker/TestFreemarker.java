...
public class TestFreemarker
{
    ...
    {
        return String.join("\n", new String[] {collectionTemplate(), collectionSizeTemplate(), collectionTemplateWithTz(), enumMap_test_Map_CaseTypeMapping(), enumMap_test_Map_CountryMapping(), equalEnumOperationSelector()});
    }
//corresponds to function templates coming with plan
    ...
    {
        String testQuery = "View of string == '${id?replace(\"'\", \"''\")}'";
    ...
    {
        String testQuery = "View of collection in (${renderCollection(id \",\" \"'\" \"'\" {\"'\" : \"''\"} \"null\")})";
        Map<String, Result> vars = new HashMap<>();
