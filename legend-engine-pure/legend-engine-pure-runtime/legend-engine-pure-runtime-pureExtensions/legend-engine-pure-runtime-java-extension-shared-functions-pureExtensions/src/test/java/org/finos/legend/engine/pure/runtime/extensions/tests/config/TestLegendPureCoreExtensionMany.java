...
public class TestLegendPureCoreExtensionMany implements TestLegendPureCoreExtension
{
    @Override
    ...
    {
        return "meta::pure::extension::runtime::test::testExtensionMany__Extension_MANY_";
    }
}
