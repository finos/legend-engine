...
public class TestCompileAndExecuteJavaCompiled extends AbstractTestCompileAndExecuteJava
{
    ...
    {
        AbstractPureTestWithCoreCompiled.setUpRuntime(new FunctionExecutionCompiledBuilder().build(), AbstractTestCompileAndExecuteJava.getCodeStorage(), null, AbstractPureTestWithCoreCompiled.getOptions(), AbstractPureTestWithCoreCompiled.getExtra());
