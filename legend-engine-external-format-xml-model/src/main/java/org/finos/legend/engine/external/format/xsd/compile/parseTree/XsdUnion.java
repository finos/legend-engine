...
public class XsdUnion extends XsdAnnotated implements XsdSimpleTypeDerivation
{
    public List<QName> memberTypeNames = new ArrayList<>();
    public List<XsdSimpleType> memberTypes = new ArrayList<>();
    ...
    public void accept(XsdObjectVisitor visitor)
    {
        ...
        memberTypes.forEach(mt -> mt.accept(visitor));
