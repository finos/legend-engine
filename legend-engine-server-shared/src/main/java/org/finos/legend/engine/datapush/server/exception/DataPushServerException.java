...
package org.finos.legend.engine.datapush.server.exception;
...
public class DataPushServerException extends RuntimeException
{
    ...
    public DataPushServerException(String message, Response.Status httpStatus, Throwable cause)
    {
        super(message, cause);
        this.status = (httpStatus == null) ? DEFAULT_STATUS : httpStatus;
    }

    public DataPushServerException(String message, Response.Status httpStatus)
    {
        super(message);
        this.status = (httpStatus == null) ? DEFAULT_STATUS : httpStatus;
    }

    public DataPushServerException(String message, Throwable cause)
    {
        this(message, null, cause);
    }

    public DataPushServerException(String message)
    {
    ...
    public static <T> T validate(T arg, Predicate<? super T> predicate, String message, Response.Status httpStatus)
    {
        ...
        {
            throw new DataPushServerException(message, (httpStatus == null) ? Response.Status.BAD_REQUEST : httpStatus);
        }
        return arg;
    }
    ...
    public static <T> T validate(T arg, Predicate<? super T> predicate, Function<? super T, String> messageFn, Response.Status httpStatus)
    {
        if (!predicate.test(arg))
        {
            throw new DataPushServerException((messageFn == null) ? null : messageFn.apply(arg), (httpStatus == null) ? Response.Status.BAD_REQUEST : httpStatus);
        }
        return arg;
    }
}