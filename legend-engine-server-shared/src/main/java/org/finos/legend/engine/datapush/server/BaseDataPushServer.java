...
import org.finos.legend.engine.datapush.server.tools.StringTools;
...
public abstract class BaseDataPushServer<C extends DataPushServerConfiguration> extends Application<C>
{
    ...
    public void initialize(Bootstrap<C> bootstrap)
    {
        ...
        String hostName = tryGetValue(BaseDataPushServer::getLocalHostName);
        ...
        // TODO
        //bootstrap.addBundle(new LegendPac4jBundle<>(DataPushServerConfiguration::getPac4jConfiguration));
    ...
    {
        environment.jersey().register(new DataPushResource());
    }
    ...
    protected static <T> T tryGetValue(Callable<T> callable, T defaultValue)
    {
        ...
        {
            LoggerFactory.getLogger(BaseDataPushServer.class).warn("Error getting info property", e);
            return defaultValue;
        }
    }
    ...
    private static class DropwizardConfigurationSwaggerBundle extends SwaggerBundle<DataPushServerConfiguration>
    {
        @Override
        protected SwaggerBundleConfiguration getSwaggerBundleConfiguration(DataPushServerConfiguration configuration)
        {
