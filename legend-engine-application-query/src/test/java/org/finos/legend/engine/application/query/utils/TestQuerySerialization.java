...
public class TestQuerySerialization
{
    ...
    String INGEST_QUERY = "{\n" +
            ...
            "      \"ingestDefinitionPath\": \"my::ingestDefinition\",\n" +
            "      \"dataSet\": \"myDataSet\"\n" +
            "    }\n" +
            "  ,\n" +
            "  \"versionId\": \"0.0.0\"\n" +
    ...
    public void testIngestDeserialization() throws Exception
    {
        ...
        Assert.assertEquals("my::ingestDefinition", ctx.ingestDefinitionPath);
    ...
    public void testIngestSerialization() throws Exception
    {
        ...
        ctx.ingestDefinitionPath = "my::ingestDefinition";
        ctx.dataSet = "myDataSet";
        String json = objectMapper.writeValueAsString(ctx);
        Assert.assertTrue(json.contains("\"ingestDefinitionPath\":\"my::ingestDefinition\""));
