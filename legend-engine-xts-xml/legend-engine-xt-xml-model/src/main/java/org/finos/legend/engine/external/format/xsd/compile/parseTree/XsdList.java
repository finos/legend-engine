...
public class XsdList extends XsdAnnotated implements XsdSimpleTypeDerivation
{
    public QName itemTypeName;
    public XsdSimpleType itemType;
    ...
    public void accept(XsdObjectVisitor visitor)
    {
        ...
        Optional.ofNullable(itemType).ifPresent(t -> t.accept(visitor));
