...
public class TestExtensionAvailable
{
    ...
    public void testServiceAvailable()
    {
        ...
        Assert.assertEquals(1, extensions.selectInstancesOf(XMLJavaBindingLegendPureCoreExtension.class).get(0).extraPureCoreExtensions(PureModel.CORE_PURE_MODEL.getExecutionSupport()).size());
