...
public class TestExtensionAvailable
{
    ...
    public void testServiceAvailable()
    {
        ...
        Assert.assertEquals(1, extensions.selectInstancesOf(XMLLegendPureCoreExtension.class).get(0).extraPureCoreExtensions(PureModel.getCorePureModel().getExecutionSupport()).size());
        Assert.assertEquals("External Format - XSD", extensions.get(0).extraPureCoreExtensions(PureModel.getCorePureModel().getExecutionSupport()).getFirst()._type());
    }
}
