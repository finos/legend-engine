...
public class AddBooleanToObject<T> implements ValueProcessor<T>
{
    ...
    public AddBooleanToObject(ExternalDataAdder<T> dataAdder, BooleanSimpleTypeHandler handler)
    {
        this.dataAdder = (ExternalDataBooleanAdder<T>) dataAdder;
    ...
    {
        context.addValue(dataAdder, handler.parseBoolean(rawValue));
    }
}
