...
public class LineageAnalytics
{
    ...
    public Response functionTree(LineageAnalyticsInput lineageAnalyticsInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
        ...
        LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_FUNCTION_TREE_START).toString());
        try (Scope scope = GlobalTracer.get().buildSpan("Lineage: functionTree").startActive(true))
        {
            ...
            LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_FUNCTION_TREE_STOP, System.currentTimeMillis() - start).toString());
            return ManageConstantResult.manageResult(user, org.finos.legend.pure.generated.core_pure_protocol_protocol.Root_meta_alloy_metadataServer_alloyToJSON_Any_1__String_1_(propertyTree, pureModel.getExecutionSupport()));
        }
        catch (Exception ex)
        {
            return ExceptionTool.exceptionManager(ex, LoggingEventType.LINEAGE_FUNCTION_TREE_ERROR, user);
        }
    }
    ...
    public Response classLineage(LineageAnalyticsInput lineageAnalyticsInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
        ...
        long start = System.currentTimeMillis();
        LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_CLASS_LINEAGE_START).toString());
        ...
        try (Scope scope = GlobalTracer.get().buildSpan("Lineage: classLineage").startActive(true))
        {
            ...
            LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_CLASS_LINEAGE_STOP, System.currentTimeMillis() - start).toString());
            return ManageConstantResult.manageResult(user, org.finos.legend.pure.generated.core_pure_protocol_protocol.Root_meta_alloy_metadataServer_alloyToJSON_Any_1__String_1_(graph, pureModel.getExecutionSupport()));
        }
        catch (Exception ex)
        {
            return ExceptionTool.exceptionManager(ex, LoggingEventType.LINEAGE_CLASS_LINEAGE_ERROR, user);
        }
    }
    ...
    public Response databaseLineage(LineageAnalyticsInput lineageAnalyticsInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
        ...
        String user = SubjectTools.getPrincipal(ProfileManagerHelper.extractSubject(profiles));
        long start = System.currentTimeMillis();
        LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_DATABASE_LINEAGE_START).toString());
        ...
        try (Scope scope = GlobalTracer.get().buildSpan("Lineage: databaseLineage").startActive(true))
        {
            ...
            Root_meta_analytics_lineage_graph_Graph graph = core_analytics_lineage_graph.Root_meta_analytics_lineage_graph_toGraph_Flow_1__Graph_1_(flow, pureModel.getExecutionSupport());
            LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_DATABASE_LINEAGE_STOP, System.currentTimeMillis() - start).toString());
        ...
        {
            return ExceptionTool.exceptionManager(ex, LoggingEventType.LINEAGE_DATABASE_LINEAGE_ERROR, user);
        }
    }
    ...
    public Response reportLineage(LineageAnalyticsInput lineageAnalyticsInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
        ...
        String user = SubjectTools.getPrincipal(ProfileManagerHelper.extractSubject(profiles));
        long start = System.currentTimeMillis();
        LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_REPORT_LINEAGE_START).toString());
        ...
        try (Scope scope = GlobalTracer.get().buildSpan("Lineage: reportLineage").startActive(true))
        {
            ...
            LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_REPORT_LINEAGE_STOP, System.currentTimeMillis() - start).toString());
            return ManageConstantResult.manageResult(user, org.finos.legend.pure.generated.core_pure_protocol_protocol.Root_meta_alloy_metadataServer_alloyToJSON_Any_1__String_1_(reportLineage, pureModel.getExecutionSupport()));
        }
        catch (Exception ex)
        {
            return ExceptionTool.exceptionManager(ex, LoggingEventType.LINEAGE_REPORT_LINEAGE_ERROR, user);
        }
    }
    ...
    public Response relationTree(LineageAnalyticsInput lineageAnalyticsInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm)
    {
        ...
        String user = SubjectTools.getPrincipal(ProfileManagerHelper.extractSubject(profiles));
        long start = System.currentTimeMillis();
        LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_RELATION_TREE_START).toString());
        ...
        try (Scope scope = GlobalTracer.get().buildSpan("Lineage: relationTree").startActive(true))
        {
            ...
            LOGGER.info(new LogInfo(user, LoggingEventType.LINEAGE_RELATION_TREE_STOP, System.currentTimeMillis() - start).toString());
            return ManageConstantResult.manageResult(user, org.finos.legend.pure.generated.core_pure_protocol_protocol.Root_meta_alloy_metadataServer_alloyToJSON_Any_1__String_1_(relationTree, pureModel.getExecutionSupport()));
        }
        catch (Exception ex)
        {
            return ExceptionTool.exceptionManager(ex, LoggingEventType.LINEAGE_RELATION_TREE_ERROR, user);
        }
    }
}
