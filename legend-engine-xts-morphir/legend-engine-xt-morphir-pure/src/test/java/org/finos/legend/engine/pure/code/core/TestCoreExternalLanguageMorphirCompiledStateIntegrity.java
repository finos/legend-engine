...
@Ignore
public class TestCoreExternalLanguageMorphirCompiledStateIntegrity extends AbstractCompiledStateIntegrityTest
{
    @BeforeClass
    public static void initialize()
    {
        initialize("core_external_language_morphir");
    }
