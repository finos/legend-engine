...
public class MorphirGenerationExtension implements GenerationExtension
{
    ...
    public GenerationConfigurationDescription getGenerationDescription()
    {
        return new GenerationConfigurationDescription()
        {
            ...
            {
                return FileGenerationDescription.extractGenerationProperties(core_external_language_morphir_transformation_integration.Root_meta_external_language_morphir_generation_describeConfiguration__GenerationParameter_MANY_(pureModel.getExecutionSupport()));
            }
        };
    }
