...
@JsonTypeInfo(use = Id.NAME, property = "type", defaultImpl = DraftV7SchemaEmpty.class, include = As.EXISTING_PROPERTY, visible = true)
@JsonSubTypes({
        @Type(value = DraftV7SchemaObject.class, name = "object"),
        @Type(value = DraftV7SchemaInteger.class, name = "integer"),
        @Type(value = DraftV7SchemaNumber.class, name = "number"),
        @Type(value = DraftV7SchemaString.class, name = "string"),
        @Type(value = DraftV7SchemaBoolean.class, name = "boolean"),
        @Type(value = DraftV7SchemaArray.class, name = "array"),
        @Type(value = DraftV7SchemaNull.class, name = "null")
})
