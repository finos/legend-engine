...
public class DraftV7SchemaArray extends DraftV7Schema
{
    ...
    public final List<DraftV7Schema> prefixItems;
    ...
    public static class DraftV7SchemaArrayBuilder extends DraftV7SchemaBuilder<DraftV7SchemaArray.DraftV7SchemaArrayBuilder>
    {
        ...
        private List<DraftV7Schema> prefixItems;
        ...
        public DraftV7SchemaArrayBuilder prefixItems(List<DraftV7Schema> prefixItems)
        {
        ...
        public DraftV7SchemaArrayBuilder maxContains(Integer maxContains)
        {
            this.maxContains = maxContains;
            return this;
        }

        public DraftV7SchemaArrayBuilder minContains(Integer minContains)
        {
