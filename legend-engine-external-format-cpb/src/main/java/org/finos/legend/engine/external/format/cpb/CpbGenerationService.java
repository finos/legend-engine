...
import org.finos.legend.pure.generated.core_external_format_cpb_transformation_cpbGenerator;
...
public class CpbGenerationService
{
    ...
    private Response exec(CpbGenerationConfig cpbConfig, Function0<PureModel> pureModelFunc, boolean interactive, MutableList<CommonProfile> pm)
    {
        try
        {
            ...
            RichIterable<? extends Root_meta_pure_generation_metamodel_GenerationOutput> output = core_external_format_cpb_transformation_cpbGenerator.Root_meta_external_format_cpb_generation_generateCpbFromPureWithScope_CpbConfig_1__CpbOutput_MANY_(cpbConfig.process(pureModel), pureModel.getExecutionSupport());
