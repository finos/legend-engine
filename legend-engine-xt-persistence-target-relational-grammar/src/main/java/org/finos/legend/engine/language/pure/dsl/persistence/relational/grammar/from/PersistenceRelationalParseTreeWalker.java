...
public class PersistenceRelationalParseTreeWalker
{
    ...
    {
        PersistenceTarget persistenceTarget = new RelationalPersistenceTarget();
        persistenceTarget.sourceInformation = walkerSourceInformation.getSourceInformation(ctx);

        // table
        PureGrammarParserUtility.validateAndExtractRequiredField(ctx.table(), "table", persistenceTarget.sourceInformation);
