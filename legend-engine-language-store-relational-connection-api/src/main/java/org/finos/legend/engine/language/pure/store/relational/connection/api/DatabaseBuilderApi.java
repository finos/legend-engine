...
package org.finos.legend.engine.language.pure.store.relational.connection.api;


import io.swagger.annotations.Api;
import org.eclipse.collections.api.list.MutableList;
import org.finos.legend.engine.language.pure.modelManager.ModelManager;
import org.finos.legend.engine.language.pure.store.relational.connection.DatabaseBuilder;
...
@Api(tags = "Builder - Database")
@Path("pure/v1/builder")
@Produces(MediaType.APPLICATION_JSON)

public class DatabaseBuilderApi {

    private final ModelManager modelManager;
    private final ConnectionManagerSelector connectionManager;


    public DatabaseBuilderApi(ModelManager modelManager, RelationalStoreExecutor relationalStoreExecutor) {
    ...
    public Response buildDatabase(DatabaseBuilderInput databaseBuilderInput, @Pac4JProfileManager ProfileManager<CommonProfile> pm) {
        ...
        try {
            ...
            DatabaseBuilder databaseBuilder = DatabaseBuilder.newBuilder(databaseBuilderInput);
