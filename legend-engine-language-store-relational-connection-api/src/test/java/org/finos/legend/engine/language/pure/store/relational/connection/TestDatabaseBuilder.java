...
public class TestDatabaseBuilder {
    ...
    public void testFilterSchemasExact() throws Exception
    {
        ...
        databaseBuilderInput.targetDatabase.name = "db";
        databaseBuilderInput.config.enrichTables = true;
        databaseBuilderInput.config.patterns = FastList.newListWith(new StorePattern("SCHEMA_1", null, true, true));
    ...
    public void testFilterSchemas() throws Exception
    {
        ...
        databaseBuilderInput.targetDatabase.name = "db";
        databaseBuilderInput.config.enrichTables = true;
        databaseBuilderInput.config.patterns = FastList.newListWith(new StorePattern("SCHEMA_1", null));
    ...
    public void testFilterTablesExact() throws Exception
    {
        ...
        databaseBuilderInput.targetDatabase.name = "db";
        databaseBuilderInput.config.enrichTables = true;
        databaseBuilderInput.config.patterns = FastList.newListWith(new StorePattern(null, "TABLE_1", false, true));
    ...
    public void testFilterTables() throws Exception
    {
        ...
        databaseBuilderInput.targetDatabase.name = "db";
        databaseBuilderInput.config.enrichTables = true;
        databaseBuilderInput.config.patterns = FastList.newListWith(new StorePattern(null, "TABLE_1", false, false));
    ...
    public void testFilterTablesAndSchemasExact() throws Exception
    {
        ...
        databaseBuilderInput.targetDatabase.name = "db";
        databaseBuilderInput.config.enrichTables = true;
        databaseBuilderInput.config.patterns = FastList.newListWith(new StorePattern("SCHEMA_1", "TABLE_1", true, true));
    ...
    {
        DatabaseBuilder builder = DatabaseBuilder.newBuilder(input);
