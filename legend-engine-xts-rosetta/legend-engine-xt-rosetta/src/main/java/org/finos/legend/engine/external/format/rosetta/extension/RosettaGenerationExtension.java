...
public class RosettaGenerationExtension implements GenerationExtension
{
    ...
    public GenerationConfigurationDescription getGenerationDescription()
    {
        return new GenerationConfigurationDescription()
        {
            ...
            {
                return FileGenerationDescription.extractGenerationProperties(core_external_format_rosetta_transformation_integration.Root_meta_external_format_rosetta_generation_describeConfiguration__GenerationParameter_MANY_(pureModel.getExecutionSupport()));
            }
        };
    }
    ...
    {
        return core_external_format_rosetta_transformation_integration.Root_meta_external_format_rosetta_generation_defaultConfig__RosettaConfig_1_(context.pureModel.getExecutionSupport());
    }
}
