...
public class GCPWorkloadIdentityFederationAuthenticationStrategy extends AuthenticationStrategy {
    ...
    public GCPWorkloadIdentityFederationAuthenticationStrategy(String workloadProjectNumber, String serviceAccountEmail, String gcpScope, String workloadPoolId, String workloadProviderId, String discoveryUrl, String clientId) {
    ...
    {
        return new GCPWorkloadIdentityFederationAuthenticationStrategyKey(this.workloadProjectNumber, this.serviceAccountEmail, this.gcpScope, this.workloadPoolId, this.workloadProviderId, this.discoveryUrl, this.clientId);
    }
}
