...
public class TestDataSpaceAnalyticsApi
{
    ...
    public void testDataSpaceAnalysisWithNotFoundDataSpace() throws IOException
    {
        ...
        {
            Response response = api.analyzeDataSpace(new DataSpaceAnalysisInput("vX_X_X", "model::UnknownDataSpace", PureModelContextData.newPureModelContextData(null, null, Lists.immutable.empty())), null);
        });
