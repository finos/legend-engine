...
import org.finos.legend.engine.pg.postgres.PostgresWireProtocol;
import org.finos.legend.engine.pg.postgres.TransactionState;
...
public class Session implements AutoCloseable {
    ...
    private Map<String, Prepared> parsed = new HashMap<>();
...
/*        if (oldPortal != null) {
            ...
            case 'S':
                ...
                try {
                    ...
                    if (portalOrStatement == null) {
                        ...
                        return new DescribeResult(preparedStatement.getMetaData(), preparedStatement.getParameterMetaData());
                    }
                } catch (SQLException e) {
                    throw new RuntimeException(e);
                }
        ...
        switch (type) {
            case 'P': {
                ...
                if(parsed.containsKey(portal.prep.name)){
                    ...
                    LOGGER.warn("Skipping close of statement {}, from portal, as already closed", portal.prep.name);
                }
    ...
    static class Portal {
        ...
        public Portal(String portalName, Prepared preparedStmt, FormatCodes.FormatCode[] resultColumnFormat) {
