...
@JsonTypeInfo(use = Id.NAME, property = "type", defaultImpl = OpenAPIv3_0_3SchemaFragment.class, include = As.EXISTING_PROPERTY, visible = true)
@JsonSubTypes({
...
public class OpenAPIv3_0_3Schema
{
    ...
    public final OpenAPIv3_0_3Components components;
    @JsonProperty("$schema")
    ...
    public static class OpenAPIv3_0_3SchemaBuilder<B extends OpenAPIv3_0_3Schema.OpenAPIv3_0_3SchemaBuilder<B>>
    {
        ...
        private OpenAPIv3_0_3Components components;
        ...
        public B components(OpenAPIv3_0_3Components components)
        {
