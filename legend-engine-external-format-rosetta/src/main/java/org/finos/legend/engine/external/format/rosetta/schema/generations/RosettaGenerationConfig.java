...
public class RosettaGenerationConfig extends GenerationConfiguration
{
    ...
    {
        Root_meta_external_format_rosetta_generation_RosettaConfig generationCdmConfig = core_external_format_rosetta_integration.Root_meta_external_format_rosetta_generation_defaultConfig__RosettaConfig_1_(pureModel.getExecutionSupport());
