...
//            }
    ...
    private ListIterable<ValueSpecification> visitNavigationPath(DomainParserGrammar.DslNavigationPathContext ctx)
    {
        ...
        ParseTreeWalkerSourceInformation graphFetchWalkerSourceInformation = new ParseTreeWalkerSourceInformation.Builder(this.walkerSourceInformation.getSourceId(), lineOffset, columnOffset, walkerSourceInformation.getElementPath()).withReturnSourceInfo(this.walkerSourceInformation.getReturnSourceInfo()).build();
