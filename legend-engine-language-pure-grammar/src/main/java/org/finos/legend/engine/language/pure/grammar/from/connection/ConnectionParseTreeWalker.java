...
public class ConnectionParseTreeWalker
{
    ...
    private Connection visitConnectionValue(ConnectionParserGrammar.ConnectionValueContext ctx, String connectionType, SourceInformation sourceInformation, boolean isProcessingEmbeddedConnection)
    {
        ...
        ParseTreeWalkerSourceInformation connectionValueWalkerSourceInformation = new ParseTreeWalkerSourceInformation.Builder(walkerSourceInformation.getSourceId(), lineOffset, columnOffset, walkerSourceInformation.getElementPath()).withReturnSourceInfo(this.walkerSourceInformation.getReturnSourceInfo()).build();
