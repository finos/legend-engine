...
public class PureCollectionDataGrammarComposer implements ValueSpecificationVisitor<String>
{
    ...
    public PureCollectionDataGrammarComposer(PureGrammarComposerContext context)
    {
        this.context = context;
        this.collectionStyle.push(BRACKETS);
    }

    public String compose(PureCollectionData data)
    {
        StringBuilder builder = new StringBuilder();
        builder.append("data: ");
        builder.append(data.data.accept(this));
        builder.append(";");
    ...
    {
        throw new UnsupportedOperationException("Not implemented for PureCollectionData");
    }
