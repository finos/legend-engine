...
public class TestCoreExternalLanguageHaskellCompiledStateIntegrity extends AbstractCompiledStateIntegrityTest
{
    @BeforeClass
    public static void initialize()
    {
        initialize("core_external_language_haskell");
    }
