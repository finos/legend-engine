        ...
        return Lists.mutable.with(() -> Lists.mutable.with(
                ...
                ProtocolSubTypeInfo.Builder
                        ...
                        .withSubtypes(FastList.newListWith(
                                ...
                                Tuples.pair(FinCloudConnection.class, "AwsFinCloudConnection")
                        )).build(),
                // Execution context
                ProtocolSubTypeInfo.Builder
                ...
                ProtocolSubTypeInfo.Builder
                        ...
                        .withSubtypes(FastList.newListWith(
                                ...
                                Tuples.pair(AwsOAuthAuthenticationStrategy.class, "awsOAuth"),
                                Tuples.pair(AwsPKAuthenticationStrategy.class, "awsPK"),
