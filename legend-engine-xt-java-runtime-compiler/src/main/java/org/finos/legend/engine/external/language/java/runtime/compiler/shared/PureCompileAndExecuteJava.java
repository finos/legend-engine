...
public class PureCompileAndExecuteJava
{
    ...
    {
        CompilationResult javaCompResult = CompileAndExecuteJava.compile(Iterate.collect(javaSources, PureCompileAndExecuteJava::toJavaFileObject), toCompileOptions(config));
    ...
    {
        CompilationResult javaCompResult = CompileAndExecuteJava.compile(Iterate.collect(javaSources, PureCompileAndExecuteJava::toJavaFileObject), toCompileOptions(compConfig));
