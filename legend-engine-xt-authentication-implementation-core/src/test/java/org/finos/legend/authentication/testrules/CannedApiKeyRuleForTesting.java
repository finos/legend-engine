...
public class CannedApiKeyRuleForTesting extends IntermediationRule<ApiTokenAuthenticationSpecification, AnonymousCredential, ApiTokenCredential>
{
    ...
    @Override
    public ApiTokenCredential makeCredential(ApiTokenAuthenticationSpecification spec, AnonymousCredential credential, Identity identity) throws Exception
    {
