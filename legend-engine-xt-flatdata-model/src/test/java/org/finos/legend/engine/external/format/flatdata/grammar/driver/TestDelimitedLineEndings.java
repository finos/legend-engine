...
public class TestDelimitedLineEndings extends AbstractDriverTest
{
    ...
    private void runTest(FlatData flatData, String data)
    {
        ...
        assertSource(1, 2, "John Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "John Doe")), records.get(0));
        Assert.assertEquals("John Doe", records.get(0).getValue().name);
        assertSource(2, 3, "Jane Doe", Arrays.asList(AbstractDriverTest.rValue("NAME", "Jane Doe")), records.get(1));
