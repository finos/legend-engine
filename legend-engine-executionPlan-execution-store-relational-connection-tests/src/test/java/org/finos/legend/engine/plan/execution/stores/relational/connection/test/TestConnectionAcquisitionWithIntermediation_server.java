...
public class TestConnectionAcquisitionWithIntermediation_server extends org.finos.legend.engine.plan.execution.stores.relational.connection.test.DbSpecificTests
{
    ...
    public void setup()
    {
        ...
        assertTrue("Test is not using intermediation. flow provider is not available", flowProviderPresent);
