...
Files identified during the Task 12 survey as likely to need
expected-SQL updates once CI surfaces failures, or as latent bypasses
worth tracking. All Pure tests below call `toSQLString(...,
DatabaseType.H2, ...)` (or assert a generated H2 plan) and then compare
the result against a hard-coded SQL string — bare table refs like
`personTable` will become `"personTable"` and need an expectation
update. The list is a starting point for triage, not a guaranteed
exhaustive set.

### Pure tests in core-pure (`legend-engine-xt-relationalStore-core-pure`)

- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/transform/fromPure/tests/testToSQLString.pure`: ~45 `DatabaseType.H2` callsites pinning H2 `toSQLString` output (heaviest single fixture in the survey).
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/executionPlan/tests/executionPlanTest.pure`: H2 plan-string fixtures (`planToString` + `DatabaseType.H2`), large block of expected `Sequence`/`SQL` plan nodes.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/executionPlan/tests/m2m2rExecutionPlanTests.pure`: H2 plan-string fixtures alongside M2M-to-relational planning.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/testDataGeneration/tests/testDataGeneration.pure`: ~20 H2 `toSQLString` / `assertEqualsH2Compatible` fixtures for test-data generation SQL.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/testDataGeneration/testDataGeneration.pure`: companion file — three more H2 SQL assertions.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/pureToSQLQuery/tests/testPureToSql.pure`: H2 SQL string assertions on Pure-to-SQL translation.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/postprocessor/tests/testPostProcessor.pure`: H2 SQL strings for post-processor regression cases.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/postprocessor/cteExtractionPostProcessor.pure`: H2 SQL fixtures around the CTE extraction post-processor.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/milestoning/tests/testBusinessDateMilestoning.pure`: `assertEqualsH2Compatible` fixtures for business-date milestoning.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/graphFetch/tests/testCrossStoreGraphFetch.pure`: H2 SQL strings for cross-store graph-fetch plans.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/graphFetch/tests/testCrossStoreGraphFetchMilestoning.pure`: same, with milestoning variants.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/graphFetch/tests/testSimpleRelationalGraphFetch.pure`: H2 SQL strings for graph-fetch plans.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/graphFetch/tests/testGraphFetchMilestoning.pure`: H2 SQL strings for milestoned graph-fetch plans.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/graphFetch/domain/domainManagementTests.pure`: domain-tests with embedded H2 SQL expectations.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tests/testRelationalExtension.pure`: H2 SQL assertions for relational-extension fixtures.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tests/mapping/sqlFunction/testSqlFunctionsInMapping.pure`: H2 SQL assertions for SQL-function-in-mapping cases.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tests/mapping/tree/tree.pure`: H2 SQL string assertions on tree-mapping plans.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tests/query/datePeriods.pure`: ~8 H2 SQL string assertions for date-period filters.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tds/tests/testTDSJoin.pure`: H2 SQL string assertions for TDS join.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tds/tests/testSort.pure`: H2 SQL string assertion for TDS sort.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tds/tests/testTDSRestrictDistinct.pure`: H2 SQL strings for TDS restrict/distinct.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/tds/tests/testTDSExtend.pure`: `sqlResultH2` compared against an expected string.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/functions/tests/testPaginated.pure`: H2 SQL pagination expectations.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/functions/tests/testSliceTakeLimitDrop.pure`: H2 SQL for slice/take/limit/drop.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/functions/tests/projection/testIn.pure`: H2 SQL for `in` projection.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/functions/tests/projection/testDateFilters.pure`: H2 SQL for date-filter projections.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/modelJoins/testModelJoinsToRelationalJoins.pure`: H2 SQL for model-joins-to-relational-joins.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/modelToModelToRelational/m2m2rShowcase.pure`: H2 SQL for M2M2R showcase.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/sqlQueryToString/DDL/testDDL.pure`: already updated in Task 11 — listed here for completeness; double-check no remaining bare table refs.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/helperFunctions/tests/testDdlGeneration.pure`: `createTempTableStatement` / `createTableStatement` / `dropTableStatement` assertions; unquoted `bar_t`/`baz_t`/`tt` will become quoted under always-quote.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/sqlQueryToString/extensionDefaults.pure`: builds a `DbConfig` with `dbType=DatabaseType.H2`; review whether its `assertEquals` paths depend on quoting behaviour.

### Java tests in `xts-relationalStore` execution plan suite

- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/execution/TestRelationalExecutor.java`: hard-coded `"sql":"select ... from ProductSynonymTable ..."` JSON in `Assert.assertEquals` calls.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/execution/TestExecutionPlan.java`: many embedded `sqlQuery` expectations.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/execution/TestStreamInput.java`: hard-coded `sqlQuery` strings in assertions.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/execution/TestPlanExecutionWithAuthenticationFlow.java`: hard-coded `sqlQuery` strings in assertions.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/full/functions/in/TestPlanExecutionForIn.java`: hard-coded `sqlQuery` strings (`in` operator).
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-execution/legend-engine-xt-relationalStore-executionPlan/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/full/tdsJoin/TestTDSJoinRealizedResults.java`: hard-coded `sqlQuery` strings around realised-result TDS joins.

### H2 PCT / dialect-translation module

- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-dbExtension/legend-engine-xt-relationalStore-h2/legend-engine-xt-relationalStore-h2-sqlDialectTranslation-pure/src/main/resources/core_external_store_relational_sql_dialect_translation_h2/h2SqlDialectTests.pure`: SQL-Dialect-Translation (separate codepath from `sqlQueryToString`); uses unquoted `db.schema.table_a` in expected output. Probably unaffected since it does not go through `processIdentifier`, but worth confirming under CI.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-dbExtension/legend-engine-xt-relationalStore-h2/legend-engine-xt-relationalStore-h2-PCT/src/test/java/org/finos/legend/engine/plan/execution/stores/relational/test/h2/pct/TestPCTReportH2.java`: H2 PCT report runner — check whether any expected-failure entries are diff-sensitive once quoting changes.

### Latent bypasses surfaced during Tasks 7-9 (out of scope for this plan)

- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/sqlQueryToString/dbSpecific/debugPrint/debugPrintExtension.pure:160`: `Create Table` emitter hand-concatenates `schema.name+'.'`. Inconsistent with rest of emitter chain. Out of scope (debugPrint is diagnostic-only).
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/sqlQueryToString/dbSpecific/debugPrint/debugPrintExtension.pure:180`: `insert into` emitter hand-concatenates `schema.name + '.'`. Same.
- [ ] `legend-engine-xts-relationalStore/legend-engine-xt-relationalStore-generation/legend-engine-xt-relationalStore-pure/legend-engine-xt-relationalStore-core-pure/src/main/resources/core_relational/relational/sqlQueryToString/dbSpecific/db2/db2Extension.pure:67`: `Drop table` emitter hand-concatenates `schema.name+'.'`. Real production code; would exhibit case-collision symptom if DB2 ever switched to always-quote.
