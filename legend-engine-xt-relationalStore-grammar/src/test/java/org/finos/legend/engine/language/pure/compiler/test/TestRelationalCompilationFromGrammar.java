...
public class TestRelationalCompilationFromGrammar extends TestCompilationFromGrammar.TestCompilationFromGrammarTestSuite
{
    ...
    {
        Pair<PureModelContextData, PureModel> testResult1 = test("Class model::Person {\n" +
                "   name:String[1];\n" +
                "}\n" +
                "###Relational\n" +
        ...
        Assert.assertTrue(testResult1.getTwo().getWarnings().stream().anyMatch(y -> y.message.equals("Types of class property: String and its mapped relational property: Integer are incompatible")));

        Pair<PureModelContextData, PureModel> testResult2 = test("Class model::Person {\n" +
                "   name:Boolean[1];\n" +
                "}\n" +
                "###Relational\n" +
                "Database model::store::db\n" +
        ...
        Assert.assertTrue(testResult2.getTwo().getWarnings().stream().anyMatch(y -> y.message.equals("Types of class property: Boolean and its mapped relational property: String are incompatible")));

        Pair<PureModelContextData, PureModel> testResult3 = test("Class model::Person {\n" +
                "   name:String[1];\n" +
                "}\n" +
                "###Relational\n" +
                "Database model::store::db\n" +
        ...
        Assert.assertFalse(testResult3.getTwo().getWarnings().stream().anyMatch(y -> y.message.startsWith("Types of class property: ") && y.message.endsWith(" are incompatible")));
