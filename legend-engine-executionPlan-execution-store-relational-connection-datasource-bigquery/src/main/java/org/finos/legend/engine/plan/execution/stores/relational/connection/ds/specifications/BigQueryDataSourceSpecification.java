...
public class BigQueryDataSourceSpecification extends DataSourceSpecification
{
    ...
    public BigQueryDataSourceSpecification(BigQueryDataSourceSpecificationKey key, AuthenticationStrategy authenticationStrategy, Properties extraUserProperties, RelationalExecutorInfo relationalExecutorInfo)
    {
        super(key, authenticationStrategy, extraUserProperties, relationalExecutorInfo);

        this.databaseManager = new BigQueryManager();
    ...
    public BigQueryDataSourceSpecification(BigQueryDataSourceSpecificationKey key, AuthenticationStrategy authenticationStrategy, RelationalExecutorInfo relationalExecutorInfo)
    {
        this(key, authenticationStrategy, new Properties(), relationalExecutorInfo);
    }
