...
public abstract class RelationalDatabaseCommands
{
    ...
    public abstract void streamResultToTempTable(String tempPath, Connection connectionManagerConnection, StreamingResult res, String tempTableName, String databaseTimeZone);
