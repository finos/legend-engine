...
public class TestEmbeddedDataGenerationObjectMapperFactory
{

    public static <T extends ObjectMapper> T withTestDataGenerationExtensions(T objectMapper)
    {
        return withTestDataGenerationExtensions(objectMapper, ObjectMapper::registerModule, ObjectMapper::registerSubtypes);
    }

    public static ObjectMapper getNewObjectMapper()
    {
        return withTestDataGenerationExtensions(new ObjectMapper());
    }

    private static <T> T withTestDataGenerationExtensions(T mapperOrBuilder, BiConsumer<? super T, ? super Module> addModule, BiConsumer<? super T, ? super NamedType> registerSubTypes)
    {
        TestEmbeddedDataGenerationServiceExtensionLoader.logExtensionList();
        // register sub types
        Map<ProtocolSubTypeInfo<?>, TestEmbeddedDataGenerationServiceExtension> subTypeInfoByExtension = Maps.mutable.empty();
        ...
        TestEmbeddedDataGenerationServiceExtensionLoader.extensions().forEach(extension ->
