...
package org.finos.legend.engine.plan.execution.stores.service.deprecatedGrammar.features.union;
...
public class TestServiceStoreUnion extends ServiceStoreTestSuite
{
    ...
    {
        setupServer("deprecatedGrammar/features/union");
        ...
        String serviceStoreConnection =
                "###Connection\n" +
                        ...
                        "    baseUrl : 'http://127.0.0.1:" + getPort() + "';\n" +
                        "}";
        pureGrammar = ServiceStoreTestUtils.readGrammarFromPureFile("/deprecatedGrammar/features/union/testGrammar.pure") + "\n\n" + serviceStoreConnection;
    }
