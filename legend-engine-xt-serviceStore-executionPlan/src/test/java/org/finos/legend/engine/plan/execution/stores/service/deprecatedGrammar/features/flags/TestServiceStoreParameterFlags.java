...
package org.finos.legend.engine.plan.execution.stores.service.deprecatedGrammar.features.flags;
...
public class TestServiceStoreParameterFlags extends ServiceStoreTestSuite
{
    ...
    {
        setupServer("deprecatedGrammar/features/flags");
        ...
        String serviceStoreConnection =
                "###Connection\n" +
                        ...
                        "}";
        pureGrammar = ServiceStoreTestUtils.readGrammarFromPureFile("/deprecatedGrammar/features/flags/testGrammar.pure") + "\n\n" + serviceStoreConnection;
    }
