...
public class DataProduct extends PackageableElement
{
    ...
    public List<DataProductExecutionContext> executionContexts;
    public String defaultExecutionContext;

    // For now, these can only include classes, enumerations, associations
    public List<DataProductElementPointer> elements;
    public List<DataProductExecutable> executables;
    public List<DataProductDiagram> diagrams;
