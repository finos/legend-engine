...
public class DataProductProtocolExtension implements PureProtocolExtension
{
    @Override
    ...
    public List<Function0<List<ProtocolSubTypeInfo<?>>>> getExtraProtocolSubTypeInfoCollectors()
    {
        return Lists.fixedSize.with(() -> Lists.mutable.with(
                ProtocolSubTypeInfo.newBuilder(PackageableElement.class)
                        .withSubtype(DataProduct.class, "dataProduct")
                        .build(),
                ProtocolSubTypeInfo.newBuilder(MappingInclude.class)
                        .withSubtype(MappingIncludeDataProduct.class, "mappingIncludeDataProduct")
                        .build()
        ));
    }
    ...
    {
        return Maps.mutable.with(DataProduct.class, "meta::pure::metamodel::dataProduct::DataProduct");
    }
}
