...
public class TestDataProductIncludeGrammarRoundtrip extends TestGrammarRoundtrip.TestGrammarRoundtripTestSuite
{
    @Test
    public void testIncludeDispatch()
    {
        test("###Mapping\n" +
                ...
                "  include dataspace meta::pure::dataspace::IncludedDataProduct\n" +
                "\n" +
