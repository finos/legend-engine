...
public class TestDataProductCompilationFromGrammar extends TestCompilationFromGrammar.TestCompilationFromGrammarTestSuite
{
    @Test
    ...
    public void testDataspaceIncludesDataspaceWithoutTestData()
    {
        ...
        test(models +
                ...
                "}\n" +
                "###DataProduct\n" +
                "DataProduct model::dataProduct2" +
                "{\n" +
                "  executionContexts:\n" +
                "  [\n" +
                "    {\n" +
                ...
                "  ];\n" +
                "  defaultExecutionContext: 'Context 1';\n" +
                "}\n", "COMPILATION error at [76:9-79:10]: Dataspace model::dataProduct does not have test data in its default execution context.");
    }
    ...
    public void testDuplicateMappingIncludeDataspaceWithImport()
    {
        ...
        test(models +
                ...
                "   include dataspace model::dataspace::dataProduct\n" +
                "   test::A[1]: Pure {\n" +
                "      ~src test::S_A\n" +
                "      prop1: $src.prop1\n" +
                "   }\n" +
                ...
                "\n" +
                "###DataProduct\n" +
                "DataProduct model::dataspace::dataProduct" +
                "{\n" +
                "  executionContexts:\n" +
                "  [\n" +
                "    {\n" +
    ...
    public void testFaultyAnnotations()
    {
        // Faulty stereotype
        test("###DataProduct\n" +
                "DataProduct <<NoProfile.NoKey>> model::dataProduct" +
                "{\n" +
                "  executionContexts:\n" +
                "  [\n" +
                "    {\n" +
        ...
        // Faulty tagged value
        test("###DataProduct\n" +
                "DataProduct { NoProfile.NoKey = 'something' } model::dataProduct" +
                "{\n" +
                "  executionContexts:\n" +
                "  [\n" +
                "    {\n" +
    ...
    @Test
    public void testDataProductWithElements()
    {
    ...
    @Test
    public void testDataProductWithTemplateExecutableWithInlineQuery()
    {
        test("Class model::element {}\n" +
                "Class model::sub::element {}\n" +
                "###Mapping\n" +
    ...
    @Test
    public void testDataProductWithExecutableWithFunctionPointer()
    {
        ...
        test(model +
                ...
                "    }\n" +
                "  ];\n" +
                "}\n", " at [44:1-65:1]: Error in 'model::dataProduct': The mapping utilized in the function within the curated template query does not align with the mapping applied in the execution context `Context 1`.");
        ...
        test(model +
                ...
                "    }\n" +
                "  ];\n" +
                "}\n", " at [44:1-65:1]: Error in 'model::dataProduct': The runtime utilized in the function within the curated template query does not align with the runtime applied in the execution context `Context 1`.");
    }

    @Test
    public void testDataProductWithUnsupportedElement()
    {
        test("Class model::element {}\n" +
                "###Mapping\n" +
                "Mapping model::dummyMapping\n" +
    ...
    @Test
    public void testDataProductDiagramsCompilation()
    {
        // no diagrams
        test("###Mapping\n" +
                "Mapping model::dummyMapping\n" +
    ...
    @Test
    public void testDataProductExecutablesCompilation()
    {
        test("###Service\n" +
        ...
        test("###Service\n" +
                ...
                "}\n", "COMPILATION error at [42:1-54:1]: Error in 'model::dataProduct': Can't find the packageable element 'model::Mine'");
    }
}
