...
package org.finos.legend.engine.protocol.functionJar.metamodel;
...
public class FunctionJarProtocolExtension implements PureProtocolExtension
{
    public static String packageJSONType = "functionJar";
    ...
    public List<Function0<List<ProtocolSubTypeInfo<?>>>> getExtraProtocolSubTypeInfoCollectors()
    {
        return Lists.fixedSize.with(() -> Lists.mutable.with(
                ...
                ProtocolSubTypeInfo.newBuilder(FunctionActivatorDeploymentContent.class)
                        .withSubtype(FunctionJarContent.class, "functionJarDeploymentContent")
                        .build()
        ));
    }
