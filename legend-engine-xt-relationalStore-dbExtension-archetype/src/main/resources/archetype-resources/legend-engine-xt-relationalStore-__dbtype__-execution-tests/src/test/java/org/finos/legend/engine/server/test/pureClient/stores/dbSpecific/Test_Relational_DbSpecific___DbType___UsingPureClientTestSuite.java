...
public class Test_Relational_DbSpecific_${DbType}_UsingPureClientTestSuite extends Relational_DbSpecific_UsingPureClientTestSuite
{
    public static Test suite() throws Exception
    {
        return createSuite(
                "meta::relational::tests::sqlQueryToString::${dbType}",
                "org/finos/legend/engine/server/test/userTestConfig_with${DbType}TestConnection.json",
