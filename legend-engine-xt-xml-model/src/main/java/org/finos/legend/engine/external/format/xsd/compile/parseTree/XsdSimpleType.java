...
public class XsdSimpleType extends XsdAnyType
{
    public String name;
    public QName ref;
    public XsdSimpleTypeDerivation derivation;
    ...
    public void accept(XsdObjectVisitor visitor)
    {
        ...
        Optional.ofNullable((XsdObject) derivation).ifPresent(a -> a.accept(visitor));
