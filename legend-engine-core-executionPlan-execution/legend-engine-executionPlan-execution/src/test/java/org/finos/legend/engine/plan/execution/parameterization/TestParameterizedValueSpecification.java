...
public class TestParameterizedValueSpecification
{
    ...
    public void testLambdaIsParameterized() throws IOException
    {
        ...
        expectedParameters.add(createParameterValue("GENERATEDL0L0L0L1L0L1L1L1", new CStrictDate("2023-06-02")));
        ...
        expectedVariables.add(new Variable("GENERATEDL0L0L0L1L0L1L1L1", "StrictDate", Multiplicity.PURE_ONE));
