...
package org.finos.legend.engine.external.format.json.specifications.draftv7.visitor;
...
public interface DraftV7SchemaVisitor<T>
{
    T visit(DraftV7Schema schemaObject);

    T visit(DraftV7SchemaArray schemaObject);

    T visit(DraftV7SchemaBoolean schemaObject);

    T visit(DraftV7SchemaFragment schemaObject);

    T visit(DraftV7SchemaInteger schemaObject);

    T visit(DraftV7SchemaMultiType schemaObject);

    T visit(DraftV7SchemaNull schemaObject);

    T visit(DraftV7SchemaNumber schemaObject);

    T visit(DraftV7SchemaObject schemaObject);

    T visit(DraftV7SchemaString schemaObject);
}
