...
awsOAuth:                                  AWS_OAUTH
                                            BRACE_OPEN
                                                (
                                                    awsAuthSecretArn
                                                    | awsOAuthDiscoveryUrl
                                                )*
                                            BRACE_CLOSE
;

awsAuthSecretArn:                         AWS_AUTH_SECRET_ARN COLON STRING SEMI_COLON
;
awsOAuthDiscoveryUrl:                      AWS_OAUTH_DISCOVERY_URL COLON STRING SEMI_COLON
;
...
awsPK:                                 AWS_PK
                                            ...
                                            BRACE_CLOSE
;
awsPKUser:                             AWS_PK_USER COLON STRING SEMI_COLON
;
// --
