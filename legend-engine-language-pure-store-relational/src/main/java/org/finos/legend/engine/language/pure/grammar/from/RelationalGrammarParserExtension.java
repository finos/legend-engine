    ...
    public List<java.util.function.Function<DataSourceSpecificationSourceCode, DatasourceSpecification>> getExtraDataSourceSpecificationParsers()
    {
        return Collections.singletonList(code ->
        {
            ...
            switch (code.getType())
            {
                ...
                case "DeltaLake":
                    return parseDataSourceSpecification(code, p -> walker.visitDeltaLakeDatasourceSpecification(code, p.deltaLakeDatasourceSpecification()));
                case "Snowflake":
    ...
    public List<Function<AuthenticationStrategySourceCode, AuthenticationStrategy>> getExtraAuthenticationStrategyParsers()
    {
        return Collections.singletonList(code ->
        {
            ...
            switch (code.getType())
            {
                ...
                case "DeltaLake":
                    return parseAuthenticationStrategy(code, p -> walker.visitDeltaLakeAuthenticationStrategy(code, p.deltaLakeAuth()));
