    ...
    public List<Function<AuthenticationStrategySourceCode, AuthenticationStrategy>> getExtraAuthenticationStrategyParsers()
    {
        return Collections.singletonList(code ->
        {
            ...
            switch (code.getType())
            {
                ...
                case "GCPWorkloadIdentityFederationWithAWS":
                    return parseAuthenticationStrategy(code, p -> walker.visitGCPWorkloadIdentityFederationAuthenticationStrategy(code, p.gcpWorkloadIdentityFederationWithAWSAuth() ));
                default:
                    return null;
            }
        });
