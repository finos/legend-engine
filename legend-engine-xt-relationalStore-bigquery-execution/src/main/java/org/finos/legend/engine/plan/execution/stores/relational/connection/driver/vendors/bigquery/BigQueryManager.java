...
public class BigQueryManager extends DatabaseManager
{
    ...
    public String buildURL(String host, int port, String databaseName, Properties extraUserDataSourceProperties, AuthenticationStrategyRuntime authenticationStrategyRuntime)
    {
        String url = String.format("jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;" +
                        "ProjectId=%s;" +
                        this.buildParamForOptionalProperty(extraUserDataSourceProperties, BigQueryDataSourceSpecificationRuntime.BIGQUERY_DATASET_NAME, "DefaultDataset") +
                        this.buildParamForOptionalProperty(extraUserDataSourceProperties, BigQueryDataSourceSpecificationRuntime.BIGQUERY_PROXY_HOST, "ProxyHost") +
                        this.buildParamForOptionalProperty(extraUserDataSourceProperties, BigQueryDataSourceSpecificationRuntime.BIGQUERY_PROXY_PORT, "ProxyPort"),
                extraUserDataSourceProperties.getProperty(BigQueryDataSourceSpecificationRuntime.BIGQUERY_PROJECT_ID));
        return url;
    }
