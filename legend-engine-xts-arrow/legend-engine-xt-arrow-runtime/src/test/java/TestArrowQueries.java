...
public class TestArrowQueries
{
    ...
    public void runTest()
    {
        ...
        )
        {
            ...
            PureModel model = org.finos.legend.engine.language.pure.compiler.Compiler.compile((PureModelContextData) input.model, DeploymentMode.TEST, Identity.getAnonymousIdentity().getName());
